...
const T = {
  ...
  tabIntegrations: { zh: '集成管理', en: 'Integrations' },
  ...
  filterTags: { zh: '标记', en: 'Tags' },
  repoStatus: { zh: '仓库状态', en: 'Repo Status' },
  ...
  statusPendingReload: { zh: '待加载', en: 'Pending Reload' },
  ...
  catPythonScript: { zh: 'Python 脚本', en: 'Python Script' },
  catCustom: { zh: '自定义', en: 'Custom' },
  ...
  redownload: { zh: '重新下载', en: 'Redownload' },
  ignore: { zh: '忽略', en: 'Ignore' },
  confirmIgnore: { zh: '确定要忽略 {repo} 吗？将不再出现在搜索结果和更新提醒中。', en: 'Ignore {repo}? It will no longer appear in search results or update notifications.' },
  ignoreVersion: { zh: '忽略此版本', en: 'Ignore this version' },
  unignoreVersion: { zh: '取消版本忽略', en: 'Unignore version' },
  confirmIgnoreVersion: { zh: '确定忽略 {repo} 的 {version} 更新？下次新版本会正常提醒。', en: 'Ignore {version} update for {repo}? Next version will still notify.' },
  ...
  // Tag chips (orthogonal markers)
  tagFavorites: { zh: '收藏', en: 'Favorites' },
  tagNew: { zh: '新发现', en: 'New' },
  ...
  confirmRemove: { zh: '确定要卸载 {repo} 吗？将删除仓库下载文件，已添加的集成配置不会被删除。', en: 'Uninstall {repo}? Repository files will be deleted. Existing integration config entries will NOT be deleted.' },
  removed: { zh: '已卸载', en: 'Uninstalled' },
  removeFailed: { zh: '卸载失败', en: 'Uninstall failed' },
  removing: { zh: '卸载中…', en: 'Uninstalling…' },
  ...
  confirmUpdateAll: { zh: '确定要更新全部 {n} 个仓库吗？', en: 'Update all {n} repositories?' },
  confirmUpdateSelected: { zh: '确定要更新已选的 {n} 个仓库吗？', en: 'Update {n} selected repositories?' },
  ...
  confirmRemoveRepo: { zh: '确定要移除 {repo} 吗？只删除 HACS 跟踪记录，仓库文件和集成配置不受影响。', en: 'Remove {repo}? Only the HACS tracking record will be deleted. Repository files and integration config are NOT affected.' },
  ...
  unignore: { zh: '取消忽略', en: 'Unignore' },
  confirmUnignore: { zh: '确定取消忽略 {repo}？', en: 'Unignore {repo}?' },
  ignoredBadge: { zh: '已忽略', en: 'Ignored' },
  ...
  stateOn: { zh: '开', en: 'On' },
  stateOff: { zh: '关', en: 'Off' },
  stateOpen: { zh: '已打开', en: 'Open' },
  stateClosed: { zh: '已关闭', en: 'Closed' },
  stateHome: { zh: '在家', en: 'Home' },
  stateNotHome: { zh: '离家', en: 'Away' },
  ...
  noDevices: { zh: '暂无设备', en: 'No devices' },
  deviceCount: { zh: '个设备', en: ' devices' },
  areaCount: { zh: '个区域', en: ' areas' },
  viewDevices: { zh: '查看设备', en: 'View Devices' },
  ...
  confirmDelete: { zh: '确定要删除 {domain} 的配置条目吗？该集成将立即停止运行，仓库下载文件不会被删除。', en: 'Delete {domain} config entry? The integration will stop immediately. Repository files will NOT be deleted.' },
  ...
  reloadHA: { zh: '重新加载', en: 'Reload' },
  reloadHATitle: { zh: '重新加载核心配置', en: 'Reload Core Config' },
  reloadingHA: { zh: '正在重新加载配置...', en: 'Reloading config...' },
  reloadSuccess: { zh: '配置已重新加载', en: 'Config reloaded' },
  coreReloadFailed: { zh: '重新加载失败', en: 'Reload failed' },
  postInstallRestartMsg: { zh: '已安装/更新完成。需要重启 Home Assistant 才能生效，是否立即重启？', en: 'Install/Update complete. Home Assistant needs a restart to apply changes. Restart now?' },
  ...
  changelogTitleVersion: { zh: '{tag} 更新内容', en: "{tag} What's New" },
  ...
  noConfigRequired: { zh: '此集成无需配置', en: 'This integration requires no configuration' },
  ...
  settingsMaintenance: { zh: '维护', en: 'Maintenance' },
  ...
  batchRemoveRepoConfirm: { zh: '确定要批量移除 {n} 个自定义仓库吗？', en: 'Remove {n} custom repositories?' },
  ...
  filterLoaded: { zh: '已加载', en: 'Loaded' },
  filterFailed: { zh: '加载失败', en: 'Failed' },
  filterDisabled: { zh: '已禁用', en: 'Disabled' },
  filterNotLoaded: { zh: '未加载', en: 'Not Loaded' },
  entryCount: { zh: '个条目', en: ' entries' },
  entryTitle: { zh: 'ID: {id}', en: 'ID: {id}' },
  detailEntries: { zh: '{count} 个条目 · 点击 ⚙ 配置', en: '{count} entries · Click ⚙ to configure' },
  reloadDomain: { zh: '重载此集成全部条目', en: 'Reload all entries' },
  configureEntry: { zh: '配置此条目', en: 'Configure this entry' },
  reloadEntry: { zh: '重载此条目', en: 'Reload this entry' },
  removeEntry: { zh: '删除此条目', en: 'Remove this entry' },
  entryDisabled: { zh: '已禁用', en: 'Disabled' },
  viewDetail: { zh: '查看详情', en: 'View details' },
  loadFailed: { zh: '加载集成列表失败', en: 'Failed to load integrations' },
  reloaded: { zh: '已重载', en: 'Reloaded' },
  reloadFailed: { zh: '重载失败', en: 'Reload failed' },
  ...
  subentryTitle: { zh: '子项配置', en: 'Subentry Configuration' },
  subentrySelectDesc: { zh: '请选择要配置的子项类型：', en: 'Select a subentry type to configure:' },
  subentryExisting: { zh: '已有子项', en: 'Existing Subentries' },
  subentryAddNew: { zh: '添加新子项', en: 'Add New Subentry' },
  subentryAddPrefix: { zh: '添加', en: 'Add' },
  subentryReconfigure: { zh: '配置', en: 'Configure' },
  subentryConversation: { zh: '对话', en: 'Conversation' },
  subentryTts: { zh: '语音合成', en: 'Text-to-Speech' },
  subentryStt: { zh: '语音识别', en: 'Speech-to-Text' },
  subentryTranslation: { zh: '翻译', en: 'Translation' },
  subentryAiTaskData: { zh: 'AI 任务数据', en: 'AI Task Data' },
  subentryDevice: { zh: 'MQTT 设备', en: 'MQTT Device' },
  subentryWecom: { zh: '企业微信', en: 'WeCom' },
  subentryWechat: { zh: '微信', en: 'WeChat' },
  subentryQq: { zh: 'QQ', en: 'QQ' },
  subentryFeishu: { zh: '飞书', en: 'Feishu' },
  subentryDingtalk: { zh: '钉钉', en: 'DingTalk' },
  subentryXiaoyi: { zh: '小懿', en: 'XiaoYi' },
  subentryCustom: { zh: '自定义', en: 'Custom' },
