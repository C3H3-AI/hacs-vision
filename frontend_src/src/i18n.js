...
const T = {
  ...
  ignoreVersion: { zh: '跳过此版本', en: 'Skip this version' },
  unignoreVersion: { zh: '取消跳过此版本', en: 'Unskip this version' },
  confirmIgnoreVersion: { zh: '确定跳过 {repo} 的 {version} 更新？下次新版本会正常提醒。', en: 'Skip {version} for {repo}? Next version will still notify.' },
