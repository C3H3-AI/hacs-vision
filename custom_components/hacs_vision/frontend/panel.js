        ...
        @keydown=${e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this._openDetail(t,o))}}>
          ...
          <div class="card-img">
            ...
            <div class="img-badges">
              ...
              ${this._iotLabel(a?.iot_class)?H`<span class="img-badge iot-badge">${this._iotLabel(a?.iot_class)}</span>`:""}
            </div>
          </div>
