        ...
        <div class="modal-overlay" @click=${e=>{e.target===e.currentTarget&&this._closeDetail()}}>
          <div class="modal ${this._detailExpanded?"expanded":""}" @dblclick=${this._toggleDetailExpand}>
            ...
            <div class="modal-body">
              ...
              ${t.config_entry_id?H`
                <button class="detail-action-btn" @click=${()=>window.top.location.href="/config/integrations/dashboard/settings?config_entry="+t.config_entry_id} title="${ue("addIntegrationHint")}">
                  ${ue("addIntegration")}
                </button>`:""}
