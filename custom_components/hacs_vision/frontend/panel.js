...
`}
/*! @license DOMPurify 3.4.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.8/LICENSE */function ve(e,t){(null==t||t>e.length)&&(t=e.length);for(var o=0,i=Array(t);o<t;o++)i[o]=e[o];return i}function be(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var o=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=o){var i,r,s,a,n=[],l=!0,d=!1;try{if(s=(o=o.call(e)).next,0===t);else for(;!(l=(i=s.call(o)).done)&&(n.push(i.value),n.length!==t);l=!0);}catch(e){d=!0,r=e}finally{try{if(!l&&null!=o.return&&(a=o.return(),Object(a)!==a))return}finally{if(d)throw r}}return n}}(e,t)||function(e,t){if(e){if("string"==typeof e)return ve(e,t);var o={}.toString.call(e).slice(8,-1);return"Object"===o&&e.constructor&&(o=e.constructor.name),"Map"===o||"Set"===o?Array.from(e):"Arguments"===o||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)?ve(e,t):void 0}}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}const xe=Object.entries,ye=Object.setPrototypeOf,_e=Object.isFrozen,we=Object.getPrototypeOf,$e=Object.getOwnPropertyDescriptor;let ke=Object.freeze,Se=Object.seal,ze=Object.create,Ce="undefined"!=typeof Reflect&&Reflect,Re=Ce.apply,Ae=Ce.construct;ke||(ke=function(e){return e}),Se||(Se=function(e){return e}),Re||(Re=function(e,t){for(var o=arguments.length,i=new Array(o>2?o-2:0),r=2;r<o;r++)i[r-2]=arguments[r];return e.apply(t,i)}),Ae||(Ae=function(e){for(var t=arguments.length,o=new Array(t>1?t-1:0),i=1;i<t;i++)o[i-1]=arguments[i];return new e(...o)});const Te=Ke(Array.prototype.forEach),Ee=Ke(Array.prototype.lastIndexOf),De=Ke(Array.prototype.pop),Fe=Ke(Array.prototype.push),Ie=Ke(Array.prototype.splice),Le=Array.isArray,Me=Ke(String.prototype.toLowerCase),Oe=Ke(String.prototype.toString),Ne=Ke(String.prototype.match),Be=Ke(String.prototype.replace),Pe=Ke(String.prototype.indexOf),He=Ke(String.prototype.trim),Ue=Ke(Number.prototype.toString),je=Ke(Boolean.prototype.toString),Ve="undefined"==typeof BigInt?null:Ke(BigInt.prototype.toString),qe="undefined"==typeof Symbol?null:Ke(Symbol.prototype.toString),Ye=Ke(Object.prototype.hasOwnProperty),Ge=Ke(Object.prototype.toString),Xe=Ke(RegExp.prototype.test),We=(Je=TypeError,function(){for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];return Ae(Je,t)});var Je;function Ke(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var o=arguments.length,i=new Array(o>1?o-1:0),r=1;r<o;r++)i[r-1]=arguments[r];return Re(e,t,i)}}function Ze(e,t){let o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Me;if(ye&&ye(e,null),!Le(t))return e;let i=t.length;for(;i--;){let r=t[i];if("string"==typeof r){const e=o(r);e!==r&&(_e(t)||(t[i]=e),r=e)}e[r]=!0}return e}function Qe(e){for(let t=0;t<e.length;t++){Ye(e,t)||(e[t]=null)}return e}function et(e){const t=ze(null);for(const i of xe(e)){var o=be(i,2);const r=o[0],s=o[1];Ye(e,r)&&(Le(s)?t[r]=Qe(s):s&&"object"==typeof s&&s.constructor===Object?t[r]=et(s):t[r]=s)}return t}function tt(e,t){for(;null!==e;){const o=$e(e,t);if(o){if(o.get)return Ke(o.get);if("function"==typeof o.value)return Ke(o.value)}e=we(e)}return function(){return null}}const ot=ke(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),it=ke(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),rt=ke(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),st=ke(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),at=ke(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),nt=ke(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),lt=ke(["#text"]),dt=ke(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),ct=ke(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),pt=ke(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ht=ke(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),gt=Se(/{{[\w\W]*|^[\w\W]*}}/g),ut=Se(/<%[\w\W]*|^[\w\W]*%>/g),ft=Se(/\${[\w\W]*/g),mt=Se(/^data-[\-\w.\u00B7-\uFFFF]+$/),vt=Se(/^aria-[\-\w]+$/),bt=Se(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),xt=Se(/^(?:\w+script|data):/i),yt=Se(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),_t=Se(/^html$/i),wt=Se(/^[a-z][.\w]*(-[.\w]+)+$/i),$t=1,kt=3,St=7,zt=8,Ct=9,Rt=11,At=function(){return"undefined"==typeof window?null:window};var Tt=function e(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:At();const o=t=>e(t);if(o.version="3.4.8",o.removed=[],!t||!t.document||t.document.nodeType!==Ct||!t.Element)return o.isSupported=!1,o;let i=t.document;const r=i,s=r.currentScript;t.DocumentFragment;const a=t.HTMLTemplateElement,n=t.Node,l=t.Element,d=t.NodeFilter,c=t.NamedNodeMap;void 0===c&&(t.NamedNodeMap||t.MozNamedAttrMap),t.HTMLFormElement;const p=t.DOMParser,h=t.trustedTypes,g=l.prototype,u=tt(g,"cloneNode"),f=tt(g,"remove"),m=tt(g,"nextSibling"),v=tt(g,"childNodes"),b=tt(g,"parentNode"),x=tt(g,"shadowRoot"),y=tt(g,"attributes"),_=n&&n.prototype?tt(n.prototype,"nodeType"):null,w=n&&n.prototype?tt(n.prototype,"nodeName"):null;if("function"==typeof a){const e=i.createElement("template");e.content&&e.content.ownerDocument&&(i=e.content.ownerDocument)}let $,k="",S=0;const z=function(e){if(S>0)throw We('The configured TRUSTED_TYPES_POLICY.createHTML must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose createHTML wraps DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.');S++;try{return $.createHTML(e)}finally{S--}},C=i,R=C.implementation,A=C.createNodeIterator,T=C.createDocumentFragment,E=C.getElementsByTagName,D=r.importNode;let F={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]};o.isSupported="function"==typeof xe&&"function"==typeof b&&R&&void 0!==R.createHTMLDocument;const I=gt,L=ut,M=ft,O=mt,N=vt,B=xt,P=yt,H=wt;let U=bt,j=null;const V=Ze({},[...ot,...it,...rt,...at,...lt]);let q=null;const Y=Ze({},[...dt,...ct,...pt,...ht]);let G=Object.seal(ze(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),X=null,W=null;const J=Object.seal(ze(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let K=!0,Z=!0,Q=!1,ee=!0,te=!1,oe=!0,ie=!1,re=!1,se=!1,ae=!1,ne=!1,le=!1,de=!0,ce=!1;const pe="user-content-";let he=!0,ge=!1,ue={},fe=null;const me=Ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let ve=null;const be=Ze({},["audio","video","img","source","image","track"]);let ye=null;const _e=Ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),we="http://www.w3.org/1998/Math/MathML",$e="http://www.w3.org/2000/svg",Se="http://www.w3.org/1999/xhtml";let Ce=Se,Re=!1,Ae=null;const Je=Ze({},[we,$e,Se],Oe);let Ke=Ze({},["mi","mo","mn","ms","mtext"]),Qe=Ze({},["annotation-xml"]);const Tt=Ze({},["title","style","font","a","script"]);let Et=null;const Dt=["application/xhtml+xml","text/html"];let Ft=null,It=null;const Lt=i.createElement("form"),Mt=function(e){return e instanceof RegExp||e instanceof Function},Ot=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(It&&It===e)return;e&&"object"==typeof e||(e={}),e=et(e),Et=-1===Dt.indexOf(e.PARSER_MEDIA_TYPE)?"text/html":e.PARSER_MEDIA_TYPE,Ft="application/xhtml+xml"===Et?Oe:Me,j=Ye(e,"ALLOWED_TAGS")&&Le(e.ALLOWED_TAGS)?Ze({},e.ALLOWED_TAGS,Ft):V,q=Ye(e,"ALLOWED_ATTR")&&Le(e.ALLOWED_ATTR)?Ze({},e.ALLOWED_ATTR,Ft):Y,Ae=Ye(e,"ALLOWED_NAMESPACES")&&Le(e.ALLOWED_NAMESPACES)?Ze({},e.ALLOWED_NAMESPACES,Oe):Je,ye=Ye(e,"ADD_URI_SAFE_ATTR")&&Le(e.ADD_URI_SAFE_ATTR)?Ze(et(_e),e.ADD_URI_SAFE_ATTR,Ft):_e,ve=Ye(e,"ADD_DATA_URI_TAGS")&&Le(e.ADD_DATA_URI_TAGS)?Ze(et(be),e.ADD_DATA_URI_TAGS,Ft):be,fe=Ye(e,"FORBID_CONTENTS")&&Le(e.FORBID_CONTENTS)?Ze({},e.FORBID_CONTENTS,Ft):me,X=Ye(e,"FORBID_TAGS")&&Le(e.FORBID_TAGS)?Ze({},e.FORBID_TAGS,Ft):et({}),W=Ye(e,"FORBID_ATTR")&&Le(e.FORBID_ATTR)?Ze({},e.FORBID_ATTR,Ft):et({}),ue=!!Ye(e,"USE_PROFILES")&&(e.USE_PROFILES&&"object"==typeof e.USE_PROFILES?et(e.USE_PROFILES):e.USE_PROFILES),K=!1!==e.ALLOW_ARIA_ATTR,Z=!1!==e.ALLOW_DATA_ATTR,Q=e.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=!1!==e.ALLOW_SELF_CLOSE_IN_ATTR,te=e.SAFE_FOR_TEMPLATES||!1,oe=!1!==e.SAFE_FOR_XML,ie=e.WHOLE_DOCUMENT||!1,ae=e.RETURN_DOM||!1,ne=e.RETURN_DOM_FRAGMENT||!1,le=e.RETURN_TRUSTED_TYPE||!1,se=e.FORCE_BODY||!1,de=!1!==e.SANITIZE_DOM,ce=e.SANITIZE_NAMED_PROPS||!1,he=!1!==e.KEEP_CONTENT,ge=e.IN_PLACE||!1,U=function(e){try{return Xe(e,""),!0}catch(e){return!1}}(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:bt,Ce="string"==typeof e.NAMESPACE?e.NAMESPACE:Se,Ke=Ye(e,"MATHML_TEXT_INTEGRATION_POINTS")&&e.MATHML_TEXT_INTEGRATION_POINTS&&"object"==typeof e.MATHML_TEXT_INTEGRATION_POINTS?et(e.MATHML_TEXT_INTEGRATION_POINTS):Ze({},["mi","mo","mn","ms","mtext"]),Qe=Ye(e,"HTML_INTEGRATION_POINTS")&&e.HTML_INTEGRATION_POINTS&&"object"==typeof e.HTML_INTEGRATION_POINTS?et(e.HTML_INTEGRATION_POINTS):Ze({},["annotation-xml"]);const t=Ye(e,"CUSTOM_ELEMENT_HANDLING")&&e.CUSTOM_ELEMENT_HANDLING&&"object"==typeof e.CUSTOM_ELEMENT_HANDLING?et(e.CUSTOM_ELEMENT_HANDLING):ze(null);if(G=ze(null),Ye(t,"tagNameCheck")&&Mt(t.tagNameCheck)&&(G.tagNameCheck=t.tagNameCheck),Ye(t,"attributeNameCheck")&&Mt(t.attributeNameCheck)&&(G.attributeNameCheck=t.attributeNameCheck),Ye(t,"allowCustomizedBuiltInElements")&&"boolean"==typeof t.allowCustomizedBuiltInElements&&(G.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),te&&(Z=!1),ne&&(ae=!0),ue&&(j=Ze({},lt),q=ze(null),!0===ue.html&&(Ze(j,ot),Ze(q,dt)),!0===ue.svg&&(Ze(j,it),Ze(q,ct),Ze(q,ht)),!0===ue.svgFilters&&(Ze(j,rt),Ze(q,ct),Ze(q,ht)),!0===ue.mathMl&&(Ze(j,at),Ze(q,pt),Ze(q,ht))),J.tagCheck=null,J.attributeCheck=null,Ye(e,"ADD_TAGS")&&("function"==typeof e.ADD_TAGS?J.tagCheck=e.ADD_TAGS:Le(e.ADD_TAGS)&&(j===V&&(j=et(j)),Ze(j,e.ADD_TAGS,Ft))),Ye(e,"ADD_ATTR")&&("function"==typeof e.ADD_ATTR?J.attributeCheck=e.ADD_ATTR:Le(e.ADD_ATTR)&&(q===Y&&(q=et(q)),Ze(q,e.ADD_ATTR,Ft))),Ye(e,"ADD_URI_SAFE_ATTR")&&Le(e.ADD_URI_SAFE_ATTR)&&Ze(ye,e.ADD_URI_SAFE_ATTR,Ft),Ye(e,"FORBID_CONTENTS")&&Le(e.FORBID_CONTENTS)&&(fe===me&&(fe=et(fe)),Ze(fe,e.FORBID_CONTENTS,Ft)),Ye(e,"ADD_FORBID_CONTENTS")&&Le(e.ADD_FORBID_CONTENTS)&&(fe===me&&(fe=et(fe)),Ze(fe,e.ADD_FORBID_CONTENTS,Ft)),he&&(j["#text"]=!0),ie&&Ze(j,["html","head","body"]),j.table&&(Ze(j,["tbody"]),delete X.tbody),e.TRUSTED_TYPES_POLICY){if("function"!=typeof e.TRUSTED_TYPES_POLICY.createHTML)throw We('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if("function"!=typeof e.TRUSTED_TYPES_POLICY.createScriptURL)throw We('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const t=$;$=e.TRUSTED_TYPES_POLICY;try{k=z("")}catch(e){throw $=t,e}}else void 0===$&&null!==e.TRUSTED_TYPES_POLICY&&($=function(e,t){if("object"!=typeof e||"function"!=typeof e.createPolicy)return null;let o=null;const i="data-tt-policy-suffix";t&&t.hasAttribute(i)&&(o=t.getAttribute(i));const r="dompurify"+(o?"#"+o:"");try{return e.createPolicy(r,{createHTML:e=>e,createScriptURL:e=>e})}catch(e){return console.warn("TrustedTypes policy "+r+" could not be created."),null}}(h,s)),$&&"string"==typeof k&&(k=z(""));(F.uponSanitizeElement.length>0||F.uponSanitizeAttribute.length>0)&&j===V&&(j=et(j)),F.uponSanitizeAttribute.length>0&&q===Y&&(q=et(q)),ke&&ke(e),It=e},Nt=Ze({},[...it,...rt,...st]),Bt=Ze({},[...at,...nt]),Pt=function(e){Fe(o.removed,{element:e});try{b(e).removeChild(e)}catch(t){f(e)}},Ht=function(e,t){try{Fe(o.removed,{attribute:t.getAttributeNode(e),from:t})}catch(e){Fe(o.removed,{attribute:null,from:t})}if(t.removeAttribute(e),"is"===e)if(ae||ne)try{Pt(t)}catch(e){}else try{t.setAttribute(e,"")}catch(e){}},Ut=function(e){let t=null,o=null;if(se)e="<remove></remove>"+e;else{const t=Ne(e,/^[\r\n\t ]+/);o=t&&t[0]}"application/xhtml+xml"===Et&&Ce===Se&&(e='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+e+"</body></html>");const r=$?z(e):e;if(Ce===Se)try{t=(new p).parseFromString(r,Et)}catch(e){}if(!t||!t.documentElement){t=R.createDocument(Ce,"template",null);try{t.documentElement.innerHTML=Re?k:r}catch(e){}}const s=t.body||t.documentElement;return e&&o&&s.insertBefore(i.createTextNode(o),s.childNodes[0]||null),Ce===Se?E.call(t,ie?"html":"body")[0]:ie?t.documentElement:s},jt=function(e){return A.call(e.ownerDocument||e,e,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT|d.SHOW_PROCESSING_INSTRUCTION|d.SHOW_CDATA_SECTION,null)},Vt=function(e){var t,o;e.normalize();const i=A.call(e.ownerDocument||e,e,d.SHOW_TEXT|d.SHOW_COMMENT|d.SHOW_CDATA_SECTION|d.SHOW_PROCESSING_INSTRUCTION,null);let r=i.nextNode();for(;r;){let e=r.data;Te([I,L,M],t=>{e=Be(e,t," ")}),r.data=e,r=i.nextNode()}const s=null!==(t=null===(o=e.querySelectorAll)||void 0===o?void 0:o.call(e,"template"))&&void 0!==t?t:[];Te(Array.from(s),e=>{Yt(e.content)&&Vt(e.content)})},qt=function(e){const t=w?w(e):null;return"string"==typeof t&&("form"===Ft(t)&&("string"!=typeof e.nodeName||"string"!=typeof e.textContent||"function"!=typeof e.removeChild||e.attributes!==y(e)||"function"!=typeof e.removeAttribute||"function"!=typeof e.setAttribute||"string"!=typeof e.namespaceURI||"function"!=typeof e.insertBefore||"function"!=typeof e.hasChildNodes||e.nodeType!==_(e)||e.childNodes!==v(e)))},Yt=function(e){if(!_||"object"!=typeof e||null===e)return!1;try{return _(e)===Rt}catch(e){return!1}},Gt=function(e){if(!_||"object"!=typeof e||null===e)return!1;try{return"number"==typeof _(e)}catch(e){return!1}};function Xt(e,t,i){Te(e,e=>{e.call(o,t,i,It)})}const Wt=function(e){let t=null;if(Xt(F.beforeSanitizeElements,e,null),qt(e))return Pt(e),!0;const i=Ft(w?w(e):e.nodeName);if(Xt(F.uponSanitizeElement,e,{tagName:i,allowedTags:j}),oe&&e.hasChildNodes()&&!Gt(e.firstElementChild)&&Xe(/<[/\w!]/g,e.innerHTML)&&Xe(/<[/\w!]/g,e.textContent))return Pt(e),!0;if(oe&&e.namespaceURI===Se&&"style"===i&&Gt(e.firstElementChild))return Pt(e),!0;if(e.nodeType===St)return Pt(e),!0;if(oe&&e.nodeType===zt&&Xe(/<[/\w]/g,e.data))return Pt(e),!0;if(X[i]||!(J.tagCheck instanceof Function&&J.tagCheck(i))&&!j[i]){if(!X[i]&&Zt(i)){if(G.tagNameCheck instanceof RegExp&&Xe(G.tagNameCheck,i))return!1;if(G.tagNameCheck instanceof Function&&G.tagNameCheck(i))return!1}if(he&&!fe[i]){const t=b(e),o=v(e);if(o&&t){for(let i=o.length-1;i>=0;--i){const r=u(o[i],!0);t.insertBefore(r,m(e))}}}return Pt(e),!0}return((_?_(e):e.nodeType)!==$t||function(e){let t=b(e);t&&t.tagName||(t={namespaceURI:Ce,tagName:"template"});const o=Me(e.tagName),i=Me(t.tagName);return!!Ae[e.namespaceURI]&&(e.namespaceURI===$e?t.namespaceURI===Se?"svg"===o:t.namespaceURI===we?"svg"===o&&("annotation-xml"===i||Ke[i]):Boolean(Nt[o]):e.namespaceURI===we?t.namespaceURI===Se?"math"===o:t.namespaceURI===$e?"math"===o&&Qe[i]:Boolean(Bt[o]):e.namespaceURI===Se?!(t.namespaceURI===$e&&!Qe[i])&&!(t.namespaceURI===we&&!Ke[i])&&!Bt[o]&&(Tt[o]||!Nt[o]):!("application/xhtml+xml"!==Et||!Ae[e.namespaceURI]))}(e))&&("noscript"!==i&&"noembed"!==i&&"noframes"!==i||!Xe(/<\/no(script|embed|frames)/i,e.innerHTML))?(te&&e.nodeType===kt&&(t=e.textContent,Te([I,L,M],e=>{t=Be(t,e," ")}),e.textContent!==t&&(Fe(o.removed,{element:e.cloneNode()}),e.textContent=t)),Xt(F.afterSanitizeElements,e,null),!1):(Pt(e),!0)},Jt=function(e,t,o){if(W[t])return!1;if(de&&("id"===t||"name"===t)&&(o in i||o in Lt))return!1;const r=q[t]||J.attributeCheck instanceof Function&&J.attributeCheck(t,e);if(Z&&!W[t]&&Xe(O,t));else if(K&&Xe(N,t));else if(!r||W[t]){if(!(Zt(e)&&(G.tagNameCheck instanceof RegExp&&Xe(G.tagNameCheck,e)||G.tagNameCheck instanceof Function&&G.tagNameCheck(e))&&(G.attributeNameCheck instanceof RegExp&&Xe(G.attributeNameCheck,t)||G.attributeNameCheck instanceof Function&&G.attributeNameCheck(t,e))||"is"===t&&G.allowCustomizedBuiltInElements&&(G.tagNameCheck instanceof RegExp&&Xe(G.tagNameCheck,o)||G.tagNameCheck instanceof Function&&G.tagNameCheck(o))))return!1}else if(ye[t]);else if(Xe(U,Be(o,P,"")));else if("src"!==t&&"xlink:href"!==t&&"href"!==t||"script"===e||0!==Pe(o,"data:")||!ve[e]){if(Q&&!Xe(B,Be(o,P,"")));else if(o)return!1}else;return!0},Kt=Ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Zt=function(e){return!Kt[Me(e)]&&Xe(H,e)},Qt=function(e){Xt(F.beforeSanitizeAttributes,e,null);const t=e.attributes;if(!t||qt(e))return;const i={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:q,forceKeepAttr:void 0};let r=t.length;for(;r--;){const s=t[r],a=s.name,n=s.namespaceURI,l=s.value,d=Ft(a),c=l;let p="value"===a?c:He(c);if(i.attrName=d,i.attrValue=p,i.keepAttr=!0,i.forceKeepAttr=void 0,Xt(F.uponSanitizeAttribute,e,i),p=i.attrValue,!ce||"id"!==d&&"name"!==d||0===Pe(p,pe)||(Ht(a,e),p=pe+p),oe&&Xe(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,p)){Ht(a,e);continue}if("attributename"===d&&Ne(p,"href")){Ht(a,e);continue}if(i.forceKeepAttr)continue;if(!i.keepAttr){Ht(a,e);continue}if(!ee&&Xe(/\/>/i,p)){Ht(a,e);continue}te&&Te([I,L,M],e=>{p=Be(p,e," ")});const g=Ft(e.nodeName);if(Jt(g,d,p)){if($&&"object"==typeof h&&"function"==typeof h.getAttributeType)if(n);else switch(h.getAttributeType(g,d)){case"TrustedHTML":p=z(p);break;case"TrustedScriptURL":p=$.createScriptURL(p)}if(p!==c)try{n?e.setAttributeNS(n,a,p):e.setAttribute(a,p),qt(e)?Pt(e):De(o.removed)}catch(t){Ht(a,e)}}else Ht(a,e)}Xt(F.afterSanitizeAttributes,e,null)},eo=function(e){let t=null;const o=jt(e);for(Xt(F.beforeSanitizeShadowDOM,e,null);t=o.nextNode();){Xt(F.uponSanitizeShadowNode,t,null),Wt(t),Qt(t),Yt(t.content)&&eo(t.content);if((_?_(t):t.nodeType)===$t){const e=x?x(t):t.shadowRoot;Yt(e)&&(to(e),eo(e))}}Xt(F.afterSanitizeShadowDOM,e,null)},to=function(e){const t=_?_(e):e.nodeType;if(t===$t){const t=x?x(e):e.shadowRoot;Yt(t)&&(to(t),eo(t))}const o=v?v(e):e.childNodes;if(!o)return;const i=[];Te(o,e=>{Fe(i,e)});for(const e of i)to(e);if(t===$t){const t=w?w(e):null;if("string"==typeof t&&"template"===Ft(t)){const t=e.content;Yt(t)&&to(t)}}};return o.sanitize=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=null,s=null,a=null,n=null;if(Re=!e,Re&&(e="\x3c!--\x3e"),"string"!=typeof e&&!Gt(e)&&"string"!=typeof(e=function(e){switch(typeof e){case"string":return e;case"number":return Ue(e);case"boolean":return je(e);case"bigint":return Ve?Ve(e):"0";case"symbol":return qe?qe(e):"Symbol()";case"undefined":default:return Ge(e);case"function":case"object":{if(null===e)return Ge(e);const t=e,o=tt(t,"toString");if("function"==typeof o){const e=o(t);return"string"==typeof e?e:Ge(e)}return Ge(e)}}}(e)))throw We("dirty is not a string, aborting");if(!o.isSupported)return e;if(re||Ot(t),o.removed=[],"string"==typeof e&&(ge=!1),ge){const t=w?w(e):e.nodeName;if("string"==typeof t){const e=Ft(t);if(!j[e]||X[e])throw We("root node is forbidden and cannot be sanitized in-place")}if(qt(e))throw We("root node is clobbered and cannot be sanitized in-place");to(e)}else if(Gt(e))i=Ut("\x3c!----\x3e"),s=i.ownerDocument.importNode(e,!0),s.nodeType===$t&&"BODY"===s.nodeName||"HTML"===s.nodeName?i=s:i.appendChild(s),to(s);else{if(!ae&&!te&&!ie&&-1===e.indexOf("<"))return $&&le?z(e):e;if(i=Ut(e),!i)return ae?null:le?k:""}i&&se&&Pt(i.firstChild);const l=jt(ge?e:i);for(;a=l.nextNode();)Wt(a),Qt(a),Yt(a.content)&&eo(a.content);if(ge)return te&&Vt(e),e;if(ae){if(te&&Vt(i),ne)for(n=T.call(i.ownerDocument);i.firstChild;)n.appendChild(i.firstChild);else n=i;return(q.shadowroot||q.shadowrootmode)&&(n=D.call(r,n,!0)),n}let d=ie?i.outerHTML:i.innerHTML;return ie&&j["!doctype"]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&Xe(_t,i.ownerDocument.doctype.name)&&(d="<!DOCTYPE "+i.ownerDocument.doctype.name+">\n"+d),te&&Te([I,L,M],e=>{d=Be(d,e," ")}),$&&le?z(d):d},o.setConfig=function(){Ot(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}),re=!0},o.clearConfig=function(){It=null,re=!1},o.isValidAttribute=function(e,t,o){It||Ot({});const i=Ft(e),r=Ft(t);return Jt(i,r,o)},o.addHook=function(e,t){"function"==typeof t&&Fe(F[e],t)},o.removeHook=function(e,t){if(void 0!==t){const o=Ee(F[e],t);return-1===o?void 0:Ie(F[e],o,1)[0]}return De(F[e])},o.removeHooks=function(e){F[e]=[]},o.removeAllHooks=function(){F={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},o}();class Et extends(ce(ae)){static properties={currentView:{type:String},stats:{type:Object},hass:{type:Object},narrow:{type:Boolean},_apiReady:{type:Boolean,state:!0},_error:{type:String,state:!0},_detailRepo:{type:Object,state:!0},_showDetail:{type:Boolean,state:!0},_favoriteCount:{type:Number,state:!0},_readmeHtml:{type:String,state:!0},_readmeLoading:{type:Boolean,state:!0},_viewTransition:{type:Boolean,state:!0},_networkStatus:{type:String,state:!0},_detailExpanded:{type:Boolean,state:!0},_showVersionSelector:{type:Boolean,state:!0},_releases:{type:Array,state:!0},_releasesLoading:{type:Boolean,state:!0},_installingVersion:{type:Boolean,state:!0},_changelogData:{type:Object,state:!0},_changelogLoading:{type:Boolean,state:!0},_changelogTag:{type:String,state:!0},_versionTab:{type:String,state:!0},_presetFilter:{type:String,state:!0},_presetTag:{type:String,state:!0},_configFlowDomain:{type:String,state:!0},_configFlowEntryId:{type:String,state:!0},_showConfigFlow:{type:Boolean,state:!0},_configEntries:{type:Object,state:!0},_showEntrySelector:{type:Boolean,state:!0},_entrySelectorDomain:{type:String,state:!0},_entrySelectorEntries:{type:Array,state:!0},_entrySelectorCurrentId:{type:String,state:!0}};constructor(){super(),this.currentView=(()=>{try{return localStorage.getItem("hacs_vision_tab")}catch{return null}})()||"browse",this.stats={pendingRestart:0},this.narrow=window.innerWidth<768,this._apiReady=!1,this._error="",this._detailRepo=null,this._showDetail=!1,this._favoriteCount=0,this._readmeHtml=null,this._readmeLoading=!1,this._viewTransition=!1,this._networkStatus="online",this._detailExpanded=!1,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1,this._installingVersion=!1,this._changelogData=null,this._changelogLoading=!1,this._changelogTag="",this._versionTab="stable",this._presetFilter="",this._presetTag="",this._configFlowDomain="",this._configFlowEntryId=null,this._showConfigFlow=!1,this._configEntries=null,this._showEntrySelector=!1,this._entrySelectorDomain="",this._entrySelectorEntries=[],this._entrySelectorCurrentId=null,this._entryDrag={offsetX:0,offsetY:0,startX:0,startY:0,dragging:!1},Ft(this),this._resizeHandler=()=>{this.narrow=window.innerWidth<768},window.addEventListener("resize",this._resizeHandler),this._onlineHandler=()=>{this._networkStatus="online"},window.addEventListener("online",this._onlineHandler),this._offlineHandler=()=>{this._networkStatus="offline"},window.addEventListener("offline",this._offlineHandler)}async _updateFavoriteCount(){try{const e=await de.getFavorites(),t=Array.isArray(e)?e:e.favorites||[];this._favoriteCount=t.length}catch{this._favoriteCount=0}}willUpdate(e){var t;e.has("hass")&&this.hass&&(t=this.hass,t?.language&&(pe=0===t.language.indexOf("zh")?"zh":"en"),de.setHass(this.hass),this._apiReady||(this._apiReady=!0,this._loadStats(),this._loadConfigEntries(),de._onNetworkStatus=e=>{this._networkStatus=e}))}static styles=[me(),s`
    :host {
      display: block;
    }
    ...
    .release-item.active { background: rgba(var(--rgb-primary-color, 3,169,244), 0.08); }
    .release-info { flex: 1; min-width: 0; cursor: pointer; }
    ...
    .version-tab:hover { color: var(--primary-text-color); }
    .version-tab.active {
    ...
    .release-group-header {
      ...
      padding: 10px 14px 4px; border-bottom: 1px solid var(--divider-color);
    }
    ...
    .entry-header { display: flex; align-items: center; gap: 12px; margin-bottom: 16px; }
    .entry-title { font-size: 17px; font-weight: 600; color: var(--primary-text-color, #212121); }
    .entry-subtitle { font-size: 13px; color: var(--secondary-text-color, #727272); }
    .entry-avatar {
    ...
    .entry-avatar-letter { font-size: 14px; font-weight: 700; color: #fff; z-index: 1; }
  ...
  `];async connectedCallback(){super.connectedCallback(),this._refreshStatsHandler=()=>this._loadStats(),this.addEventListener("refresh-stats",this._refreshStatsHandler),this._detailHandler=e=>this._openDetail(e.detail.repo),this.addEventListener("detail",this._detailHandler),this._favoriteHandler=()=>this._loadStats(),this.addEventListener("favorite",this._favoriteHandler),this._openFlowHandler=e=>{const t=e.detail?.domain;t&&this._openConfigFlow(t)},this.addEventListener("open-flow",this._openFlowHandler),this._openOptionsFlowHandler=e=>{const{entryId:t,domain:o}=e.detail||{};t&&this._openOptionsFlow(t,o)},this.addEventListener("open-options-flow",this._openOptionsFlowHandler),this._keydownHandler=e=>{if("Escape"===e.key&&this._showDetail)return e.preventDefault(),void this._closeDetail();if((e.ctrlKey||e.metaKey)&&"k"===e.key){e.preventDefault();const t=this.renderRoot?.querySelector(".search input");return void(t&&(t.focus(),t.select()))}},window.addEventListener("keydown",this._keydownHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._keydownHandler),window.removeEventListener("resize",this._resizeHandler),window.removeEventListener("online",this._onlineHandler),window.removeEventListener("offline",this._offlineHandler),this.removeEventListener("refresh-stats",this._refreshStatsHandler),this.removeEventListener("detail",this._detailHandler),this.removeEventListener("favorite",this._favoriteHandler),this.removeEventListener("open-flow",this._openFlowHandler),this.removeEventListener("open-options-flow",this._openOptionsFlowHandler)}async _loadStats(){try{this._error="",this.stats=await de.getStats();const e=await de.getFavorites(),t=Array.isArray(e)?e:e.favorites||[];this._favoriteCount=t.length}catch(e){console.error("Stats error:",e),this.stats={},this._error=`API: ${e.message}`}}async _restartHA(){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Ht});if(await e.show(this,{message:ge("restartConfirm"),confirmText:ge("restartHA"),danger:!0}))try{await de.restartHA(),Mt(ge("haRestarting"),"info")}catch(e){Mt(`${ge("restartFailed")}: ${e.message}`,"error")}}switchView(e){if(this.currentView!==e){this._viewTransition=!0,this.currentView=e;try{localStorage.setItem("hacs_vision_tab",e)}catch(e){}this.dispatchEvent(new CustomEvent("view-changed",{detail:{view:e},bubbles:!0,composed:!0})),setTimeout(()=>{this._viewTransition=!1},150)}}_openDetail(e){this._detailRepo=e,this._showDetail=!0,this._readmeHtml=null,this._readmeLoading=!0,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1,this._changelogData=null,this._changelogLoading=!0,this._loadReadme(e),this._loadChangelog(e),requestAnimationFrame(()=>this._installFocusTrap())}async _loadReadme(e){if(e?.full_name){try{const t=await de.getReadme(e.full_name);this._readmeHtml=t?Tt.sanitize(t):null}catch(e){this._readmeHtml=null}this._readmeLoading=!1}else this._readmeLoading=!1}async _loadChangelog(e,t){if(e?.full_name){this._changelogLoading=!0,this._changelogTag=t||"";try{const o=await de.getChangelog(e.full_name,t);this._changelogData=o?.body?o:null}catch(e){this._changelogData=null}this._changelogLoading=!1}else this._changelogLoading=!1}_applyFilter(e){this._presetFilter=e,this.switchView("browse"),setTimeout(()=>{this._presetFilter=""},100)}_applyTag(e){this._presetTag=e,this.switchView("browse"),setTimeout(()=>{this._presetTag=""},100)}_closeDetail(){this._showDetail=!1,this._detailRepo=null,this._readmeHtml=null,this._readmeLoading=!1,this._detailExpanded=!1,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1,this._removeFocusTrap(),this._detailDrag={offsetX:0,offsetY:0,startX:0,startY:0,dragging:!1};const e=this.renderRoot?.querySelector(".modal");e&&(e.style.transform="")}_storeModalPointerDown(e){const t=e.target.closest(".modal-header");if(!t||e.target.closest("button, input, select, textarea, a"))return;if(void 0!==e.button&&0!==e.button)return;const o=this._detailDrag||(this._detailDrag={offsetX:0,offsetY:0,startX:0,startY:0,dragging:!1}),i=e.currentTarget;if(this._detailExpanded)return;o.dragging=!0,o.startX=e.clientX-o.offsetX,o.startY=e.clientY-o.offsetY,i.style.transition="none",i.style.cursor="grabbing",t.style.userSelect="none",i.setPointerCapture(e.pointerId);const r=e=>{o.dragging&&(o.offsetX=e.clientX-o.startX,o.offsetY=e.clientY-o.startY,i.style.transform=`translate(${o.offsetX}px, ${o.offsetY}px)`)},s=e=>{o.dragging=!1,i.style.cursor="",t.style.userSelect="",i.removeEventListener("pointermove",r),i.removeEventListener("pointerup",s),i.removeEventListener("pointercancel",s);try{i.releasePointerCapture(e.pointerId)}catch(e){}};i.addEventListener("pointermove",r),i.addEventListener("pointerup",s),i.addEventListener("pointercancel",s)}_entryPointerDown(e){const t=e.target.closest(".entry-header");if(!t||e.target.closest("button"))return;if(void 0!==e.button&&0!==e.button)return;const o=this._entryDrag,i=e.currentTarget;o.dragging=!0,o.startX=e.clientX-o.offsetX,o.startY=e.clientY-o.offsetY,i.style.transition="none",i.style.cursor="grabbing",t.style.userSelect="none",i.setPointerCapture(e.pointerId);const r=e=>{o.dragging&&(o.offsetX=e.clientX-o.startX,o.offsetY=e.clientY-o.startY,i.style.transform=`translate(${o.offsetX}px, ${o.offsetY}px)`)},s=e=>{o.dragging=!1,i.style.cursor="",t.style.userSelect="",i.removeEventListener("pointermove",r),i.removeEventListener("pointerup",s),i.removeEventListener("pointercancel",s);try{i.releasePointerCapture(e.pointerId)}catch(e){}};i.addEventListener("pointermove",r),i.addEventListener("pointerup",s),i.addEventListener("pointercancel",s)}_installFocusTrap(){this._removeFocusTrap();const e=this.renderRoot?.querySelector(".modal-overlay");if(!e)return;this._focusTrapHandler=t=>{if("Tab"!==t.key)return;const o=e.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');if(0===o.length)return;const i=o[0],r=o[o.length-1];t.shiftKey?document.activeElement!==i&&e.contains(document.activeElement)||(t.preventDefault(),r.focus()):document.activeElement!==r&&e.contains(document.activeElement)||(t.preventDefault(),i.focus())};const t=e.querySelector(".modal-close");t&&t.focus(),window.addEventListener("keydown",this._focusTrapHandler)}_removeFocusTrap(){this._focusTrapHandler&&(window.removeEventListener("keydown",this._focusTrapHandler),this._focusTrapHandler=null)}_openConfigFlow(e){this._configFlowDomain=e,this._configFlowEntryId=null,this._showConfigFlow=!0}_openOptionsFlow(e,t){if(this._configEntries)for(const t of Object.values(this._configEntries)){const o=t.find(t=>t.entry_id===e);if(o){if(!1===o.supports_options)return void Mt(ge("noConfigRequired"),"info");break}}if(this._configFlowDomain=t||"",this._configFlowEntryId=null,t&&this._configEntries&&this._configEntries[t]&&this._configEntries[t].length>1)return this._entrySelectorDomain=t,this._entrySelectorEntries=this._configEntries[t],this._entrySelectorCurrentId=e,void(this._showEntrySelector=!0);this._configFlowEntryId=e,this._showConfigFlow=!0}_closeEntrySelector(){this._showEntrySelector=!1,this._entryDrag={offsetX:0,offsetY:0,startX:0,startY:0,dragging:!1}}_selectConfigEntry(e){if(this._closeEntrySelector(),this._configFlowEntryId=e,this._configEntries)for(const t of Object.values(this._configEntries)){const o=t.find(t=>t.entry_id===e);if(o){this._configFlowDomain=o.domain||"";break}}this._showConfigFlow=!0}async _loadConfigEntries(){try{const e=await de.getConfigEntries(),t=e?.entries||[],o={};if(Array.isArray(t))for(const e of t){const t=e.domain||e.handler||"?";o[t]||(o[t]=[]),o[t].push(e)}this._configEntries=o}catch{this._configEntries=null}}async _checkUpdates(){try{const e=await de.checkUpdatesWithNotify();e.success&&(e.updates_found>0?Mt(ge("updatesChecked",{n:e.updates_found}),"success"):Mt(ge("noUpdatesFound"),"info"),e.notified&&Mt(ge("notifySent"),"success"),this._loadStats())}catch(e){Mt(`Update check failed: ${e.message}`,"error")}}_onConfigureIntegration(e){const{domain:t,entry_id:o}=e.detail;this._configFlowDomain=t,this._configFlowEntryId=o,this._showConfigFlow=!0}_onAddIntegration(e){const{domain:t}=e.detail;this._configFlowDomain=t,this._configFlowEntryId=null,this._showConfigFlow=!0}_onMoreInfo(e){const{entityId:t}=e.detail;this.hass&&t&&this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}_onFlowClose(){this._showConfigFlow=!1,this._configFlowDomain="",this._configFlowEntryId=null,this._closeEntrySelector()}_toggleDetailExpand(){this._detailExpanded=!this._detailExpanded}async _toggleVersionSelector(){if(this._showVersionSelector=!this._showVersionSelector,this._showVersionSelector&&(this._versionTab="stable",0===this._releases.length)){this._releasesLoading=!0;try{const e=this._detailRepo?.id||this._detailRepo?.full_name;if(e){const t=await de.getRepoReleases(e);this._releases=Array.isArray(t)?t:t.releases||[]}}catch(e){console.error("Failed to load releases:",e),this._releases=[]}this._releasesLoading=!1}}async _installVersion(e){const t=this._detailRepo?.id||this._detailRepo?.full_name;if(t&&e){this._installingVersion=!0;try{await de.installVersion(t,e),Mt(`${ge("installComplete")}: ${e}`,"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._closeDetail()}catch(e){Mt(`${ge("installFailed")}: ${e.message}`,"error")}this._installingVersion=!1}}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPythonScript"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}async _modalAction(e){const t=this._detailRepo;if(t)try{if("install"===e)await de.install(t.id||t.full_name,t.category),Mt(ge("installComplete"),"success");else if("update"===e)await de.update([t.id||t.full_name]),Mt(ge("updateStarted"),"success");else if("uninstall"===e){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Ht});if(!await e.show(this,{message:ge("confirmRemove",{repo:t.full_name||t.name}),confirmText:ge("remove"),danger:!0}))return;await de.remove(t.id||t.full_name),Mt(ge("removed"),"success")}else if("github"===e){const e=t.html_url||`https://github.com/${t.full_name}`;return void window.open(e,"_blank")}this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._closeDetail()}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}_checkTabsScrollable(){const e=this.renderRoot?.querySelector(".tabs-wrapper"),t=e?.querySelector(".tabs");e&&t&&e.classList.toggle("scrollable",t.scrollWidth>t.clientWidth)}async updated(e){super.updated(e),e.has("narrow")&&requestAnimationFrame(()=>this._checkTabsScrollable())}firstUpdated(){requestAnimationFrame(()=>this._checkTabsScrollable())}render(){const e=[{view:"browse",label:ge("tabBrowse"),icon:"",count:null},{view:"integrations",label:ge("tabIntegrations")||"集成管理",icon:"",count:null},{view:"updates",label:ge("tabUpdates"),icon:"",count:this.stats.available_updates},{view:"management",label:ge("tabManagement"),icon:"",count:null},{view:"settings",label:ge("tabSettings"),icon:"",count:null}],t=this._detailRepo,o=t?.installed||!1,i=o&&(t?.has_update||t?.installed_version&&t?.latest_version&&t.installed_version!==t.latest_version),r=t?fe(t.category):"#03a9f4";return U`
      <div class="store">
        ${this._error?U`
        ...
        <div class="header">
          ...
          <div class="header-right">
            ...
            ${(this.stats.pending_restart??0)>0?U`
            ...
            <div class="tabs" role="tablist">
              ${e.map(e=>U`
                <button class="tab ${this.currentView===e.view?"active":""}"
                  ...
                  ${e.icon?U`${e.icon} `:""}${e.label}
                  ${void 0!==e.count&&null!==e.count?U`<span class="badge" aria-label="${e.count}">${e.count}</span>`:""}
                </button>
              `)}
            </div>
          </div>
        ...
        <div class="content ${this._viewTransition?"transitioning":""}">
          ...
          <integrations-list .hass=${this.hass} ?hidden=${"integrations"!==this.currentView} @configure-integration=${this._onConfigureIntegration} @add-integration=${this._onAddIntegration} @more-info=${this._onMoreInfo}></integrations-list>
      ...
      ${this._showDetail&&t?U`
        <div class="modal-overlay" role="dialog" aria-modal="true" aria-label="${t.manifest_name||t.full_name||ge("detail")}" @click=${e=>{e.target===e.currentTarget&&this._closeDetail()}}>
          <div class="modal ${this._detailExpanded?"expanded":""}" @dblclick=${this._toggleDetailExpand} @pointerdown=${this._storeModalPointerDown}>
            ${this._detailExpanded?"":U`<div class="modal-expand-hint">${ge("dblZoomHint")||"双击放大"}</div>`}
            ...
            <div class="modal-body">
              ...
              ${t.authors&&t.authors.length?U`
                <div class="detail-authors">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                  ${t.authors.filter(e=>e&&"@user"!==e).map(e=>U`
              ...
              <div class="version-selector">
                ...
                ${this._showVersionSelector?U`
                  <div class="version-selector-body">
                    ${this._releasesLoading?U`
                      <div class="releases-loading">
                        <div class="spinner-sm"></div>
                        ${ge("loading")}
                      </div>
                    `:0===this._releases.length?U`
                    ...
                    `:U`
                      ...
                      `:""}
                      ${this._releases.filter(e=>"prerelease"===this._versionTab?e.prerelease:!e.prerelease).map(e=>U`
                        <div class="release-item ${this._changelogTag===(e.tag_name||e.tag)?"active":""}"
                             @click=${()=>this._loadChangelog(this._detailRepo,e.tag_name||e.tag)}>
                          <div class="release-info">
                            <div class="release-tag">
                              ${e.tag_name||e.tag||"?"}
                              ${e.prerelease?U`<span class="prerelease-badge">${ge("prerelease")}</span>`:""}
                            </div>
                            ${e.published_at||e.created_at?U`
              ...
              <!-- Changelog — always shown when data is loaded -->
              <div class="detail-changelog">
                <div class="detail-changelog-title">
                  ${this._changelogTag?ge("changelogTitleVersion")?.replace("{tag}",this._changelogTag)||`${this._changelogTag} 更新内容`:ge("changelogTitle")||"更新内容"}
                </div>
                ${this._changelogLoading?U`
                  <div class="readme-loading">
                    <div class="spinner-sm"></div>
                    ${ge("loading")||"加载中..."}
                  </div>
                `:this._changelogData?U`
                  <div class="changelog-body">${this._changelogData.body}</div>
                  ${this._changelogData.tag?U`
                    <div class="changelog-tag">${this._changelogData.tag}</div>
                  `:""}
                  ${this._changelogData.url?U`
      ...
      ${this._showEntrySelector?U`
        <div class="entry-overlay" role="dialog" aria-modal="true" aria-label="${ge("selectEntryTitle")}" @click=${()=>{this._closeEntrySelector()}}>
          <div class="entry-dialog" @click=${e=>e.stopPropagation()} @pointerdown=${this._entryPointerDown}>
            <div class="entry-header">
              ${this._entrySelectorDomain?U`
                <div class="entry-avatar">
                  <img class="entry-avatar-img" src="https://brands.home-assistant.io/${this._entrySelectorDomain}/icon.png" alt=""
                    @error=${function(){this.style.display="none";const e=this.parentElement.querySelector(".entry-avatar-letter");e&&(e.style.display="flex")}}>
                  <span class="entry-avatar-letter" style="display:none">${this._entrySelectorDomain.charAt(0).toUpperCase()}</span>
                </div>
              `:""}
              <div>
            ...
            <div class="entry-list">
              ${this._entrySelectorEntries.map(e=>U`
            ...
            <button class="entry-cancel" @click=${()=>{this._closeEntrySelector()}}>${ge("cancel")}</button>
          </div>
        </div>
      `:""}
  ...
  `;_getInitials(e){if(!e)return"?";const t=e.split("/");return(t[t.length-1]||e).charAt(0).toUpperCase()}_getIconUrls(e){const t=e.domain,o=e.full_name||e.repository_manifest?.full_name||"",i=o.split("/")[0],r=o.split("/")[1]||"",s=e.default_branch||"main",a=e.custom||e.is_custom||i&&"home-assistant"!==i;if(!t||"integration"!==e.category)return[];const n=[];return n.push(`https://brands.home-assistant.io/${t}/icon.png`),a&&(i&&r&&n.push(`https://raw.githubusercontent.com/${i}/${r}/${s}/custom_components/${t}/brand/icon.png`),n.push(`/api/hacs_vision_brand/${t}`),i&&n.push(`https://github.com/${i}.png`)),n}_getStatusBadge(e){if(e.pending_restart)return{label:ge("statusPendingRestart"),cls:"pending-restart"};const t=de.getPendingReloads();return e.installed&&t.length>0&&e.full_name&&t.includes(e.full_name)?{label:ge("statusPendingReload"),cls:"pending-reload"}:e.installed&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version)?{label:ge("statusPendingUpgrade"),cls:"update-available"}:e.installed?{label:ge("installed"),cls:"installed"}:null}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}_handleAction(e,t){e.stopPropagation(),this.dispatchEvent(new CustomEvent(t,{detail:{repo:this.repo},bubbles:!0,composed:!0}))}async _handleFavorite(e){e.stopPropagation();const t=this.repo.id||this.repo.full_name,o=[...this.favorites],i=o.indexOf(t);i>=0?(o.splice(i,1),this._isFavorite=!1):(o.push(t),this._isFavorite=!0);try{await de.setFavorites(o),this.favorites=o}catch(e){this._isFavorite=!this._isFavorite}this.dispatchEvent(new CustomEvent("favorite",{detail:{repo:this.repo,isFavorite:this._isFavorite},bubbles:!0,composed:!0}))}_handleCardClick(){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:this.repo},bubbles:!0,composed:!0}))}render(){const e=this.repo,t=e.manifest_name||e.repository_manifest?.name||e.full_name||e.name||"unknown",o=e.description||"",i=e.category||"integration",r=e.stars||e.stargazers_count||0,s=e.downloads||0,a=e.installed||!1,n=a&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version),l=fe(i),d=this._getIconUrls(e);return U`
      <div class="card${e.is_custom?" custom-repo":""}" @click=${this._handleCardClick}>
        <div class="img-container">
          ...
          `:U`<span class="badge ${i}" style="position:absolute;top:10px;left:10px;">${this._getCategoryLabel(i)}</span>`}
          <div class="avatar">
            ${d.length>0?U`
          ...
          ${this._getStatusBadge(e)?U`<span class="status-badge ${this._getStatusBadge(e).cls}">${this._getStatusBadge(e).label}</span>`:""}
          <!-- Right-side badges (symmetrical with status-badge) -->
          <div class="right-tags">
            ${e.config_entry_id?U`<span class="tag configured">${ge("badgeConfigured")}</span>`:""}
            ${e.load_failed?U`<span class="tag load-failed">${ge("badgeLoadFailed")}</span>`:""}
            ${e.is_custom&&"management"!==this.viewMode?U`<span class="tag custom-tag">${ge("customBadge")}</span>`:""}
            ${this.renamedFrom?U`<span class="tag" style="background:#ff9800;color:#fff;font-weight:600;display:flex;align-items:center;gap:2px;"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:10px;height:10px;"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${this.renamedFrom}</span>`:""}
          </div>
          ${"management"!==this.viewMode?U`
        ...
        <div class="content">
          ...
          <div class="meta">
            <div class="tags">
              ${e.topics&&e.topics.length?e.topics.slice(0,3).map(e=>U`<span class="topic-tag">${e}</span>`):""}
            </div>
            <span class="stars">
            ...
            ${"store"!==this.viewMode?U`
              <span style="font-size:10px;color:var(--secondary-text-color);display:flex;align-items:center;gap:3px;">
                ...
                ${n?U`${e.installed_version||"?"} → <span style="color:var(--primary-color);font-weight:600;">${e.latest_version||"?"}</span>`:e.installed_version||ge("installed")}
              </span>
            `:""}
          </div>
        </div>
        ...
        <div class="actions">
          ${this.showRemoveBtn?U`
            <button class="action-btn ${this._removing?"installing":""}"
              ...
              ${this._removing?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>`}
        ...
        <div class="actions">
          ...
          ${a?U`
            ${n?U`
              <button class="action-btn primary ${this._updating?"installing":""}"
                ...
                ${this._updating?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg>`}
                <span class="label">${this._updating?ge("updatingProgress"):ge("update")}</span>
              </button>
            `:""}
            <button class="action-btn ${this._updating?"installing":""}"
              @click=${e=>{this._updating=!0,this._handleAction(e,"redownload")}} ?disabled=${this._updating}
              ...
              <span class="label">${ge("redownload")}</span>
            </button>
            ${"integration"===i?U`
          ...
          `:U`
            <button class="action-btn primary ${this._installing?"installing":""}"
              ...
              ${this._installing?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> ${ge("installing")}`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg><span class="label">${ge("install")}</span>`}
            </button>
          `}
        </div>
        `}
  ...
  `;async connectedCallback(){super.connectedCallback(),await this._loadFavorites(),await this._load(),this.addEventListener("install",e=>this._handleInstall(e.detail.repo)),this.addEventListener("update",e=>this._handleUpdate(e.detail.repo)),this.addEventListener("uninstall",e=>this._handleUninstall(e.detail.repo)),this.addEventListener("redownload",e=>this._handleRedownload(e.detail.repo)),this.addEventListener("ignore",e=>this._handleIgnore(e.detail.repo)),this.addEventListener("configure",e=>this._handleConfigure(e.detail.repo)),this.addEventListener("add-integration",e=>this._handleAddIntegration(e.detail.repo)),this.addEventListener("favorite",e=>{const{isFavorite:t,repo:o}=e.detail,i=o?.id||o?.full_name;i&&(t&&!this._favorites.includes(i)?this._favorites=[...this._favorites,i]:t||(this._favorites=this._favorites.filter(e=>e!==i))),this._syncFavoriteCount()})}willUpdate(e){if(e.has("presetFilter")){const t=this.presetFilter;if(void 0===e.get("presetFilter")&&""===t)return;this.presetFilter="",this.statusFilter=t,this.page=1,this._persistState(),this._load()}if(e.has("presetTag")&&this.presetTag){const e=this.presetTag;this.presetTag="",this._tagFilters.includes(e)?this._tagFilters=this._tagFilters.filter(t=>t!==e):this._tagFilters=[...this._tagFilters,e],this.page=1,this._load()}}async _loadFavorites(){try{const e=await de.getFavorites();this._favorites=Array.isArray(e)?e:e.favorites||[]}catch(e){this._favorites=[]}}_syncFavoriteCount(){this.requestUpdate()}_persistState(){!function(e){try{localStorage.setItem(Ut,JSON.stringify(e))}catch{}}({search:this.search,category:this.category,statusFilter:this.statusFilter,sort:this.sort,sortDir:this.sortDir,page:this.page,groupBy:this.groupBy,pageSize:this.pageSize})}async _handleInstall(e){const t=e.id||e.full_name;this._installingIds={...this._installingIds,[t]:!0};try{await de.install(t,e.category),Mt(`${ge("installComplete")}: ${e.full_name||e.name}`,"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load(),this._showPostInstallPrompt(e)}catch(e){Mt(`${ge("installFailed")}: ${e.message}`,"error")}const o={...this._installingIds};delete o[t],this._installingIds=o}async _showPostInstallPrompt(e){const t="integration"===(e.category||"integration");await new Promise(e=>setTimeout(e,1500));const{ConfirmDialog:o}=await Promise.resolve().then(function(){return Ht});if(t){if(!await o.show(this,{message:`${e.manifest_name||e.name} ${ge("postInstallRestartMsg")}`,confirmText:ge("restartHA"),cancelText:ge("later"),danger:!0}))return;try{await de.restartHA(),Mt(ge("haRestarting"),"info")}catch(e){Mt(`${ge("restartFailed")}: ${e.message}`,"error")}}else{Mt(ge("reloadingHA"),"info");try{const e=await de.reloadHA();e.success?Mt(ge("reloadSuccess"),"success"):Mt(`${ge("coreReloadFailed")}: ${e.error}`,"error")}catch(e){Mt(`${ge("coreReloadFailed")}: ${e.message}`,"error")}}}async _handleUpdate(e){try{const t=await de.update([e.id||e.full_name]);t?.success?.length>0?Mt(`${ge("updateComplete")}: ${e.full_name||e.name}`,"success"):Mt(`${ge("updateFailed")}: ${e.full_name||e.name}`,"error"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load(),this._showPostInstallPrompt(e)}catch(e){console.error("Update failed",e),Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}async _handleRedownload(e){try{const t=await de.redownload(e.id||e.full_name,e.category);t?.success?Mt(`${ge("redownload")}: ${e.full_name||e.name}`,"success"):Mt(`${ge("updateFailed")}: ${t?.error||e.full_name}`,"error"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load()}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}async _handleIgnore(e){if(await Pt.show(this,{message:ge("confirmIgnore",{repo:e.full_name||e.name}),confirmText:ge("ignore"),danger:!1}))try{await de.ignoreRepo(e.id||e.full_name),Mt(`${ge("ignore")}: ${e.full_name||e.name}`,"success"),this._load()}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}async _handleUninstall(e){if(await Pt.show(this,{message:ge("confirmRemove",{repo:e.full_name||e.name}),confirmText:ge("remove"),danger:!0}))try{await de.remove(e.id||e.full_name),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load()}catch(e){console.error("Uninstall failed",e),Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}_handleConfigure(e){const t=e.domain||(e.full_name||"").split("/")[1]||"";this.dispatchEvent(new CustomEvent("open-options-flow",{detail:{entryId:e.config_entry_id,domain:t},bubbles:!0,composed:!0}))}_handleAddIntegration(e){const t=e.domain||(e.full_name||"").split("/")[1]||"";this.dispatchEvent(new CustomEvent("open-flow",{detail:{domain:t},bubbles:!0,composed:!0}))}async _load(){this.loading=!0;try{const e=!(!this.search||!this.search.match(/github\.com\/([^/]+\/[^/\s?#]+)/i)&&!this.search.match(/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/));let t=this.search;if(e){const e=this.search.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);e&&(t=e[1].replace(/\.git$/,""))}const o=1===this._tagFilters.length?this._tagFilters[0]:"",i=await de.listRepositories({search:t,category:this.category,sort:this.sort,sortDir:this.sortDir,page:this.page,limit:this.limit,status:this.statusFilter,tag:o});this.repos=i.repositories||[],this.total=i.total||0,this.categoryCounts=i.category_counts||{},this.statusCounts=i.status_counts||{},this.tagCounts=i.tag_counts||{},this.tagCounts={...this.tagCounts,favorites:this._favorites.length}}catch(e){console.error("Browse load error",e),this.repos=[],this.total=0}this.loading=!1}_onSearch(e){this._searchText=e.target.value,this._showSearchHistory=!1,clearTimeout(this._searchTimer),this._searchTimer=setTimeout(()=>{this.search=this._searchText,this.page=1,this._persistState(),this._load(),this._searchText&&function(e){if(!e||!e.trim())return;e=e.trim();let t=qt();t=t.filter(t=>t!==e),t.unshift(e),t.length>10&&(t=t.slice(0,10));try{localStorage.setItem(Vt,JSON.stringify(t))}catch{}}(this._searchText)},300)}_onSearchFocus(){const e=qt();e.length>0&&(this._searchHistory=e,this._showSearchHistory=!0)}_onSearchHistoryClick(e){this._showSearchHistory=!1,this._searchText=e,this.search=e,this.page=1,this._persistState(),this._load()}_clearSearchHistory(e,t){e.stopPropagation(),function(e){let t=qt().filter(t=>t!==e);try{localStorage.setItem(Vt,JSON.stringify(t))}catch{}}(t),this._searchHistory=qt(),0===this._searchHistory.length&&(this._showSearchHistory=!1)}_clearSearch(){this._searchText="",this.search="",this.page=1,this._showSearchHistory=!1,this._persistState(),this._load()}_onStatusFilter(e){this.statusFilter=e,this.page=1,this._persistState(),this._load()}_onTypeFilter(e){this.category=e,this.page=1,this._persistState(),this._load()}_onTagFilter(e){this._tagFilters.includes(e)?this._tagFilters=this._tagFilters.filter(t=>t!==e):this._tagFilters=[...this._tagFilters,e],this.page=1,this._load()}_onSortColumn(e){this.sort===e?this.sortDir="desc"===this.sortDir?"asc":"desc":(this.sort=e,this.sortDir="name"===e?"asc":"desc"),this.page=1,this._persistState(),this._load()}_onGroupChange(e){this.groupBy=e.target.value,this._persistState()}_onViewModeChange(e){this.viewMode=e;try{localStorage.setItem(jt,e)}catch{}}_toggleGroup(e){this._collapsedGroups={...this._collapsedGroups,[e]:!this._collapsedGroups[e]}}_goPage(e){this.page=e,this._persistState(),this._load()}_onPageSizeChange(e){this.pageSize=parseInt(e.target.value,10),this.limit=this.pageSize,this.page=1,this._persistState(),this._load()}_refresh(){this.page=1,this._persistState(),this._load()}async _addRepo(){const e=this._parseRepoUrl(this._newRepoUrl);if(e){this._addRepoInstalling=!0;try{const t=await de.addCustomRepo(e,this._newRepoCategory);t.success?(Mt(`${ge("addSuccess")}: ${e}`,"success"),this._newRepoUrl="",this._showAddRepo=!1,this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))):Mt(`${ge("addFailed")}: ${t.error}`,"error")}catch(e){Mt(`${ge("addFailed")}: ${e.message}`,"error")}this._addRepoInstalling=!1}else Mt(ge("invalidRepoUrl"),"error")}_parseRepoUrl(e){const t=e.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return t?t[1].replace(/\.git$/,""):/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/.test(e)?e:null}_getRepoStatus(e){return e.pending_restart?"pending_restart":e.installed&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version)?"pending-upgrade":e.installed?"installed":"default"}_getStatusBadge(e){const t={installed:{label:ge("statusInstalled"),cls:"installed"},"pending-upgrade":{label:ge("statusPendingUpgrade"),cls:"pending-upgrade"},"pending-restart":{label:ge("statusPendingRestart"),cls:"pending-restart"},default:{label:ge("statusDefault"),cls:"default"}}[e]||{label:e,cls:"default"};return U`<span class="status-badge ${t.cls}">${t.label}</span>`}_getStatusLabel(e){return{installed:ge("statusInstalled"),not_installed:ge("statusDefault"),update_available:ge("statusPendingUpgrade"),pending_restart:ge("statusPendingRestart")}[e]||e}_applyFilters(e){return this._tagFilters.includes("favorites")?e.filter(e=>this._favorites.includes(e.id||e.full_name)):e}_getFiltered(){let e=this._applyFilters(this.repos);if(!this.search)return e;const t=this.search.toLowerCase();let o=null;const i=t.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return i&&(o=i[1].replace(/\.git$/,"").toLowerCase()),e.filter(e=>{const i=(e.full_name||"").toLowerCase(),r=(e.name||"").toLowerCase(),s=(e.description||"").toLowerCase(),a=(e.authors||[]).join(",").toLowerCase(),n=(e.manifest_name||e.repository_manifest?.name||"").toLowerCase();return!!(i.includes(t)||r.includes(t)||s.includes(t)||a.includes(t))||(!(!o||i!==o&&!i.includes(o))||!!n.includes(t))})}_groupRepos(e){if("none"===this.groupBy)return null;const t={};for(const o of e){let e;e="status"===this.groupBy?this._getRepoStatus(o):"type"===this.groupBy&&o.category||"other",t[e]||(t[e]=[]),t[e].push(o)}const o=["pending-restart","pending-upgrade","installed","default"],i=["integration","plugin","theme","template","other"],r=Object.keys(t);return"status"===this.groupBy?r.sort((e,t)=>o.indexOf(e)-o.indexOf(t)):"type"===this.groupBy&&r.sort((e,t)=>i.indexOf(e)-i.indexOf(t)),r.map(e=>({key:e,label:"status"===this.groupBy?this._getStatusLabel(e):this._getCategoryLabel(e),repos:t[e]}))}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),template:ge("catTemplate"),other:e}[e]||e}_formatDate(e){if(!e)return"";try{const t=new Date(e),o=new Date-t,i=Math.floor(o/864e5);return 0===i?ge("today")||"今天":1===i?ge("yesterday")||"昨天":i<30?`${i}d`:i<365?`${Math.floor(i/30)}mo`:`${Math.floor(i/365)}y`}catch{return""}}_toggleSelect(e){this._selectedRepos.includes(e)?this._selectedRepos=this._selectedRepos.filter(t=>t!==e):this._selectedRepos=[...this._selectedRepos,e]}_isAllSelected(){const e=this._getFiltered();return e.length>0&&this._selectedRepos.length===e.length}_toggleSelectAll(){const e=this._getFiltered();this._isAllSelected()?this._selectedRepos=[]:this._selectedRepos=e.map(e=>e.full_name).filter(Boolean)}async _batchDo(e){if(0===this._selectedRepos.length)return;const t=this._selectedRepos.map(e=>{const t=this.repos.find(t=>t.full_name===e);return{repository:e,category:t?.category||"integration"}});if("remove"===e){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Ht});if(!await e.show(this,{message:ge("batchRemoveConfirm",{n:t.length}),confirmText:ge("batchRemove"),danger:!0}))return}try{let o;Mt(ge("batchInProgress"),"info"),o="install"===e?await de.batchInstall(t):"update"===e?await de.update(t.map(e=>e.repository)):await de.batchRemove(t.map(e=>e.repository)),Mt(ge("batchComplete"),"success"),this._selectedRepos=[],this._load()}catch(t){Mt(`${e} failed: ${t.message}`,"error")}}async _restartHA(){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Ht});if(await e.show(this,{message:this.t?.("restartConfirm"),confirmText:this.t?.("restartHA"),danger:!0}))try{await de.restartHA(),Mt(this.t?.("haRestarting"),"info")}catch(e){Mt(`${this.t?.("restartFailed")}: ${e.message}`,"error")}}_renderRepoList(e){return"list"===this.viewMode?U`<div class="list-view">${this._renderListTable(e)}</div>`:U`<div class="grid">${e.map(e=>U`
    ...
    `)}</div>`}_renderListTable(e){const t=e=>this.sort!==e?"":"desc"===this.sortDir?" ▼":" ▲",o=e=>"sortable "+(this.sort===e?"active-sort":"");return U`
    ...
    `}_renderListRow(e){const t=fe(e.category||"integration"),o=e.manifest_name||e.repository_manifest?.name||e.full_name||e.name||"?",i=e.stars||e.stargazers_count||0,r=e.downloads||0,s=this._getRepoStatus(e),a=e.installed||!1,n="pending-upgrade"===s,l=e.id||e.full_name,d=!!this._installingIds?.[l];return U`
      <tr @click=${()=>this._handleDetail(e)}>
        <td class="col-icon"><div class="icon-cell" style="background:${t}">
          ${e.domain&&"integration"===e.category?U`
        ...
        <td class="name-cell">${o}<br><span class="desc-cell">${e.description||""}</span>
          ${e.is_custom?U`<span class="custom-tag-list">${ge("customBadge")}</span>`:""}
          ${e.topics&&e.topics.length?U`<br><span class="topic-chips">${e.topics.slice(0,4).map(e=>U`<span class="topic-chip">${e}</span>`)}</span>`:""}
        </td>
        ...
        <td class="actions-cell">
          ${a?U`
            ${n?U`<button class="action-sm primary" @click=${t=>{t.stopPropagation(),this._handleUpdate(e)}}>${ge("update")}</button>`:""}
          `:U`
            <button class="action-sm primary ${d?"installing":""}" @click=${t=>{t.stopPropagation(),this._handleInstall(e)}} ?disabled=${d}>${d?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:ge("install")}</button>
          `}
        </td>
      </tr>
    `}render(){const e=Math.ceil(this.total/this.limit),t=this._getFiltered(),o=this._groupRepos(t);return U`
      ...
      <div class="controls">
        <div class="search">
          ...
          ${this.search?U`<button class="search-clear" @click=${this._clearSearch}>✕</button>`:""}
          ${this._showSearchHistory&&this._searchHistory.length>0?U`
            <div class="search-history">
              ${this._searchHistory.map(e=>U`
      ...
      <div class="filter-sort-row ${this._filterExpanded?"expanded":""}">
        <div class="fs-chips">
          ...
          ${this.statusOptions.filter(e=>""===e.value||(this.statusCounts[e.value]??0)>0).map(e=>U`
            <button class="filter-chip ${this.statusFilter===e.value?"active":""}" @click=${()=>this._onStatusFilter(e.value)}>${e.label}${""===e.value?U`<span class="chip-count">${this.total??0}</span>`:""}</button>
          `)}
          ...
          ${this.typeOptions.filter(e=>""===e.value||(this.categoryCounts[e.value]??0)>0).map(e=>U`
          ...
          ${this.sortColumns.map(e=>U`
            <button class="filter-chip sort-inline ${this.sort===e.key?"active":""}" @click=${()=>this._onSortColumn(e.key)}>
              ${e.label}${this.sort===e.key?U`<span class="sort-dir">${"desc"===this.sortDir?"▼":"▲"}</span>`:""}
            </button>
          `)}
        </div>
      ...
      <div style="display:flex;align-items:center;gap:12px;padding:8px 0;margin-bottom:4px;">
        ...
        <span style="font-size:13px;color:var(--secondary-text-color);">
          ...
          ${this._selectedRepos.length>0?U`| <strong>${this._selectedRepos.length}</strong> ${ge("selected")}`:""}
        </span>
      </div>
      ...
      `}
    `}}customElements.define("browse-view",Yt);class Gt extends ae{static properties={updates:{type:Array},loading:{type:Boolean},updating:{type:Boolean},search:{type:String},_installingIds:{type:Object,state:!0},_changelogs:{type:Object,state:!0},_searchText:{type:String,state:!0},_selectedIds:{type:Object,state:!0},_selectedRepos:{type:Array,state:!0},_batchMode:{type:Boolean,state:!0},_viewMode:{type:String,state:!0}};constructor(){super(),this.updates=[],this.loading=!1,this.updating=!1,this.search="",this._searchTimer=null,this._installingIds={},this._changelogs={},this._changelogsLoading={},this._expandedChangelogs={},this._searchText="",this._selectedIds={},this._selectedRepos=[],this._batchMode=!1;const e=(()=>{try{return localStorage.getItem("hacs_vision_view_mode")}catch{return null}})();this._viewMode=e||"card"}static styles=[me(),s`
      :host { display: block; touch-action: manipulation; background: var(--primary-background-color); }
    ...
    `];async connectedCallback(){super.connectedCallback(),await this._load()}_lazyLoadChangelogs(){const e=this.updates.filter(e=>e.full_name&&!this._changelogs[e.full_name]);if(0===e.length)return;let t=0;const o=()=>{t>=e.length||(this._loadChangelog(e[t++].full_name),setTimeout(o,150))};setTimeout(o,300)}async _load(){this.loading=!0;try{de.refresh().catch(()=>{});const e=await de.getUpdates();this.updates=Array.isArray(e)?e:e.updates||[],this._lazyLoadChangelogs()}catch(e){console.error("Failed to load updates",e),this.updates=[]}this.loading=!1}async _loadChangelog(e){if(e&&!this._changelogs[e]&&!this._changelogsLoading[e]){this._changelogsLoading={...this._changelogsLoading,[e]:!0};try{const t=await de.getChangelog(e);t?.body&&(this._changelogs={...this._changelogs,[e]:t})}catch{}this._changelogsLoading={...this._changelogsLoading,[e]:!1}}}_toggleChangelog(e){this._expandedChangelogs={...this._expandedChangelogs,[e]:!this._expandedChangelogs?.[e]}}async _loadChangelogs(){const e=this.updates.filter(e=>e.full_name);if(0===e.length)return;const t=await Promise.allSettled(e.map(e=>de.getChangelog(e.full_name).then(t=>({fullName:e.full_name,data:t})))),o={};for(const e of t)"fulfilled"===e.status&&e.value.data?.body&&(o[e.value.fullName]=e.value.data);Object.keys(o).length>0&&(this._changelogs={...this._changelogs,...o})}async _updateSelected(){const e=Object.keys(this._selectedIds).filter(e=>this._selectedIds[e]);if(0===e.length)return;if(await Pt.show(this,{message:ge("confirmUpdateSelected",{n:e.length}),confirmText:ge("confirmUpdate"),danger:!1})){this.updating=!0;try{await de.update(e),Mt(`${ge("allUpdatesStarted")} (${e.length})`,"success"),this._selectedIds={},this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}this.updating=!1}}async _updateAll(){const e=this.updates.map(e=>e.id||e.full_name);if(0===e.length)return;if(await Pt.show(this,{message:ge("confirmUpdateAll",{n:e.length}),confirmText:ge("confirmUpdate"),danger:!1})){this.updating=!0;try{await de.update(e),Mt(`${ge("allUpdatesStarted")} (${e.length})`,"success"),this._selectedIds={},this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}this.updating=!1}}_toggleSelect(e){this._selectedIds={...this._selectedIds,[e]:!this._selectedIds[e]}}_toggleSelectFull(e){this._selectedRepos.includes(e)?this._selectedRepos=this._selectedRepos.filter(t=>t!==e):this._selectedRepos=[...this._selectedRepos,e]}async _batchDo(e){if(0!==this._selectedRepos.length){if("remove"===e){if(!await Pt.show(this,{message:ge("batchRemoveConfirm",{n:this._selectedRepos.length}),confirmText:ge("batchRemove"),danger:!0}))return}try{Mt(ge("batchInProgress"),"info"),"update"===e?await de.update(this._selectedRepos):"remove"===e&&await de.batchRemove(this._selectedRepos.map(e=>e)),Mt(ge("batchComplete"),"success"),this._selectedRepos=[],this._batchMode=!1,this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(t){Mt(`${e} failed: ${t.message}`,"error")}}}_toggleSelectAll(){const e=this._getFiltered();if(this._isAllSelected())this._selectedIds={};else{const t={};for(const o of e)t[o.id||o.full_name]=!0;this._selectedIds=t}}_isAllSelected(){const e=this._getFiltered();return 0!==e.length&&e.every(e=>this._selectedIds[e.id||e.full_name])}_selectedCount(){return Object.keys(this._selectedIds).filter(e=>this._selectedIds[e]).length}async _updateOne(e){const t=e.id||e.full_name;this._installingIds={...this._installingIds,[t]:!0};try{await de.update([t]);const o=e.latest_version;let i=0;const r=async()=>{if(i++>30){const e={...this._installingIds};return delete e[t],this._installingIds=e,void Mt(`${ge("updateFailed")}: timeout`,"error")}try{const i=await de.getRepoStatus(t);if(i?.installed_version===o||i?.installed&&!i?.has_update){const o={...this._installingIds};return delete o[t],this._installingIds=o,Mt(`${ge("updateComplete")}: ${e.full_name||e.name}`,"success"),this._load(),void this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}}catch(e){}setTimeout(r,2e3)};setTimeout(r,2e3)}catch(e){const o={...this._installingIds};delete o[t],this._installingIds=o,Mt(`${ge("updateFailed")}: ${e.message}`,"error")}}_getFiltered(){if(!this.search)return this.updates;const e=this.search.toLowerCase();return this.updates.filter(t=>(t.full_name||t.name||"").toLowerCase().includes(e))}_clearSearch(){this._searchText="",this.search="",this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_openDetail(e){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:e},bubbles:!0,composed:!0}))}_setViewMode(e){this._viewMode=e;try{localStorage.setItem("hacs_vision_view_mode",e)}catch{}}_renderListTable(e){return U`
      <table class="list-table">
        <thead>
          <tr>
            <th class="col-icon"></th>
    ...
    `}_renderListRow(e){const t=e.id||e.full_name,o=!!this._installingIds?.[t],i=!!this._selectedIds[t],r=e.manifest_name||e.name||e.full_name||"?",s=fe(e.category),a=e.domain;return U`
      <tr @click=${t=>{t.target.closest(".btn")||t.target.closest("a")||t.target.closest(".checkbox")||this._openDetail(e)}}>
        ...
        <td>
          ...
          ${e.description?U`<div class="desc-cell">${e.description}</div>`:""}
          ${e.is_custom?U`<span class="custom-tag-list">${ge("customBadge")}</span>`:""}
          ${e.topics&&e.topics.length?U`<div class="topic-chips">${e.topics.slice(0,4).map(e=>U`<span class="topic-chip">${e}</span>`)}</div>`:""}
        </td>
        ...
        <td style="white-space:nowrap;">
          ...
          <button class="btn primary ${o?"installing":""}" style="padding:4px 10px;font-size:11px;"
            ...
            ${o?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:U`<svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${ge("updateNow")}`}
          </button>
        </td>
      </tr>
    `}render(){const e=this._getFiltered();return U`
      <div class="controls">
        <div class="search">
          <svg class="search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/>
      ...
      `:U`
        ...
        ${this.updates.length>1?U`
          <div class="update-all-bar">
            ${this._selectedCount()>0?U`
        ...
        ${this._batchMode&&this._selectedRepos.length>0?U`
          <div class="batch-bar">
        ...
        ${"list"===this._viewMode?U`
          <div class="list-view">${this._renderListTable(e)}</div>
        `:U`
          <div class="grid">
            ${e.map(e=>{const t=e.id||e.full_name,o=!!this._installingIds?.[t],i=this._changelogs?.[e.full_name],r=!!this._selectedIds[t];return U`
              <div class="card" @click=${t=>{t.target.closest(".btn")||t.target.closest("a")||t.target.closest(".checkbox")||this._openDetail(e)}}>
                <div class="card-header">
                  <div class="card-left">
                    ...
                    <div class="card-name">
                      ${e.name||e.full_name}
                      ${e.category?U`<span class="category-badge">${e.category}</span>`:""}
                    </div>
                  </div>
                </div>
                ...
                ${i?.body?U`
                  <div class="changelog-preview">
                    <div class="changelog-preview-title">${ge("changelogTitle")} ${i.tag?U`<small>(${i.tag})</small>`:""}</div>
                ...
                <button class="btn primary ${o?"installing":""}"
                  ...
                  ${o?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> ${ge("updatingProgress")}`:U`<svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${ge("updateNow")}`}
                </button>
              </div>
            `})}
          </div>
        `}
      `}
    `}}customElements.define("updates-view",Gt);const Xt="hacs_vision_mgmt_state";function Wt(e){try{localStorage.setItem(Xt,JSON.stringify(e))}catch{}}class Jt extends ae{static properties={customRepos:{type:Array},archivedRepos:{type:Array},ignoredRepos:{type:Array},renamedEntries:{type:Array},loading:{type:Boolean},_customRepoUrl:{type:String},_customRepoCategory:{type:String},_showAddCustom:{type:Boolean},_addingCustom:{type:Boolean},erLoading:{type:Boolean},iLoading:{type:Boolean},importing:{type:Boolean},exporting:{type:Boolean},_viewMode:{type:String},_collapsed:{type:Object},_renamedRefreshing:{type:Boolean},_depResults:{type:Object},_depLoading:{type:Boolean},_customRepoSearch:{type:String},_customRepofilter:{type:String},_customRepoSort:{type:String},_statusFilter:{type:String},_typeFilter:{type:String},_selectedRepos:{type:Array,state:!0},_favorites:{type:Array,state:!0},_tagFilters:{type:Array,state:!0}};constructor(){super();const e=function(){try{return JSON.parse(localStorage.getItem(Xt)||"{}")}catch{return{}}}();this.customRepos=[],this.archivedRepos=[],this.ignoredRepos=[],this.renamedEntries=[],this.loading=!1,this.exporting=!1,this.importing=!1,this._depResults=null,this._depLoading=!1,this._renamedRefreshing=!1,this._showAddCustom=!1,this._customRepoUrl="",this._customRepoCategory="integration",this._addingCustom=!1,this._viewMode="card",this._customRepoSearch="",this._customRepofilter=e.customRepofilter||"all",this._customRepoSort=e.customRepoSort||"name",this._statusFilter=e.statusFilter||"",this._typeFilter=e.typeFilter||"",this._selectedRepos=[],this._favorites=[],this._tagFilters=[],this._collapsed={customRepos:!1,archived:!1,ignored:!1,tools:!1}}static styles=[me(),s`
    :host { display: block; touch-action: manipulation; background: var(--primary-background-color); }
  ...
  `];async connectedCallback(){super.connectedCallback(),await this._load()}async _load(){this.loading=!0;try{const e=await de.getConfig()||{};this.archivedRepos=e.archived_repositories||[],this.ignoredRepos=e.ignored_repositories||[],this.renamedEntries=Object.entries(e.renamed_repositories||{});const t=await de.getCustomRepos();this.customRepos=Array.isArray(t)?t:t.custom_repositories||[];try{const e=await de.getFavorites();this._favorites=Array.isArray(e)?e:e.favorites||[]}catch{this._favorites=[]}}catch(e){console.error("Config load error",e)}this.loading=!1}async _removeArchivedRepo(e){if(await Pt.show(this,{message:ge("confirmRemoveArchived",{repo:e}),confirmText:ge("removeArchived"),danger:!0}))try{await de.removeArchivedRepo(e),this._load()}catch(e){Mt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}async _removeRenamedRepo(e){if(await Pt.show(this,{message:ge("confirmRemoveRenamed",{old:e}),confirmText:ge("removeRenamed"),danger:!0}))try{await de.removeRenamedRepo(e),this._load()}catch(e){Mt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}async _replaceRenamedOneClick(e,t){if(await Pt.show(this,{message:ge("confirmReplaceRenamed",{old:e,new:t}),confirmText:ge("replace"),danger:!0})){this._renamedRefreshing=!0;try{await de.replaceRenamedRepo(e,t),Mt(`${ge("replace")}: ${e} → ${t}`,"success"),await de.refresh(),this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Mt(`${ge("updateFailed")}: ${e.message}`,"error")}this._renamedRefreshing=!1}}async _checkDependencies(){this._depLoading=!0;try{const e=await de.checkDependencies();this._depResults=e,e.all_ok?Mt(ge("depOk"),"success"):Mt(`${ge("depMissing")} (${e.issues_count})`,"error")}catch(e){this._depResults=null,Mt(`${ge("checkFailed")}: ${e.message}`,"error")}this._depLoading=!1}_depMissingCount(){return this._depResults?.dependencies?this._depResults.dependencies.filter(e=>e.has_issues).length:0}async _export(){this.exporting=!0;try{const e=await de.exportBackup(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),o=URL.createObjectURL(t),i=document.createElement("a");i.href=o,i.download=`hacs-vision-backup-${(new Date).toISOString().slice(0,10)}.json`,i.click(),URL.revokeObjectURL(o),Mt(ge("exportSuccess"),"success")}catch(e){Mt(`${ge("exportFailed")}: ${e.message}`,"error")}this.exporting=!1}async _import(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=async()=>{const t=e.files[0];if(t){this.importing=!0;try{const e=await t.text(),o=JSON.parse(e);await de.importBackup(o),Mt(ge("importSuccess"),"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Mt(`${ge("importFailed")}: ${e.message}`,"error")}this.importing=!1}},e.click()}_toggleAddCustom(){this._showAddCustom=!this._showAddCustom,this._showAddCustom||(this._customRepoUrl="",this._customRepoCategory="integration")}_parseRepoUrl(e){const t=(e=e.trim()).match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return t?t[1].replace(/\.git$/,""):/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/.test(e)?e:null}async _addCustomRepo(){const e=this._parseRepoUrl(this._customRepoUrl);if(!e)return void Mt(ge("invalidRepoUrl"),"error");const t=this.customRepos.some(t=>(t.full_name||t.repository)===e);if(t)Mt(`${e} ${ge("alreadyExists")}`,"error");else{this._addingCustom=!0;try{const t=await de.addCustomRepo(e,this._customRepoCategory);t.success?(Mt(`${ge("addSuccess")}: ${e}`,"success"),this._customRepoUrl="",this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))):Mt(`${ge("addFailed")}: ${t.error}`,"error")}catch(e){Mt(`${ge("addFailed")}: ${e.message}`,"error")}this._addingCustom=!1}}async _removeCustomRepo(e,t){if(await Pt.show(this,{message:ge("confirmRemoveRepo",{repo:e}),confirmText:ge("removeRepo"),danger:!0}))try{const t=await de.removeCustomRepo(e);t&&!1===t.success&&Mt(`${ge("removeRepoFailed")}: ${t.error}`,"error"),this._selectedRepos=this._selectedRepos.filter(t=>t!==e),this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Mt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}_toggleSelectRepo(e){this._selectedRepos.includes(e)?this._selectedRepos=this._selectedRepos.filter(t=>t!==e):this._selectedRepos=[...this._selectedRepos,e]}async _batchRemove(){const e=this._selectedRepos.length;if(await Pt.show(this,{message:`${ge("batchRemoveRepoConfirm")||"确认移除"} ${e} ${ge("totalRepos")}?`,confirmText:ge("removeRepo"),danger:!0})){for(const e of[...this._selectedRepos])try{await de.removeCustomRepo(e)}catch(t){Mt(`${ge("removeRepoFailed")}: ${e} - ${t.message}`,"error")}this._selectedRepos=[],this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}}_toggleSection(e){this._collapsed={...this._collapsed,[e]:!this._collapsed[e]}}_setViewMode(e){this._viewMode=e}_openCardDetail(e){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:e},bubbles:!0,composed:!0}))}_getRepoStatus(e){return e.pending_restart?"pending_restart":e.installed&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version)?"update_available":e.installed?"installed":"not_installed"}_getFilteredCustomRepos(){let e=[...this.customRepos];const t=(this._customRepoSearch||"").toLowerCase();t&&(e=e.filter(e=>{const o=(e.manifest_name||e.name||e.full_name||"").toLowerCase(),i=(e.description||"").toLowerCase();return o.includes(t)||i.includes(t)}));const o=this._statusFilter||"";o&&(e=e.filter(e=>this._getRepoStatus(e)===o));const i=this._typeFilter||"";i&&(e=e.filter(e=>(e.category||"")===i)),this._tagFilters.includes("favorites")&&(e=e.filter(e=>this._favorites.includes(e.id||e.full_name)));const r=this._customRepoSort||"name";return"stars"===r?e.sort((e,t)=>(t.stargazers_count||0)-(e.stargazers_count||0)):"updated"===r?e.sort((e,t)=>(t.last_updated||"").localeCompare(e.last_updated||"")):e.sort((e,t)=>(e.manifest_name||e.name||e.full_name||"").localeCompare(t.manifest_name||t.name||t.full_name||"")),e}_getStatusCounts(){const e={installed:0,update_available:0,not_installed:0,pending_restart:0};for(const t of this.customRepos){const o=this._getRepoStatus(t);void 0!==e[o]&&e[o]++}return e}_getTypeCounts(){const e={};for(const t of this.customRepos){const o=t.category||"other";e[o]=(e[o]||0)+1}return e}_renderFilteredContent(e,t,o,i){const r=this._customRepofilter||"all";return"archived"===r?t.length>0?U`
        ...
        `)}</div>
      `:U`<div class="empty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;opacity:0.4;margin-bottom:8px;"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><div>${ge("noArchived")}</div></div>`:"ignored"===r?o.length>0?U`
        <div class="repo-cards">${o.map(e=>U`
          <div class="repo-card" style="cursor:default;">
        ...
        `)}</div>
      `:U`<div class="empty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;opacity:0.4;margin-bottom:8px;"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg><div>${ge("noIgnored")}</div></div>`:"renamed"===r?i.length>0?U`
        <div class="repo-cards">${i.map(([e,t])=>U`
          <div class="repo-card" style="cursor:default;">
        ...
        `)}</div>
      `:U`<div class="empty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;opacity:0.4;margin-bottom:8px;"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg><div>${ge("noRenamed")||"无重命名仓库"}</div></div>`:0===e.length?U`<div class="empty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;opacity:0.4;margin-bottom:8px;"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><div>${ge("noCustomRepos")}</div></div>`:"card"===this._viewMode?U`<div class="repo-cards">${this._getFilteredCustomRepos().map(e=>{const t=i.find(([t,o])=>o===(e.full_name||e.repository));return U`
          ...
          </repo-card>`})}</div>`:U`<div class="repo-list">${this._getFilteredCustomRepos().map(e=>this._renderListItem(e,i))}</div>`}_getInitials(e){if(!e)return"?";const t=e.split("/");return(t[t.length-1]||e).charAt(0).toUpperCase()}_getCategoryColor(e){return fe(e)}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPythonScript"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}_renderCard(e,t){const o=e.full_name||e.repository,i=e.manifest_name||e.name||o,r=t.find(([e,t])=>t===o),s=!!r,a=s?r[0]:null,n=e.installed_version||"",l=e.latest_version||"",d=e.has_update,c=e.stargazers_count||0,p=e.description||"",h=e.installed||!1,g=this._getCategoryColor(e.category);return U`
      <div class="repo-card" @click=${()=>this._openCardDetail(e)}>
        <div class="repo-card-img" style="background:linear-gradient(135deg, ${g}44 0%, ${g}22 100%);">
          ...
          ${e.is_custom?U`<span class="repo-card-custom">${ge("customBadge")}</span>`:""}
          ${s?U`<span class="repo-card-renamed"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${a}</span>`:""}
          ${h?U`<span class="repo-card-installed"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="#4caf50" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg> ${ge("installed")}</span>`:""}
        ...
        <div class="repo-card-body">
          ...
          ${e.topics&&e.topics.length?U`
            <div class="topic-chips" style="margin-top:6px;">
              ${e.topics.slice(0,3).map(e=>U`<span class="topic-chip">${e}</span>`)}
            </div>
          `:""}
          <div class="meta">
            <span class="stars">
            ...
            ${h?U`
              <span style="font-size:10px;color:var(--secondary-text-color);">
                <svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg> ${n}${d?U` <span class="update-badge"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${l}</span>`:""}
              </span>
            `:U`<span class="repo-not-installed">${ge("notInstalled")}</span>`}
          </div>
        </div>
      </div>
    `}_renderListItem(e,t){const o=e.full_name||e.repository,i=e.manifest_name||e.name||o,r=t.find(([e,t])=>t===o),s=!!r,a=s?r[0]:null,n=e.installed_version||"",l=e.latest_version||"",d=e.has_update,c=e.stargazers_count||0,p=e.description||"";return U`
      <div class="repo-item" @click=${()=>this._openCardDetail(e)}>
        ...
        <div class="repo-info">
          <div class="repo-top">
            ...
            ${e.is_custom?U`<span class="custom-badge-tag">${ge("customBadge")}</span>`:""}
            ${s?U`<span class="renamed-badge"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${a}</span>`:""}
          </div>
          <div class="repo-meta">
            ...
            ${e.installed?U`
              ...
              ${d?U`<span class="update-badge"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg> ${l}</span>`:""}
            `:U`<span class="repo-not-installed">${ge("notInstalled")}</span>`}
          </div>
          ${p?U`<div class="repo-desc">${p}</div>`:""}
          ${e.topics&&e.topics.length?U`
            <div class="topic-chips" style="margin-top:4px;">
              ${e.topics.slice(0,4).map(e=>U`<span class="topic-chip">${e}</span>`)}
            </div>
          `:""}
        </div>
        <div class="repo-actions">
          ...
          ${s?U`
            <button class="btn primary sm" @click=${e=>{e.stopPropagation(),this._replaceRenamedOneClick(a,o)}} ?disabled=${this._renamedRefreshing}>
              ${this._renamedRefreshing?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:ge("replace")}
            </button>
    ...
    `}render(){const{archivedRepos:e,ignoredRepos:t,renamedEntries:o,customRepos:i,loading:r,_viewMode:s,_collapsed:a}=this;return U`
      ${r?U`
      ...
      <div class="controls">
        <div class="search" style="flex:1;min-width:150px;">
          ...
          ${this._customRepoSearch?U`<button class="search-clear" @click=${()=>this._customRepoSearch=""}>✕</button>`:""}
        </div>
        <div class="controls-right">
        ...
        <div class="add-repo-form">
          <div class="form-row" style="display:flex;gap:8px;flex-wrap:wrap;">
            ...
            <select class="form-select" .value=${this._customRepoCategory} @change=${e=>this._customRepoCategory=e.target.value}>
              ${["integration","plugin","theme","dashboard","python_script","template","appdaemon","netdaemon"].map(e=>U`<option value=${e}>${this._getCategoryLabel(e)}</option>`)}
            </select>
          </div>
          <div class="form-actions" style="display:flex;gap:6px;margin-top:8px;">
            <button class="btn primary" @click=${this._addCustomRepo} ?disabled=${this._addingCustom||!this._customRepoUrl.trim()}>
              ${this._addingCustom?U`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> ${ge("add")}`:U`<svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg> ${ge("add")}`}
            </button>
            <button class="btn" @click=${this._toggleAddCustom}>${ge("cancel")}</button>
          </div>
          ${this._customRepoUrl.trim()&&this._parseRepoUrl(this._customRepoUrl)?U`
      ...
      <div style="display:flex;align-items:center;gap:8px;margin:8px 0;">
        <button class="btn" style="padding:4px 10px;font-size:12px;" @click=${this._checkDependencies} ?disabled=${this._depLoading}>
          ${this._depLoading?"⟳":"🔗"} ${ge("checkDeps")||"检查依赖"}
        </button>
        ${this._depResults?U`
          <span style="font-size:12px;">${this._depResults.all_ok?U`<span style="color:var(--success-color,#0f9d58);">✅ ${ge("depOk")}</span>`:U`<span style="color:#f44336;">⚠️ ${ge("depMissing")} (${this._depMissingCount()})</span>`}</span>
          <button class="btn" style="padding:2px 8px;font-size:11px;" @click=${()=>{this._depResults=null}}>✕</button>
        `:""}
      </div>
      ${this._depResults&&!this._depResults.all_ok?U`
        <div class="dep-panel">
          ${this._depResults.dependencies.filter(e=>e.has_issues).map(e=>U`
            <div class="dep-item">
              <div class="repo">${e.repository} ${e.installed?"✅":"❌"}</div>
              ${e.missing_requirements?.length?U`<div class="missing">缺少: ${e.missing_requirements.join(", ")}</div>`:""}
              ${e.missing_dependencies?.length?U`<div class="missing">依赖: ${e.missing_dependencies.join(", ")}</div>`:""}
            </div>
          `)}
        </div>
      `:""}
      ...
      <div class="filter-sort-row">
        <div class="fs-chips">
          ...
          ${e.length>0?U`<button class="filter-chip ${"archived"===this._customRepofilter?"active":""}" @click=${()=>{this._customRepofilter="archived",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>${ge("archivedRepos")} (${e.length})</button>`:""}
          ${o.length>0?U`<button class="filter-chip ${"renamed"===this._customRepofilter?"active":""}" @click=${()=>{this._customRepofilter="renamed",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>${ge("renamedRepos")} (${o.length})</button>`:""}
          ${t.length>0?U`<button class="filter-chip ${"ignored"===this._customRepofilter?"active":""}" @click=${()=>{this._customRepofilter="ignored",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>${ge("ignoredRepos")} (${t.length})</button>`:""}
          <span class="fs-divider"></span>
          <span class="fs-label">${ge("filterStatus")}</span>
          ...
          ${["installed","update_available","not_installed","pending_restart"].filter(e=>(this._getStatusCounts()[e]??0)>0).map(e=>U`
          ...
          ${Object.entries(this._getTypeCounts()).filter(([e,t])=>t>0).map(([e,t])=>U`
          ...
          <button class="filter-chip sort-inline ${"name"===this._customRepoSort?"active":""}" @click=${()=>{this._customRepoSort="name",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>
            ${ge("sortByName")}${"name"===this._customRepoSort?U`<span class="sort-dir">▲</span>`:""}
          </button>
          <button class="filter-chip sort-inline ${"stars"===this._customRepoSort?"active":""}" @click=${()=>{this._customRepoSort="stars",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>
            ${ge("sortByStars")}${"stars"===this._customRepoSort?U`<span class="sort-dir">▼</span>`:""}
          </button>
          <button class="filter-chip sort-inline ${"updated"===this._customRepoSort?"active":""}" @click=${()=>{this._customRepoSort="updated",Wt({customRepofilter:this._customRepofilter,customRepoSort:this._customRepoSort,statusFilter:this._statusFilter,typeFilter:this._typeFilter})}}>
            ${ge("sortByUpdated")}${"updated"===this._customRepoSort?U`<span class="sort-dir">▼</span>`:""}
          </button>
        </div>
      </div>
      ...
      <div style="display:flex;align-items:center;gap:12px;padding:8px 0;margin-bottom:4px;">
        ...
        ${"all"===this._customRepofilter?U`
          <span style="font-size:13px;color:var(--secondary-text-color);">
            ${ge("totalCount")||"共"} <strong>${this._getFilteredCustomRepos().length}</strong> ${ge("totalRepos")}
          </span>
        `:U`
          <span style="font-size:13px;color:var(--secondary-text-color);">
            ${"archived"===this._customRepofilter?U`${ge("archivedRepos")}: <strong>${e.length}</strong>`:""}
            ${"renamed"===this._customRepofilter?U`${ge("renamedRepos")}: <strong>${o.length}</strong>`:""}
            ${"ignored"===this._customRepofilter?U`${ge("ignoredRepos")}: <strong>${t.length}</strong>`:""}
          </span>
        `}
        ${this._selectedRepos.length>0?U`| <strong>${this._selectedRepos.length}</strong> ${ge("selected")||"已选"}`:""}
      </div>

      <!-- Batch Action Bar -->
      ${this._selectedRepos.length>0?U`
        <div class="batch-bar">
          <span>${ge("batchSelected",{n:this._selectedRepos.length})}</span>
    ...
    `}}customElements.define("management-view",Jt);class Kt extends ae{static properties={hass:{type:Object},_settings:{type:Object,state:!0},_saving:{type:Boolean,state:!0},_version:{type:String,state:!0},_importing:{type:Boolean,state:!0},_exporting:{type:Boolean,state:!0}};constructor(){super(),this._settings={},this._saving=!1,this._version="",this._importing=!1,this._exporting=!1}connectedCallback(){super.connectedCallback(),this._load()}async _load(){try{this._settings=await de.getSettings()||{}}catch(e){console.error("Settings load failed:",e),this._settings={}}try{const e=await de.getVersion();this._version=e?.version||""}catch(e){}}async _save(){this._saving=!0;try{await de.updateSettings(this._settings);const{showToast:e}=await Promise.resolve().then(function(){return Nt});e(ge("settingsSaved"),"success")}catch(e){showToast(`${ge("settingsSaveFailed")}: ${e.message}`,"error")}this._saving=!1}_set(e,t){this._settings={...this._settings,[e]:t}}async _reloadCore(){try{const{showToast:e}=await Promise.resolve().then(function(){return Nt});e(ge("reloadingHA"),"info");const t=await de.reloadHA();t.success?e(ge("reloadSuccess"),"success"):e(`${ge("coreReloadFailed")}: ${t.error}`,"error")}catch(e){const{showToast:t}=await Promise.resolve().then(function(){return Nt});t(`${ge("coreReloadFailed")}: ${e.message}`,"error")}}static styles=[me(),s`
    :host { display: block; }
    .container {
  ...
  `];render(){return U`
        ...
        <div class="section">
          ...
          <div class="save-bar">
            <button class="btn primary" @click=${this._save} ?disabled=${this._saving}>
              ${this._saving?U`<span class="spinner-sm" style="display:inline-block;width:14px;height:14px;border-width:2px;margin:0;vertical-align:-2px;"></span> ${ge("loading")}`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg> ${ge("save")}`}
            </button>
          </div>
        </div>
        ...
        <div class="section">
          ...
          <div class="backup-row">
            <button class="btn primary" @click=${this._export} ?disabled=${this._exporting}>
              ${this._exporting?U`<span class="spinner-sm" style="display:inline-block;width:14px;height:14px;border-width:2px;margin:0;"></span> ${ge("exporting")}`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg> ${ge("exportBtn")}`}
            </button>
            <button class="btn file-input" ?disabled=${this._importing}>
              ...
              ${this._importing?U`${ge("importing")}`:U`${ge("importBackup")}`}
    ...
    `}async _export(){this._exporting=!0;try{const e=await de.exportBackup(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),o=URL.createObjectURL(t),i=document.createElement("a");i.href=o,i.download=`hacs_backup_${(new Date).toISOString().slice(0,10)}.json`,i.click(),URL.revokeObjectURL(o);const{showToast:r}=await Promise.resolve().then(function(){return Nt});r(ge("exportSuccess"),"success")}catch(e){showToast(`${ge("exportFailed")}: ${e.message}`,"error")}this._exporting=!1}async _import(e){const t=e.target?.files?.[0];if(!t)return;if(await Pt.show(this,{message:ge("importDesc"),confirmText:ge("importBackup"),danger:!0})){this._importing=!0;try{const e=await t.text(),o=JSON.parse(e),i=await de.importBackup(o),{showToast:r}=await Promise.resolve().then(function(){return Nt});i.success?(r(ge("importSuccess"),"success"),this._load()):r(`${ge("importFailed")}: ${i.error}`,"error")}catch(e){showToast(`${ge("importFailed")}: ${e.message}`,"error")}this._importing=!1,e.target.value=""}}async _checkUpdates(){try{const e=await de.checkUpdatesWithNotify(),{showToast:t}=await Promise.resolve().then(function(){return Nt});e.success&&(e.updates_found>0?t(ge("updatesChecked",{n:e.updates_found}),"success"):t(ge("noUpdatesFound"),"info"),e.notified&&t(ge("notifySent"),"success"))}catch(e){showToast(`Update check failed: ${e.message}`,"error")}}async _checkAndRestart(){if(await Pt.show(this,{message:ge("restartConfirm"),confirmText:ge("restartHA"),danger:!0}))try{await de.restartHA();const{showToast:e}=await Promise.resolve().then(function(){return Nt});e(ge("haRestarting"),"info")}catch(e){showToast(`${ge("restartFailed")}: ${e.message}`,"error")}}}customElements.define("config-view",Kt);class Zt extends ae{static properties={hass:{type:Object},configEntries:{type:Array},loading:{type:Boolean},searchText:{type:String},_statusFilter:{type:String,state:!0},_showAddDialog:{type:Boolean,state:!0},_handlerSearch:{type:String,state:!0},_handlers:{type:Array,state:!0},_handlersLoading:{type:Boolean,state:!0},_removing:{type:Object,state:!0},_reloading:{type:Object,state:!0},_detailDomain:{type:String,state:!0},_detailEntries:{type:Array,state:!0},_detailDeviceCounts:{type:Object,state:!0},_showDetail:{type:Boolean,state:!0},_deviceViewEntryId:{type:String,state:!0},_domainNames:{type:Object,state:!0},_viewMode:{type:String,state:!0}};constructor(){super(),this.configEntries=[],this.loading=!0,this.searchText="",this._statusFilter="all",this._showAddDialog=!1,this._handlerSearch="",this._handlers=[],this._handlersLoading=!1,this._removing={},this._reloading={},this._detailDomain="",this._detailEntries=[],this._showDetail=!1,this._domainNames={},this._viewMode=localStorage.getItem("hacs_int_view_mode")||"card",this._modalDrag={offsetX:0,offsetY:0,startX:0,startY:0,dragging:!1,cleanup:null}}_modalPointerDown(e){const t=e.target.closest(".modal-header, .dv-header");if(!t||e.target.closest("button, input, select, textarea"))return;if(void 0!==e.button&&0!==e.button)return;const o=this._modalDrag,i=e.currentTarget;o.dragging=!0,o.startX=e.clientX-o.offsetX,o.startY=e.clientY-o.offsetY,i.style.transition="none",i.style.cursor="grabbing",t.style.userSelect="none",i.setPointerCapture(e.pointerId);const r=e=>{o.dragging&&(o.offsetX=e.clientX-o.startX,o.offsetY=e.clientY-o.startY,i.style.transform=`translate(${o.offsetX}px, ${o.offsetY}px)`)},s=e=>{o.dragging=!1,i.style.cursor="",t.style.userSelect="",i.removeEventListener("pointermove",r),i.removeEventListener("pointerup",s),i.removeEventListener("pointercancel",s);try{i.releasePointerCapture(e.pointerId)}catch(e){}};i.addEventListener("pointermove",r),i.addEventListener("pointerup",s),i.addEventListener("pointercancel",s)}connectedCallback(){super.connectedCallback(),this._load()}_setViewMode(e){this._viewMode=e;try{localStorage.setItem("hacs_int_view_mode",e)}catch(e){}}async _load(){this.loading=!0;try{const e=await de.getConfigEntries();this.configEntries=e.entries||[];const t={};for(const e of this.configEntries)t[e.domain]||(t[e.domain]=e.translated_name||e.domain);this._domainNames=t}catch(e){console.error("Failed to load config entries:",e),Mt(ge("loadFailed"),"error")}this.loading=!1}async _loadHandlers(){if(!(this._handlers.length>0)){this._handlersLoading=!0;try{const e=await this.hass.callApi("GET","config/config_entries/flow_handlers");this._handlers=Array.isArray(e)?e.map(e=>"string"==typeof e?{domain:e,name:e}:e):[],this._handlers.sort((e,t)=>(e.name||e.domain).localeCompare(t.name||t.domain))}catch(e){console.error("Failed to load flow handlers:",e),this._handlers=[]}this._handlersLoading=!1}}async _removeEntry(e,t){t.stopPropagation();const{ConfirmDialog:o}=await Promise.resolve().then(function(){return Ht});if(!await o.show(this,{title:e.domain,message:ge("confirmDelete",{domain:e.domain}),confirmText:ge("delete"),danger:!0}))return;this._removing={...this._removing,[e.entry_id]:!0};try{const t=de._getHeaders(),o=await fetch(`/api/config/config_entries/entry/${e.entry_id}`,{method:"DELETE",headers:t,credentials:"include"});if(!o.ok)throw new Error(`HTTP ${o.status}`);Mt(`${e.domain} ${ge("deleted")}`,"success"),this._load()}catch(t){Mt(`${ge("deleteFailed")}: ${t.message}`,"error")}const i={...this._removing};delete i[e.entry_id],this._removing=i}async _reloadEntry(e,t){t.stopPropagation(),this._reloading={...this._reloading,[e.entry_id]:!0};try{const t=de._getHeaders(),o=await fetch(`/api/config/config_entries/entry/${e.entry_id}/reload`,{method:"POST",headers:{...t,"Content-Type":"application/json"},credentials:"include",body:"{}"});if(!o.ok)throw new Error(`HTTP ${o.status}`);Mt(`${e.domain} ${ge("reloaded")}`,"success"),setTimeout(()=>this._load(),1500)}catch(t){Mt(`${ge("reloadFailed")}: ${t.message}`,"error")}const o={...this._reloading};delete o[e.entry_id],this._reloading=o}async _toggleDisabled(e,t){t.stopPropagation();const o=e.disabled_by?null:"user",i=o?ge("disableEntry")||"禁用":ge("enableEntry")||"启用";try{const t=de._getHeaders(),r=await fetch("/api/config/config_entries/entry",{method:"POST",headers:{...t,"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({entry_id:e.entry_id,disabled_by:o})});if(!r.ok)throw new Error(`HTTP ${r.status}`);Mt(`${e.domain} ${i}${ge("successSuffix")||"成功"}`,"success"),setTimeout(()=>this._load(),1500)}catch(e){Mt(`${i}${ge("failedSuffix")||"失败"}: ${e.message}`,"error")}}_configureEntry(e,t){t.stopPropagation(),this._closeDetail(),this.dispatchEvent(new CustomEvent("configure-integration",{bubbles:!0,composed:!0,detail:{domain:e.domain,entry_id:e.entry_id}}))}_openAddDialog(){this._showAddDialog=!0,this._handlerSearch="",this._loadHandlers()}_closeAddDialog(){this._showAddDialog=!1,this._handlerSearch=""}_addIntegration(e){this._closeAddDialog(),this.dispatchEvent(new CustomEvent("add-integration",{bubbles:!0,composed:!0,detail:{domain:e}}))}_openDetail(e,t){this._detailDomain=e,this._detailEntries=t,this._showDetail=!0,this._detailDeviceCounts=null,de.getDeviceCounts(e).then(e=>{this._detailDeviceCounts=e}).catch(t=>{console.warn("Failed to get device counts for",e,t)})}_closeDetail(){this._showDetail=!1,this._detailDomain="",this._detailEntries=[],this._deviceViewEntryId="";const e=this.shadowRoot?.querySelector(".modal");e&&(e.style.transform="")}_openDeviceView(e){this._showDetail=!0,this._detailDomain=e.domain,this._detailEntries=[e],this._deviceViewEntryId=e.entry_id}_translateDomain(e){return this._domainNames?.[e]||e}_renderAvatar(e){const t=`https://brands.home-assistant.io/${e}/icon.png`,o=`${window.location.origin}/api/hacs_vision_brand/${e}`;this._getDomainColor(e);const i=e.charAt(0).toUpperCase();return U`
      <div class="avatar">
      ...
      <div class="integrations">
        <div class="controls">
          <div class="search" style="flex:1;min-width:120px;">
            ...
            ${this.searchText?U`<button class="search-clear" @click=${()=>{this.searchText=""}}>✕</button>`:""}
          </div>
          <div class="controls-right">
            <div class="view-toggle">
              <button class="view-toggle-btn ${"card"===this._viewMode?"active":""}" @click=${()=>this._setViewMode("card")} title="${ge("viewCard")}">${ge("viewCard")}</button>
        ...
        <div class="filter-bar">
          ${["all","loaded","failed","disabled","not-loaded"].map(e=>U`
    ...
    `}_renderListRow(e){const{domain:t,entries:o}=e,i=e._state,r=o.length>1,s=o[0],a=o.some(e=>this._removing[e.entry_id]||this._reloading[e.entry_id]);return U`
      <div class="list-row list-row-${i}" @click=${()=>r?this._openDetail(t,o):this._openDeviceView(s)}>
        ...
        <span class="list-row-status">
          ...
          ${r?U`<span class="list-entry-count">${o.length} ${ge("entryCount")}</span>`:""}
        </span>
        <span class="list-row-actions">
          <button class="list-action-btn" @click=${e=>{e.stopPropagation(),r?this._openDetail(t,o):this._openDeviceView(s)}} title="${ge(r?"viewDetail":"configure")}">
          ...
          <button class="list-action-btn reload" @click=${e=>{e.stopPropagation(),this._reloadEntry(s||o[0],e)}} title="${ge("reloadEntry")}" ?disabled=${a}>
            ${this._reloading[s?.entry_id||""]?"⋯":U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14"><path d="M1 4v6h6M23 20v-6h-6"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"/></svg>`}
          </button>
        </span>
      </div>
    `}_renderCard(e){const{domain:t,entries:o}=e,i=this._getDomainColor(t),r=e._state,s=o.some(e=>this._removing[e.entry_id]||this._reloading[e.entry_id]),a=o.length>1,n=o[0];return U`
      <div class="card card-${r}" @click=${()=>a?this._openDetail(t,o):this._openDeviceView(n)} role="button" tabindex="0"
        @keydown=${e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),a?this._openDetail(t,o):this._openDeviceView(n))}}>

          <div class="card-img">
            <span class="category-badge" style="background:${i}">${ge("catIntegration")}</span>
            ${this._renderAvatar(t)}
            ${"loaded"!==r?U`<span class="img-status-badge state-${r}">${this._groupLabel(r)}</span>`:""}
          </div>
        ...
        <div class="card-body">
          ...
          <div class="card-meta">
            ...
            ${n?U`<span class="dot-sep"></span><span class="status-label" style="color:${this._groupColor(r)}">${n.title||n.entry_id.substring(0,8)}</span>`:""}
          </div>
        </div>

        <div class="card-footer" @click=${e=>e.stopPropagation()}>
          <button class="footer-btn configure" @click=${()=>a?this._openDetail(t,o):this._configureEntry(n,{stopPropagation:()=>{}})}
            title="${ge("configureEntry")}" ?disabled=${s}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
          ...
          <button class="footer-btn reload" @click=${()=>this._reloadEntry(n||o[0],{stopPropagation:()=>{}})}
            title="${ge("reloadEntry")}" ?disabled=${s}>
            ${s?U`<span class="spinning-mini">⟳</span>`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>`}
            <span class="btn-label">${ge("reloadEntry")||"重载"}</span>
          </button>
          <button class="footer-btn remove" @click=${e=>this._removeEntry(n||o[0],e)}
            title="${ge("removeEntry")}" ?disabled=${s}>
            ${s?U`<span class="spinning-mini">⋯</span>`:U`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>`}
            <span class="btn-label">${ge("delete")}</span>
          </button>
        </div>
      </div>
    `}_renderDetailDialog(){if(!this._showDetail)return"";if(this._deviceViewEntryId){const e=this._detailEntries.find(e=>e.entry_id===this._deviceViewEntryId);return U`
        <div class="detail-overlay" role="dialog" aria-modal="true" @click=${e=>{e.target===e.currentTarget&&this._closeDetail()}} @keydown=${e=>{"Escape"===e.key&&this._closeDetail()}}>
          <div class="modal" @pointerdown=${this._modalPointerDown}>
            <hacs-vision-device-view
              ...
              .entryTitle=${e&&e.title||this._detailDomain}
              @back=${()=>{this._deviceViewEntryId=""}}
              @close=${()=>this._closeDetail()}>
            </hacs-vision-device-view>
          </div>
        </div>
      `}if(!this._detailEntries.length)return"";const e=this._detailDomain;this._getDomainColor(e);const t=this._detailEntries,o=t.length>0&&(t.some(e=>e.subentries||e.title&&e.title.startsWith("subentry"))||t.length>=3),i=o;return U`
      <div class="detail-overlay" role="dialog" aria-modal="true" aria-label="${this._translateDomain(e)}" @click=${e=>{e.target===e.currentTarget&&this._closeDetail()}} @keydown=${e=>{"Escape"===e.key&&this._closeDetail()}}>
        <div class="modal ${i?"two-col":""}" @pointerdown=${this._modalPointerDown}>
            ...
            <div class="modal-header-left">
              ...
              <div>
                ...
                <div class="modal-subtitle">
                  ${t.length} ${ge("entryCount")}
                  ${this._detailDeviceCounts?U` · ${this._detailDeviceCounts.devices} ${ge("deviceCount")} · ${this._detailDeviceCounts.entities} 个实体`:""}
                </div>
              </div>
            </div>
            <button class="modal-close" aria-label="${ge("close")||"关闭"}" @click=${this._closeDetail}>
          ...
          <div class="modal-body ${i?"grid-2col":""}">
            ${i?U`
              <div class="col-left">
                <div class="col-title">${ge("subentryConfig")||"子项配置"}</div>
                ${t.map(e=>this._renderEntryRow(e))}
              </div>
              <div class="col-right">
                <div class="col-title">${ge("addSubentry")||"添加新子项"}</div>
                <div class="add-subentry-card">
                  ...
                  <div class="add-subentry-text">${ge("addSubentryHint")||"点击添加新的子项配置"}</div>
                  <button class="add-subentry-btn" @click=${()=>{this._closeDetail(),this.dispatchEvent(new CustomEvent("add-integration",{bubbles:!0,composed:!0,detail:{domain:e,isSubentry:!0}}))}}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    ${ge("addSubentry")||"添加新子项"}
                  </button>
                </div>
              </div>
            `:t.map(e=>this._renderEntryRow(e))}
    ...
    `}_renderEntryRow(e){const t=this._getState(e),o=this._removing[e.entry_id]||this._reloading[e.entry_id],i=e.title||e.entry_id.substring(0,8),r=!!e.disabled_by;return U`
      <div class="entry-row ${r?"disabled":""}">
        ...
        <div class="entry-actions" @click=${e=>e.stopPropagation()}>
          ...
          <button class="entry-btn reload" @click=${t=>this._reloadEntry(e,t)} title="${ge("reloadEntry")}" ?disabled=${o}>
            ${this._reloading[e.entry_id]?U`<span class="spinning">⋯</span>`:U`
          ...
          <button class="entry-btn device" @click=${t=>{t.stopPropagation(),this._openDeviceView(e)}} title="${ge("viewDevices")||"设备"}" ?disabled=${o}>
          ...
          <button class="entry-btn remove" @click=${t=>this._removeEntry(e,t)} title="${ge("removeEntry")}" ?disabled=${o}>
            ${this._removing[e.entry_id]?U`<span class="spinning">⋯</span>`:U`
    ...
    `}_renderAddDialog(){if(!this._showAddDialog)return"";const e=this._filteredHandlers;return U`
          ...
          <div class="modal-body">
            ...
            `:e.map(e=>U`
              <div class="add-item" @click=${()=>this._addIntegration(e.domain)}>
                ...
                ${e.name&&e.name!==e.domain?U`<span class="add-item-domain">${e.domain}</span>`:""}
              </div>
            `)}
          </div>
        </div>
  ...
  `]}customElements.define("integrations-list",Zt);class Qt extends ae{static properties={hass:{type:Object},entryId:{type:String},domain:{type:String},entryTitle:{type:String},_groups:{type:Array,state:!0},_loading:{type:Boolean,state:!0},_collapsed:{type:Object,state:!0},_error:{type:String,state:!0},_toggling:{type:Object,state:!0},_deviceCollapsed:{type:Object,state:!0}};constructor(){super(),this.entryId="",this.domain="",this.entryTitle="",this._groups=[],this._loading=!1,this._collapsed={},this._allCollapsed=!1,this._error="",this._toggling={},this._deviceCollapsed={}}get _totalDeviceCount(){return this._groups.reduce((e,t)=>e+t.devices.length,0)}connectedCallback(){super.connectedCallback(),this.entryId&&this._load()}updated(e){e.has("entryId")&&this.entryId&&this._load()}async _load(){this._loading=!0,this._error="";try{const e=await de.get(`devices/${this.entryId}`);this._groups=e.groups||[];for(const e of this._groups)this._collapsed[e.area]||(this._collapsed[e.area]=!1);this.requestUpdate()}catch(e){this._error=e.message||"Failed to load devices",this._groups=[]}this._loading=!1}_toggleArea(e){this._collapsed={...this._collapsed,[e]:!this._collapsed[e]}}_toggleDevice(e){this._deviceCollapsed={...this._deviceCollapsed,[e]:!this._deviceCollapsed[e]}}_toggleAll(){this._allCollapsed=!this._allCollapsed;const e={},t={};for(const o of this._groups){e[o.area]=this._allCollapsed;for(const e of o.devices)t[e.device_id||e.entity_id||e.name]=this._allCollapsed}this._collapsed=e,this._deviceCollapsed=t}_entityIcon(e,t){if(!t||"unavailable"===t||"unknown"===t)return"⊙";if("on"===t||"open"===t||"home"===t)return"●";if("off"===t||"closed"===t||"not_home"===t)return"○";return{light:"💡",switch:"🔌",sensor:"📊",binary_sensor:"🔍",climate:"🌡️",cover:"🚪",fan:"🌀",lock:"🔒",alarm_control_panel:"🔔",camera:"📷",media_player:"📺",vacuum:"🧹",weather:"☀️",device_tracker:"📍",person:"👤",sun:"☀️",automation:"⚡",script:"📜",input_boolean:"🔘",input_number:"🔢",input_select:"📋",number:"🔢",select:"📋",button:"🔘",text:"📝"}[e]||"◆"}_stateColor(e){return e&&"unavailable"!==e&&"unknown"!==e?"on"===e||"open"===e||"home"===e?"#4caf50":"off"===e||"closed"===e||"not_home"===e?"#9e9e9e":"var(--primary-text-color, #212121)":"var(--secondary-text-color, #888)"}_formatState(e,t,o){if(!e||"unavailable"===e)return"不可用";if("unknown"===e)return"未知";if("on"===e)return"开";if("off"===e)return"关";if("open"===e)return"已打开";if("closed"===e)return"已关闭";if("home"===e)return"在家";if("not_home"===e)return"离家";const i={cool:"❄️ 制冷",heat:"🔥 制热",fan_only:"🌀 送风",dry:"💧 除湿",auto:"🤖 自动",off:"关"};return i[e]?i[e]:o?`${e} ${o}`:e}_stateIcon(e){return e&&"unavailable"!==e&&"unknown"!==e?"on"===e||"open"===e||"home"===e?"●":"off"===e||"closed"===e||"not_home"===e?"○":"◆":"⊙"}render(){return U`
      <div class="device-view">
        ...
        `:0===this._groups.length?U`
          <div class="dv-empty">
            <div>${ge("noDevices")||"暂无设备"}</div>
          </div>
        `:U`
                    ...
                    ${e.devices.map(e=>U`
                      <div class="dv-device">
                        <div class="dv-device-header" @click=${()=>this._toggleDevice(e.device_id||e.entity_id||e.name)}>
                          ...
                          ${e.model?U`<span class="dv-device-model">${e.model}</span>`:""}
                          <span class="dv-device-ecount">${e.entities.filter(e=>!e.disabled).length} 个实体</span>
                        </div>
                        ${this._deviceCollapsed[e.device_id||e.entity_id||e.name]?"":U`
                        <div class="dv-entities">
                          ${e.entities.map(e=>e.disabled?"":U`
    ...
    .device-view { display: flex; flex-direction: column; height: 100%; }
    .dv-header {
      display: flex; align-items: center; justify-content: space-between;
  ...
  `];render(){if(!this.open)return"";const e=this._isSubentry?(this._getFlowDomain()||"")+" - "+ge("subentryTitle"):this._isOptions?this._getFlowDomain()||ge("flowTitleOptions"):this._step?.title||this._localizeTitle()||this._step?.handler||this.domain||ge("flowTitle");return U`
      <div class="overlay" role="dialog" aria-modal="true" aria-label="${this._flowTitle||ge("flowTitle")}" @keydown=${e=>{"Escape"===e.key&&this._cancelFlow()}} @click=${e=>{e.target===e.currentTarget&&this._cancelFlow()}}>
        <div class="dialog" @pointerdown=${this._dialogPointerDown}>
              ...
              ${this.domain?U`
                <div class="cfg-avatar">
                  <img class="cfg-avatar-img" src="https://brands.home-assistant.io/${this.domain}/icon.png" alt=""
                    @error=${function(){this.style.display="none";const e=this.parentElement.querySelector(".cfg-avatar-letter");e&&(e.style.display="flex")}}>
          ...
          ${this._loading||this._finished||this._step||this._result||!this._isSubentry||this._subentryType?"":U`
            <div class="subentry-list">
              ${this._existingSubentries.length>0?U`
                <div class="step-desc" style="margin-bottom:8px">${ge("subentryExisting")}</div>
                ${this._existingSubentries.map(e=>U`
    ...
    `}_renderStep(){const e=this._step;return e?"menu"===e.type?this._renderMenu(e):"form"===e.type?this._renderForm(e):U`<div class="result error"><div class="result-title">${ge("flowResultFailed")}: ${e.type}</div></div>`:""}_renderMenu(e){const t=this._buildDescription(e),o=e.menu_options||[];return U`
      ${t?U`<div class="step-desc">${t}</div>`:""}
      <div class="menu-list">
        ${o.map((t,o)=>{const i="string"==typeof t,r=i?t:t.value||"",s=this._t(`component.${this._getFlowDomain()}.config.step.${e.step_id}.menu_options.${r}`)||this._isOptions&&this._t(`component.${this._getFlowDomain()}.options.step.${e.step_id}.menu_options.${r}`)||(i?t:t.label||t.title||t.value||""),a=i?"":t.description||"";return U`
            <div class="menu-option" @click=${()=>this._handleMenuSelect(r)}>
              <span class="menu-label">${s}</span>
              ${a?U`<span class="menu-desc">${a}</span>`:""}
              <span class="menu-arrow">→</span>
            </div>
          `})}
      </div>
    ...
    `}_renderForm(e){const t=this._buildDescription(e),o=e.data_schema||[],i=this._errors?.base||"";return U`
      ${t?U`<div class="step-desc">${t}</div>`:""}
      ${i?U`<div class="form-error" style="margin-bottom:12px">${i}</div>`:""}
    ...
    `}_buildDescription(e){let t=e.description||e.description_placeholders?.description||"";if(t&&t.includes(".")){const e=this._t(t)||null;e&&(t=e)}if(!t){const e=this._translateField("description");e&&(t=e)}const o=e.description_placeholders||{};for(const[e,i]of Object.entries(o)){const o=null!=i&&"object"!=typeof i?String(i):"";t=t.replace(new RegExp(`\\{${e}\\}`,"g"),o)}if(!t&&Object.keys(o).length>0){const e=Object.entries(o).map(([,e])=>null!=e&&"object"!=typeof e?String(e):"").filter(Boolean);t=e.join("\n")}return t}_getFlowDomain(){if(this.domain)return this.domain;if(this.entryId&&this.configEntries)for(const e of Object.values(this.configEntries))for(const t of e)if(t.entry_id===this.entryId)return t.domain||"";const e=this._step?.handler;return e&&!/^[0-9A-Z]{20,}$/.test(e)?e:""}_getSubentryTypeLabel(e){const t={conversation:"subentryConversation",tts:"subentryTts",stt:"subentryStt",translation:"subentryTranslation",ai_task_data:"subentryAiTaskData",device:"subentryDevice",wecom:"subentryWecom",wechat:"subentryWechat",qq:"subentryQq",feishu:"subentryFeishu",dingtalk:"subentryDingtalk",xiaoyi:"subentryXiaoyi",custom:"subentryCustom"}[e];return t?ge(t):e}_localizeTitle(){const e=this._getFlowDomain(),t=this._step?.step_id;if(e&&t){const e=this._translateField("title");if(e)return e}if(e){const t=`component.${e}.title`,o=this._t(t);if(o)return o}return""}_translateField(e){const t=this._getFlowDomain(),o=this._step?.step_id;if(!t||!o)return null;if(this._isSubentry&&this._subentryType){const i=`component.${t}.config_subentries.${this._subentryType}.step.${o}.${e}`,r=this._t(i);if(r)return r}const i=`component.${t}.config.step.${o}.${e}`;return this._t(i)}_getFieldLabel(e){const t=this._translateField(`data.${e.name}`);return t||(e.label||this._friendlyName(e.name))}_friendlyName(e){return e.replace(/_/g," ").replace(/(^|\s)\w/g,e=>e.toUpperCase()).replace(/Id\b/gi,"ID").replace(/Ip\b/gi,"IP").replace(/Url\b/gi,"URL").replace(/Api\b/gi,"API")}_getFieldDescription(e){const t=this._translateField(`data.${e.name}.description`);if(t)return t;const o=e.description;return"string"==typeof o?o:""}_getFieldPlaceholder(e){const t=this._translateField(`data.${e.name}.placeholder`);return t||(e.placeholder||"")}_getOptionLabel(e,t){const o=this._translateField(`data.${e.name}.options.${t}`);return o||null}_getFlowErrorMessage(e){const t=e?.message||"";return t.includes("404")?this._isSubentry?this._getSubentryTypeLabel(this._subentryType)+" "+ge("flowHandlerNotFound"):this._isOptions?ge("flowOptionsNotSupported"):ge("flowHandlerNotFound"):t.includes("401")||t.includes("403")?ge("flowAuthError"):t||(this._isOptions?ge("flowStartFailedOptions"):ge("flowStartFailed"))}_renderField(e){const t=e.name,o=this._getFieldLabel(e),i=e.type||"string",r=!1!==e.required,s=e.description?.suggested_value,a=void 0!==e.default&&null!==e.default||null!=s,n=void 0!==e.default&&null!==e.default?e.default:void 0!==s?s:"",l=this._getFieldPlaceholder(e),d=this._getFieldDescription(e),c=this._errors?.[t]||"",p=!0===e.multiline,h=!0===e.password||"password"===e.type||/token|secret|password|key|api_key|apiKey/i.test(t)&&"string"===i,g=e.selector||{},u=Object.keys(g)[0];if("select"===i||"multi_select"===i||e.options||e.enum||"select"===u){let s=e.options||e.enum||[];!s.length&&g.select?.options&&(s=g.select.options);const l="multi_select"===i||!0===g.select?.multiple;s.length?console.debug(`HACS Vision: select field "${t}" options:`,JSON.stringify(s).slice(0,200)):console.warn(`HACS Vision: select field "${t}" has empty options`,e);let p=[];return Array.isArray(s)?p=s:s&&"object"==typeof s&&(p=Object.entries(s).map(([e,t])=>({value:e,label:t}))),p=p.filter(Boolean).map(e=>{if("string"==typeof e)return{value:e,label:e};if(Array.isArray(e))return{value:e[0],label:e[1]||e[0]};if(e&&"object"==typeof e){const t=e.value??e.val??e.id??Object.values(e)[0]??"",o=e.label??e.name??e.description??Object.values(e)[1]??t;return{value:String(t),label:String(o)}}return{value:String(e),label:String(e)}}),U`
        <div class="form-field">
          ...
          `:U`
            <select name=${t} ?required=${r}>
              ${r?"":U`<option value="">${ge("flowSelectOption")}</option>`}
              ${p.map(t=>{const o=this._getOptionLabel(e,t.value)||t.label,i=a&&n===t.value;return U`<option value=${t.value} ?selected=${i}>${o}</option>`})}
            </select>
          `}
          ${c?U`<div class="form-error">${c}</div>`:""}
        </div>
      `}if("boolean"===i||"boolean"===u){if("back"===t&&!r)return U`
          <div class="form-field">
        ...
        <div class="form-field">
          <label class="checkbox-label">
            ...
            <span>${o!==e.name.replace(/_/g," ")?o:d||o}</span>
          </label>
          ${c?U`<div class="form-error">${c}</div>`:""}
        </div>
      `}if("integer"===i||"number"===i||"number"===u||"integer"===u){const s=g.number?.step||("integer"===i?1:"any"),a=g.number?.min??e.valueMin??e.minimum??"",p=g.number?.max??e.valueMax??e.maximum??"";return U`
        <div class="form-field">
          <label>${o}${r?" *":""}</label>
          ${d?U`<div class="field-desc">${d}</div>`:""}
      ...
      `}return p||"text"===u&&g.text?.multiline?U`
        <div class="form-field">
          <label>${o}${r?" *":""}</label>
          ${d?U`<div class="field-desc">${d}</div>`:""}
      ...
      <div class="form-field">
        <label>${o}${r?" *":""}</label>
        ${d&&d!==l?U`<div class="field-desc">${d}</div>`:""}
        <input type=${h?"password":"text"} name=${t}
               .value=${n} ?required=${r} placeholder=${l}>
        ${c?U`<div class="form-error">${c}</div>`:""}
      </div>
    `}_renderResult(){if(!this._result)return"";const e=this._result;if("create_entry"===e.type)return U`
        <div class="result">
      ...
      `;if("abort"===e.type){const t={already_configured:ge("flowAbortAlreadyConfigured"),single_instance_allowed:ge("flowAbortSingleInstance"),no_devices_found:ge("flowAbortNoDevices"),already_in_progress:ge("flowAbortInProgress")};return U`
        <div class="result">
      ...
      `}return"external"===e.type?U`
        <div class="result">
          ...
          ${e.url?U`<a href=${e.url} target="_blank" class="btn external">${ge("flowOpenAuthPage")}</a>`:""}
          <div class="actions">
