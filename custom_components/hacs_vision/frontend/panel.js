              ...
              <div class="release-item">
                <div class="release-info">
                  <div class="release-tag">
                    <span class="ref-badge ${"branch"===e.type?"branch":"commit"}">${"branch"===e.type?_e("refBranch"):_e("refCommit")}</span>
                    ${"branch"===e.type?e.name||"?":e.sha||e.name||"?"}
                  </div>
