            ...
            `:this._customRepoUrl.trim()&&!this._isRepoUrl(this._customRepoUrl)?H`
              ...
              `:this._orgRepos.length>0?H`
                <div style="display:flex;align-items:center;gap:6px;margin:6px 0;width:100%;">
                  ...
                  <button class="btn primary" style="font-size:10px;padding:3px 8px;" @click=${this._syncSelectedMgmtOrg} ?disabled=${this._orgSyncing||0===Object.keys(this._selectedOrgRepos).length}>
                    ${this._orgSyncing?"同步中...":`同步选中 (${Object.keys(this._selectedOrgRepos).length})`}
                  </button>
                </div>
                ${this._orgSyncResult?H`<div style="font-size:11px;margin-bottom:4px;width:100%;color:${this._orgSyncResult.includes("失败")?"#f44336":"var(--primary-text-color)"};">${this._orgSyncResult}</div>`:""}
                <div style="max-height:200px;overflow-y:auto;border:1px solid var(--divider-color);border-radius:4px;width:100%;">
                  ${this._orgRepos.filter(e=>!this._orgFilter||e.full_name.toLowerCase().includes(this._orgFilter.toLowerCase())).map(e=>H`
                    <div style="display:flex;align-items:center;gap:6px;padding:4px 8px;border-bottom:1px solid var(--divider-color);font-size:11px;cursor:pointer;" @click=${()=>this._toggleSelectMgmtOrg(e.full_name)}>
                      ...
                      <span style="flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                        ...
                        ${e.category?H`<span style="margin-left:4px;padding:0 4px;border-radius:3px;background:var(--primary-color);color:#fff;font-size:9px;">${e.category}</span>`:""}
                      </span>
                    </div>
                  `)}
                </div>
