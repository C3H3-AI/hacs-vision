              ...
              <div class="version-selector">
                ...
                ${this._showVersionSelector?U`
                  <div class="version-selector-body">
                    ...
                    `:U`
                      ${this._releases.filter(e=>!e.prerelease).length?U`
                        <div class="release-group-header">${ge("releaseStable")}</div>
                        ${this._releases.filter(e=>!e.prerelease).map(e=>U`
                      ...
                      `:""}
                      ${this._releases.filter(e=>e.prerelease).length?U`
                        <div class="release-group-header">${ge("releasePrerelease")}</div>
                        ${this._releases.filter(e=>e.prerelease).map(e=>U`
                          <div class="release-item ${this._changelogTag===(e.tag_name||e.tag)?"active":""}"
                               @click=${()=>this._loadChangelog(this._detailRepo,e.tag_name||e.tag)}>
                            <div class="release-info">
                              <div class="release-tag">
                                ${e.tag_name||e.tag||"?"}
                                <span class="prerelease-badge">${ge("prerelease")}</span>
                              </div>
                              ${e.published_at||e.created_at?U`
                                <div class="release-date">${ge("publishedAt")} ${new Date(e.published_at||e.created_at).toLocaleDateString()}</div>
                              `:""}
