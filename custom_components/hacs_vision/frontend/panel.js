      ...
      <div class="store">
        ...
        <div class="header">
          ...
          <div class="header-right">
            ...
            `:""}
            ${this.stats.pending_restart,H`
            <button class="action-btn-sm" @click=${this._checkUpdates} title="${ue("checkUpdatesNotify")}">
        ...
        <div class="modal-overlay" @click=${e=>{e.target===e.currentTarget&&this._closeDetail()}}>
          <div class="modal ${this._detailExpanded?"expanded":""}" @dblclick=${this._toggleDetailExpand}>
            ...
            <div class="modal-body">
              ...
              ${t.config_entry_id?H`
                <button class="detail-action-btn" @click=${()=>window.open("/config/integrations/dashboard?config_entry="+t.config_entry_id,"_self")} title="${ue("addIntegrationHint")}">
                  ${ue("addIntegration")}
                </button>
              `:""}
