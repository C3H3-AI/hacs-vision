      ...
      <div class="integrations">
        ...
        <div class="filter-bar">
          ...
          ${[{key:"name",label:ge("sortByName")},{key:"entries",label:ge("sortByEntries")},{key:"status",label:ge("filterStatus")}].map(e=>H`
            <button class="filter-chip sort-inline ${this._sortBy===e.key?"active":""}" @click=${()=>this._setSortBy(e.key)}>
              ${e.label}${this._sortBy===e.key?H`<span class="sort-dir">${"name"===e.key?"A-Z":""}</span>`:""}
            </button>
          `)}
        </div>
