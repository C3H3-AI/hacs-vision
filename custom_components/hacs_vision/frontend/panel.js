    ...
    `}_renderCard(e){const{domain:t,entries:o}=e;this._getDomainColor(t);const i=e._state,r=o.some(e=>this._removing[e.entry_id]||this._reloading[e.entry_id]),s=o.length>1,a=o[0];return H`
      <div class="card card-${i}" @click=${()=>this._openDetail(t,o)} role="button" tabindex="0"
        ...
        <div class="card-footer" @click=${e=>e.stopPropagation()}>
          <button class="footer-btn detail" @click=${()=>this._openDetail(t,o)}
            title="${ge("viewDetail")||"详情"}" ?disabled=${r}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
            <span class="btn-label">${s?`${o.length} ${ge("entryCount")}`:ge("viewDetail")||"详情"}</span>
          </button>
          ${e._supports_options?H`
