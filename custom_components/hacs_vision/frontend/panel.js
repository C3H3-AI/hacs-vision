    ...
    `}_renderListRow(e){const{domain:t,entries:o}=e,i=e._state,r=o.length>1,s=o[0],a=o.some(e=>this._removing[e.entry_id]||this._reloading[e.entry_id]);return H`
      <div class="list-row list-row-${i}" @click=${()=>this._openDetail(t,o)}>
        ...
        <span class="list-row-actions">
          ${e._supports_options||e._has_subentry?H`
          <button class="list-action-btn" @click=${t=>{t.stopPropagation(),this._onConfigure(s||o[0],e)}} title="${ge("configureEntry")}">
        ...
        <div class="card-footer" @click=${e=>e.stopPropagation()}>
          <div class="footer-left">
            ...
            <button class="footer-btn configure" @click=${()=>this._onConfigure(a||o[0],e)}
              ...
              <span class="btn-label">${ge("configure")||"配置"}${s||a?.supported_subentry_types?H`<span class="config-arrow">▾</span>`:""}</span>
            </button>
            `:""}
            ${e._can_add?H`
