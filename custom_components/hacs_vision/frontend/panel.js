        ...
        <div class="actions">
          ${e.pending_restart?N`
            <button class="action-btn primary" @click=${e=>{e.stopPropagation(),this.dispatchEvent(new CustomEvent("restart-ha",{bubbles:!0,composed:!0}))}}
              ...
              <span class="label">${ge("pendingRestart")||"待重启"}</span>
            </button>
          `:""}
