        ...
        <div class="actions">
          ...
          ${"store"===this.viewMode?H`
            <button class="action-btn star-btn ${this._starred?"starred":""}"
              ...
              title=${this._starred?ge("unstar")||"取消星标":ge("star")||"星标"}>
              ${this._starring?H`<svg class="mini-icon spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`:H`<svg viewBox="0 0 20 20" fill="${this._starred?"#ff9800":"none"}" stroke="#ff9800" stroke-width="1.5"><path d="M10 1l2.39 4.84L17.6 6.7l-3.8 3.71.9 5.26L10 13.27l-4.7 2.46.9-5.26L2.4 6.7l5.2-.86L10 1z"/></svg>`}
              <span class="label">${this._starred?ge("starred")||"已星标":ge("starBtn")||"星标"}</span>
            </button>
          `:""}
          ${a?H`
            ${n?H`
