...
/*! @license DOMPurify 3.4.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.8/LICENSE */function me(e,t){(null==t||t>e.length)&&(t=e.length);for(var o=0,i=Array(t);o<t;o++)i[o]=e[o];return i}function ve(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var o=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=o){var i,r,a,s,n=[],l=!0,c=!1;try{if(a=(o=o.call(e)).next,0===t);else for(;!(l=(i=a.call(o)).done)&&(n.push(i.value),n.length!==t);l=!0);}catch(e){c=!0,r=e}finally{try{if(!l&&null!=o.return&&(s=o.return(),Object(s)!==s))return}finally{if(c)throw r}}return n}}(e,t)||function(e,t){if(e){if("string"==typeof e)return me(e,t);var o={}.toString.call(e).slice(8,-1);return"Object"===o&&e.constructor&&(o=e.constructor.name),"Map"===o||"Set"===o?Array.from(e):"Arguments"===o||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)?me(e,t):void 0}}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}const be=Object.entries,xe=Object.setPrototypeOf,ye=Object.isFrozen,_e=Object.getPrototypeOf,we=Object.getOwnPropertyDescriptor;let $e=Object.freeze,ke=Object.seal,ze=Object.create,Se="undefined"!=typeof Reflect&&Reflect,Ce=Se.apply,Ae=Se.construct;$e||($e=function(e){return e}),ke||(ke=function(e){return e}),Ce||(Ce=function(e,t){for(var o=arguments.length,i=new Array(o>2?o-2:0),r=2;r<o;r++)i[r-2]=arguments[r];return e.apply(t,i)}),Ae||(Ae=function(e){for(var t=arguments.length,o=new Array(t>1?t-1:0),i=1;i<t;i++)o[i-1]=arguments[i];return new e(...o)});const Re=Xe(Array.prototype.forEach),Ee=Xe(Array.prototype.lastIndexOf),Te=Xe(Array.prototype.pop),Ie=Xe(Array.prototype.push),De=Xe(Array.prototype.splice),Le=Array.isArray,Ne=Xe(String.prototype.toLowerCase),Oe=Xe(String.prototype.toString),Fe=Xe(String.prototype.match),Me=Xe(String.prototype.replace),Ue=Xe(String.prototype.indexOf),Pe=Xe(String.prototype.trim),Be=Xe(Number.prototype.toString),He=Xe(Boolean.prototype.toString),je="undefined"==typeof BigInt?null:Xe(BigInt.prototype.toString),Ve="undefined"==typeof Symbol?null:Xe(Symbol.prototype.toString),Ge=Xe(Object.prototype.hasOwnProperty),qe=Xe(Object.prototype.toString),We=Xe(RegExp.prototype.test),Ye=(Je=TypeError,function(){for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];return Ae(Je,t)});var Je;function Xe(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var o=arguments.length,i=new Array(o>1?o-1:0),r=1;r<o;r++)i[r-1]=arguments[r];return Ce(e,t,i)}}function Ze(e,t){let o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Ne;if(xe&&xe(e,null),!Le(t))return e;let i=t.length;for(;i--;){let r=t[i];if("string"==typeof r){const e=o(r);e!==r&&(ye(t)||(t[i]=e),r=e)}e[r]=!0}return e}function Ke(e){for(let t=0;t<e.length;t++){Ge(e,t)||(e[t]=null)}return e}function Qe(e){const t=ze(null);for(const i of be(e)){var o=ve(i,2);const r=o[0],a=o[1];Ge(e,r)&&(Le(a)?t[r]=Ke(a):a&&"object"==typeof a&&a.constructor===Object?t[r]=Qe(a):t[r]=a)}return t}function et(e,t){for(;null!==e;){const o=we(e,t);if(o){if(o.get)return Xe(o.get);if("function"==typeof o.value)return Xe(o.value)}e=_e(e)}return function(){return null}}const tt=$e(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),ot=$e(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),it=$e(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),rt=$e(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),at=$e(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),st=$e(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),nt=$e(["#text"]),lt=$e(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),ct=$e(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),dt=$e(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),pt=$e(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),ht=ke(/{{[\w\W]*|^[\w\W]*}}/g),gt=ke(/<%[\w\W]*|^[\w\W]*%>/g),ut=ke(/\${[\w\W]*/g),ft=ke(/^data-[\-\w.\u00B7-\uFFFF]+$/),mt=ke(/^aria-[\-\w]+$/),vt=ke(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),bt=ke(/^(?:\w+script|data):/i),xt=ke(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),yt=ke(/^html$/i),_t=ke(/^[a-z][.\w]*(-[.\w]+)+$/i),wt=1,$t=3,kt=7,zt=8,St=9,Ct=11,At=function(){return"undefined"==typeof window?null:window};var Rt=function e(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:At();const o=t=>e(t);if(o.version="3.4.8",o.removed=[],!t||!t.document||t.document.nodeType!==St||!t.Element)return o.isSupported=!1,o;let i=t.document;const r=i,a=r.currentScript;t.DocumentFragment;const s=t.HTMLTemplateElement,n=t.Node,l=t.Element,c=t.NodeFilter,d=t.NamedNodeMap;void 0===d&&(t.NamedNodeMap||t.MozNamedAttrMap),t.HTMLFormElement;const p=t.DOMParser,h=t.trustedTypes,g=l.prototype,u=et(g,"cloneNode"),f=et(g,"remove"),m=et(g,"nextSibling"),v=et(g,"childNodes"),b=et(g,"parentNode"),x=et(g,"shadowRoot"),y=et(g,"attributes"),_=n&&n.prototype?et(n.prototype,"nodeType"):null,w=n&&n.prototype?et(n.prototype,"nodeName"):null;if("function"==typeof s){const e=i.createElement("template");e.content&&e.content.ownerDocument&&(i=e.content.ownerDocument)}let $,k="",z=0;const S=function(e){if(z>0)throw Ye('The configured TRUSTED_TYPES_POLICY.createHTML must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose createHTML wraps DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.');z++;try{return $.createHTML(e)}finally{z--}},C=i,A=C.implementation,R=C.createNodeIterator,E=C.createDocumentFragment,T=C.getElementsByTagName,I=r.importNode;let D={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]};o.isSupported="function"==typeof be&&"function"==typeof b&&A&&void 0!==A.createHTMLDocument;const L=ht,N=gt,O=ut,F=ft,M=mt,U=bt,P=xt,B=_t;let H=vt,j=null;const V=Ze({},[...tt,...ot,...it,...at,...nt]);let G=null;const q=Ze({},[...lt,...ct,...dt,...pt]);let W=Object.seal(ze(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Y=null,J=null;const X=Object.seal(ze(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Z=!0,K=!0,Q=!1,ee=!0,te=!1,oe=!0,ie=!1,re=!1,ae=!1,se=!1,ne=!1,le=!1,ce=!0,de=!1;const pe="user-content-";let he=!0,ge=!1,ue={},fe=null;const me=Ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let ve=null;const xe=Ze({},["audio","video","img","source","image","track"]);let ye=null;const _e=Ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),we="http://www.w3.org/1998/Math/MathML",ke="http://www.w3.org/2000/svg",Se="http://www.w3.org/1999/xhtml";let Ce=Se,Ae=!1,Je=null;const Xe=Ze({},[we,ke,Se],Oe);let Ke=Ze({},["mi","mo","mn","ms","mtext"]),Rt=Ze({},["annotation-xml"]);const Et=Ze({},["title","style","font","a","script"]);let Tt=null;const It=["application/xhtml+xml","text/html"];let Dt=null,Lt=null;const Nt=i.createElement("form"),Ot=function(e){return e instanceof RegExp||e instanceof Function},Ft=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(Lt&&Lt===e)return;e&&"object"==typeof e||(e={}),e=Qe(e),Tt=-1===It.indexOf(e.PARSER_MEDIA_TYPE)?"text/html":e.PARSER_MEDIA_TYPE,Dt="application/xhtml+xml"===Tt?Oe:Ne,j=Ge(e,"ALLOWED_TAGS")&&Le(e.ALLOWED_TAGS)?Ze({},e.ALLOWED_TAGS,Dt):V,G=Ge(e,"ALLOWED_ATTR")&&Le(e.ALLOWED_ATTR)?Ze({},e.ALLOWED_ATTR,Dt):q,Je=Ge(e,"ALLOWED_NAMESPACES")&&Le(e.ALLOWED_NAMESPACES)?Ze({},e.ALLOWED_NAMESPACES,Oe):Xe,ye=Ge(e,"ADD_URI_SAFE_ATTR")&&Le(e.ADD_URI_SAFE_ATTR)?Ze(Qe(_e),e.ADD_URI_SAFE_ATTR,Dt):_e,ve=Ge(e,"ADD_DATA_URI_TAGS")&&Le(e.ADD_DATA_URI_TAGS)?Ze(Qe(xe),e.ADD_DATA_URI_TAGS,Dt):xe,fe=Ge(e,"FORBID_CONTENTS")&&Le(e.FORBID_CONTENTS)?Ze({},e.FORBID_CONTENTS,Dt):me,Y=Ge(e,"FORBID_TAGS")&&Le(e.FORBID_TAGS)?Ze({},e.FORBID_TAGS,Dt):Qe({}),J=Ge(e,"FORBID_ATTR")&&Le(e.FORBID_ATTR)?Ze({},e.FORBID_ATTR,Dt):Qe({}),ue=!!Ge(e,"USE_PROFILES")&&(e.USE_PROFILES&&"object"==typeof e.USE_PROFILES?Qe(e.USE_PROFILES):e.USE_PROFILES),Z=!1!==e.ALLOW_ARIA_ATTR,K=!1!==e.ALLOW_DATA_ATTR,Q=e.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=!1!==e.ALLOW_SELF_CLOSE_IN_ATTR,te=e.SAFE_FOR_TEMPLATES||!1,oe=!1!==e.SAFE_FOR_XML,ie=e.WHOLE_DOCUMENT||!1,se=e.RETURN_DOM||!1,ne=e.RETURN_DOM_FRAGMENT||!1,le=e.RETURN_TRUSTED_TYPE||!1,ae=e.FORCE_BODY||!1,ce=!1!==e.SANITIZE_DOM,de=e.SANITIZE_NAMED_PROPS||!1,he=!1!==e.KEEP_CONTENT,ge=e.IN_PLACE||!1,H=function(e){try{return We(e,""),!0}catch(e){return!1}}(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:vt,Ce="string"==typeof e.NAMESPACE?e.NAMESPACE:Se,Ke=Ge(e,"MATHML_TEXT_INTEGRATION_POINTS")&&e.MATHML_TEXT_INTEGRATION_POINTS&&"object"==typeof e.MATHML_TEXT_INTEGRATION_POINTS?Qe(e.MATHML_TEXT_INTEGRATION_POINTS):Ze({},["mi","mo","mn","ms","mtext"]),Rt=Ge(e,"HTML_INTEGRATION_POINTS")&&e.HTML_INTEGRATION_POINTS&&"object"==typeof e.HTML_INTEGRATION_POINTS?Qe(e.HTML_INTEGRATION_POINTS):Ze({},["annotation-xml"]);const t=Ge(e,"CUSTOM_ELEMENT_HANDLING")&&e.CUSTOM_ELEMENT_HANDLING&&"object"==typeof e.CUSTOM_ELEMENT_HANDLING?Qe(e.CUSTOM_ELEMENT_HANDLING):ze(null);if(W=ze(null),Ge(t,"tagNameCheck")&&Ot(t.tagNameCheck)&&(W.tagNameCheck=t.tagNameCheck),Ge(t,"attributeNameCheck")&&Ot(t.attributeNameCheck)&&(W.attributeNameCheck=t.attributeNameCheck),Ge(t,"allowCustomizedBuiltInElements")&&"boolean"==typeof t.allowCustomizedBuiltInElements&&(W.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),te&&(K=!1),ne&&(se=!0),ue&&(j=Ze({},nt),G=ze(null),!0===ue.html&&(Ze(j,tt),Ze(G,lt)),!0===ue.svg&&(Ze(j,ot),Ze(G,ct),Ze(G,pt)),!0===ue.svgFilters&&(Ze(j,it),Ze(G,ct),Ze(G,pt)),!0===ue.mathMl&&(Ze(j,at),Ze(G,dt),Ze(G,pt))),X.tagCheck=null,X.attributeCheck=null,Ge(e,"ADD_TAGS")&&("function"==typeof e.ADD_TAGS?X.tagCheck=e.ADD_TAGS:Le(e.ADD_TAGS)&&(j===V&&(j=Qe(j)),Ze(j,e.ADD_TAGS,Dt))),Ge(e,"ADD_ATTR")&&("function"==typeof e.ADD_ATTR?X.attributeCheck=e.ADD_ATTR:Le(e.ADD_ATTR)&&(G===q&&(G=Qe(G)),Ze(G,e.ADD_ATTR,Dt))),Ge(e,"ADD_URI_SAFE_ATTR")&&Le(e.ADD_URI_SAFE_ATTR)&&Ze(ye,e.ADD_URI_SAFE_ATTR,Dt),Ge(e,"FORBID_CONTENTS")&&Le(e.FORBID_CONTENTS)&&(fe===me&&(fe=Qe(fe)),Ze(fe,e.FORBID_CONTENTS,Dt)),Ge(e,"ADD_FORBID_CONTENTS")&&Le(e.ADD_FORBID_CONTENTS)&&(fe===me&&(fe=Qe(fe)),Ze(fe,e.ADD_FORBID_CONTENTS,Dt)),he&&(j["#text"]=!0),ie&&Ze(j,["html","head","body"]),j.table&&(Ze(j,["tbody"]),delete Y.tbody),e.TRUSTED_TYPES_POLICY){if("function"!=typeof e.TRUSTED_TYPES_POLICY.createHTML)throw Ye('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if("function"!=typeof e.TRUSTED_TYPES_POLICY.createScriptURL)throw Ye('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const t=$;$=e.TRUSTED_TYPES_POLICY;try{k=S("")}catch(e){throw $=t,e}}else void 0===$&&null!==e.TRUSTED_TYPES_POLICY&&($=function(e,t){if("object"!=typeof e||"function"!=typeof e.createPolicy)return null;let o=null;const i="data-tt-policy-suffix";t&&t.hasAttribute(i)&&(o=t.getAttribute(i));const r="dompurify"+(o?"#"+o:"");try{return e.createPolicy(r,{createHTML:e=>e,createScriptURL:e=>e})}catch(e){return console.warn("TrustedTypes policy "+r+" could not be created."),null}}(h,a)),$&&"string"==typeof k&&(k=S(""));(D.uponSanitizeElement.length>0||D.uponSanitizeAttribute.length>0)&&j===V&&(j=Qe(j)),D.uponSanitizeAttribute.length>0&&G===q&&(G=Qe(G)),$e&&$e(e),Lt=e},Mt=Ze({},[...ot,...it,...rt]),Ut=Ze({},[...at,...st]),Pt=function(e){Ie(o.removed,{element:e});try{b(e).removeChild(e)}catch(t){f(e)}},Bt=function(e,t){try{Ie(o.removed,{attribute:t.getAttributeNode(e),from:t})}catch(e){Ie(o.removed,{attribute:null,from:t})}if(t.removeAttribute(e),"is"===e)if(se||ne)try{Pt(t)}catch(e){}else try{t.setAttribute(e,"")}catch(e){}},Ht=function(e){let t=null,o=null;if(ae)e="<remove></remove>"+e;else{const t=Fe(e,/^[\r\n\t ]+/);o=t&&t[0]}"application/xhtml+xml"===Tt&&Ce===Se&&(e='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+e+"</body></html>");const r=$?S(e):e;if(Ce===Se)try{t=(new p).parseFromString(r,Tt)}catch(e){}if(!t||!t.documentElement){t=A.createDocument(Ce,"template",null);try{t.documentElement.innerHTML=Ae?k:r}catch(e){}}const a=t.body||t.documentElement;return e&&o&&a.insertBefore(i.createTextNode(o),a.childNodes[0]||null),Ce===Se?T.call(t,ie?"html":"body")[0]:ie?t.documentElement:a},jt=function(e){return R.call(e.ownerDocument||e,e,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},Vt=function(e){var t,o;e.normalize();const i=R.call(e.ownerDocument||e,e,c.SHOW_TEXT|c.SHOW_COMMENT|c.SHOW_CDATA_SECTION|c.SHOW_PROCESSING_INSTRUCTION,null);let r=i.nextNode();for(;r;){let e=r.data;Re([L,N,O],t=>{e=Me(e,t," ")}),r.data=e,r=i.nextNode()}const a=null!==(t=null===(o=e.querySelectorAll)||void 0===o?void 0:o.call(e,"template"))&&void 0!==t?t:[];Re(Array.from(a),e=>{qt(e.content)&&Vt(e.content)})},Gt=function(e){const t=w?w(e):null;return"string"==typeof t&&("form"===Dt(t)&&("string"!=typeof e.nodeName||"string"!=typeof e.textContent||"function"!=typeof e.removeChild||e.attributes!==y(e)||"function"!=typeof e.removeAttribute||"function"!=typeof e.setAttribute||"string"!=typeof e.namespaceURI||"function"!=typeof e.insertBefore||"function"!=typeof e.hasChildNodes||e.nodeType!==_(e)||e.childNodes!==v(e)))},qt=function(e){if(!_||"object"!=typeof e||null===e)return!1;try{return _(e)===Ct}catch(e){return!1}},Wt=function(e){if(!_||"object"!=typeof e||null===e)return!1;try{return"number"==typeof _(e)}catch(e){return!1}};function Yt(e,t,i){Re(e,e=>{e.call(o,t,i,Lt)})}const Jt=function(e){let t=null;if(Yt(D.beforeSanitizeElements,e,null),Gt(e))return Pt(e),!0;const i=Dt(w?w(e):e.nodeName);if(Yt(D.uponSanitizeElement,e,{tagName:i,allowedTags:j}),oe&&e.hasChildNodes()&&!Wt(e.firstElementChild)&&We(/<[/\w!]/g,e.innerHTML)&&We(/<[/\w!]/g,e.textContent))return Pt(e),!0;if(oe&&e.namespaceURI===Se&&"style"===i&&Wt(e.firstElementChild))return Pt(e),!0;if(e.nodeType===kt)return Pt(e),!0;if(oe&&e.nodeType===zt&&We(/<[/\w]/g,e.data))return Pt(e),!0;if(Y[i]||!(X.tagCheck instanceof Function&&X.tagCheck(i))&&!j[i]){if(!Y[i]&&Kt(i)){if(W.tagNameCheck instanceof RegExp&&We(W.tagNameCheck,i))return!1;if(W.tagNameCheck instanceof Function&&W.tagNameCheck(i))return!1}if(he&&!fe[i]){const t=b(e),o=v(e);if(o&&t){for(let i=o.length-1;i>=0;--i){const r=u(o[i],!0);t.insertBefore(r,m(e))}}}return Pt(e),!0}return((_?_(e):e.nodeType)!==wt||function(e){let t=b(e);t&&t.tagName||(t={namespaceURI:Ce,tagName:"template"});const o=Ne(e.tagName),i=Ne(t.tagName);return!!Je[e.namespaceURI]&&(e.namespaceURI===ke?t.namespaceURI===Se?"svg"===o:t.namespaceURI===we?"svg"===o&&("annotation-xml"===i||Ke[i]):Boolean(Mt[o]):e.namespaceURI===we?t.namespaceURI===Se?"math"===o:t.namespaceURI===ke?"math"===o&&Rt[i]:Boolean(Ut[o]):e.namespaceURI===Se?!(t.namespaceURI===ke&&!Rt[i])&&!(t.namespaceURI===we&&!Ke[i])&&!Ut[o]&&(Et[o]||!Mt[o]):!("application/xhtml+xml"!==Tt||!Je[e.namespaceURI]))}(e))&&("noscript"!==i&&"noembed"!==i&&"noframes"!==i||!We(/<\/no(script|embed|frames)/i,e.innerHTML))?(te&&e.nodeType===$t&&(t=e.textContent,Re([L,N,O],e=>{t=Me(t,e," ")}),e.textContent!==t&&(Ie(o.removed,{element:e.cloneNode()}),e.textContent=t)),Yt(D.afterSanitizeElements,e,null),!1):(Pt(e),!0)},Xt=function(e,t,o){if(J[t])return!1;if(ce&&("id"===t||"name"===t)&&(o in i||o in Nt))return!1;const r=G[t]||X.attributeCheck instanceof Function&&X.attributeCheck(t,e);if(K&&!J[t]&&We(F,t));else if(Z&&We(M,t));else if(!r||J[t]){if(!(Kt(e)&&(W.tagNameCheck instanceof RegExp&&We(W.tagNameCheck,e)||W.tagNameCheck instanceof Function&&W.tagNameCheck(e))&&(W.attributeNameCheck instanceof RegExp&&We(W.attributeNameCheck,t)||W.attributeNameCheck instanceof Function&&W.attributeNameCheck(t,e))||"is"===t&&W.allowCustomizedBuiltInElements&&(W.tagNameCheck instanceof RegExp&&We(W.tagNameCheck,o)||W.tagNameCheck instanceof Function&&W.tagNameCheck(o))))return!1}else if(ye[t]);else if(We(H,Me(o,P,"")));else if("src"!==t&&"xlink:href"!==t&&"href"!==t||"script"===e||0!==Ue(o,"data:")||!ve[e]){if(Q&&!We(U,Me(o,P,"")));else if(o)return!1}else;return!0},Zt=Ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Kt=function(e){return!Zt[Ne(e)]&&We(B,e)},Qt=function(e){Yt(D.beforeSanitizeAttributes,e,null);const t=e.attributes;if(!t||Gt(e))return;const i={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:G,forceKeepAttr:void 0};let r=t.length;for(;r--;){const a=t[r],s=a.name,n=a.namespaceURI,l=a.value,c=Dt(s),d=l;let p="value"===s?d:Pe(d);if(i.attrName=c,i.attrValue=p,i.keepAttr=!0,i.forceKeepAttr=void 0,Yt(D.uponSanitizeAttribute,e,i),p=i.attrValue,!de||"id"!==c&&"name"!==c||0===Ue(p,pe)||(Bt(s,e),p=pe+p),oe&&We(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,p)){Bt(s,e);continue}if("attributename"===c&&Fe(p,"href")){Bt(s,e);continue}if(i.forceKeepAttr)continue;if(!i.keepAttr){Bt(s,e);continue}if(!ee&&We(/\/>/i,p)){Bt(s,e);continue}te&&Re([L,N,O],e=>{p=Me(p,e," ")});const g=Dt(e.nodeName);if(Xt(g,c,p)){if($&&"object"==typeof h&&"function"==typeof h.getAttributeType)if(n);else switch(h.getAttributeType(g,c)){case"TrustedHTML":p=S(p);break;case"TrustedScriptURL":p=$.createScriptURL(p)}if(p!==d)try{n?e.setAttributeNS(n,s,p):e.setAttribute(s,p),Gt(e)?Pt(e):Te(o.removed)}catch(t){Bt(s,e)}}else Bt(s,e)}Yt(D.afterSanitizeAttributes,e,null)},eo=function(e){let t=null;const o=jt(e);for(Yt(D.beforeSanitizeShadowDOM,e,null);t=o.nextNode();){Yt(D.uponSanitizeShadowNode,t,null),Jt(t),Qt(t),qt(t.content)&&eo(t.content);if((_?_(t):t.nodeType)===wt){const e=x?x(t):t.shadowRoot;qt(e)&&(to(e),eo(e))}}Yt(D.afterSanitizeShadowDOM,e,null)},to=function(e){const t=_?_(e):e.nodeType;if(t===wt){const t=x?x(e):e.shadowRoot;qt(t)&&(to(t),eo(t))}const o=v?v(e):e.childNodes;if(!o)return;const i=[];Re(o,e=>{Ie(i,e)});for(const e of i)to(e);if(t===wt){const t=w?w(e):null;if("string"==typeof t&&"template"===Dt(t)){const t=e.content;qt(t)&&to(t)}}};return o.sanitize=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=null,a=null,s=null,n=null;if(Ae=!e,Ae&&(e="\x3c!--\x3e"),"string"!=typeof e&&!Wt(e)&&"string"!=typeof(e=function(e){switch(typeof e){case"string":return e;case"number":return Be(e);case"boolean":return He(e);case"bigint":return je?je(e):"0";case"symbol":return Ve?Ve(e):"Symbol()";case"undefined":default:return qe(e);case"function":case"object":{if(null===e)return qe(e);const t=e,o=et(t,"toString");if("function"==typeof o){const e=o(t);return"string"==typeof e?e:qe(e)}return qe(e)}}}(e)))throw Ye("dirty is not a string, aborting");if(!o.isSupported)return e;if(re||Ft(t),o.removed=[],"string"==typeof e&&(ge=!1),ge){const t=w?w(e):e.nodeName;if("string"==typeof t){const e=Dt(t);if(!j[e]||Y[e])throw Ye("root node is forbidden and cannot be sanitized in-place")}if(Gt(e))throw Ye("root node is clobbered and cannot be sanitized in-place");to(e)}else if(Wt(e))i=Ht("\x3c!----\x3e"),a=i.ownerDocument.importNode(e,!0),a.nodeType===wt&&"BODY"===a.nodeName||"HTML"===a.nodeName?i=a:i.appendChild(a),to(a);else{if(!se&&!te&&!ie&&-1===e.indexOf("<"))return $&&le?S(e):e;if(i=Ht(e),!i)return se?null:le?k:""}i&&ae&&Pt(i.firstChild);const l=jt(ge?e:i);for(;s=l.nextNode();)Jt(s),Qt(s),qt(s.content)&&eo(s.content);if(ge)return te&&Vt(e),e;if(se){if(te&&Vt(i),ne)for(n=E.call(i.ownerDocument);i.firstChild;)n.appendChild(i.firstChild);else n=i;return(G.shadowroot||G.shadowrootmode)&&(n=I.call(r,n,!0)),n}let c=ie?i.outerHTML:i.innerHTML;return ie&&j["!doctype"]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&We(yt,i.ownerDocument.doctype.name)&&(c="<!DOCTYPE "+i.ownerDocument.doctype.name+">\n"+c),te&&Re([L,N,O],e=>{c=Me(c,e," ")}),$&&le?S(c):c},o.setConfig=function(){Ft(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}),re=!0},o.clearConfig=function(){Lt=null,re=!1},o.isValidAttribute=function(e,t,o){Lt||Ft({});const i=Dt(e),r=Dt(t);return Xt(i,r,o)},o.addHook=function(e,t){"function"==typeof t&&Ie(D[e],t)},o.removeHook=function(e,t){if(void 0!==t){const o=Ee(D[e],t);return-1===o?void 0:De(D[e],o,1)[0]}return Te(D[e])},o.removeHooks=function(e){D[e]=[]},o.removeAllHooks=function(){D={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},o}();class Et extends(de(se)){static properties={currentView:{type:String},stats:{type:Object},hass:{type:Object},narrow:{type:Boolean},_apiReady:{type:Boolean,state:!0},_error:{type:String,state:!0},_detailRepo:{type:Object,state:!0},_showDetail:{type:Boolean,state:!0},_favoriteCount:{type:Number,state:!0},_readmeHtml:{type:String,state:!0},_readmeLoading:{type:Boolean,state:!0},_viewTransition:{type:Boolean,state:!0},_networkStatus:{type:String,state:!0},_detailExpanded:{type:Boolean,state:!0},_showVersionSelector:{type:Boolean,state:!0},_releases:{type:Array,state:!0},_releasesLoading:{type:Boolean,state:!0},_installingVersion:{type:Boolean,state:!0},_changelogData:{type:Object,state:!0},_changelogLoading:{type:Boolean,state:!0},_presetFilter:{type:String,state:!0},_configFlowDomain:{type:String,state:!0},_configFlowEntryId:{type:String,state:!0},_showConfigFlow:{type:Boolean,state:!0},_configEntries:{type:Object,state:!0},_showEntrySelector:{type:Boolean,state:!0},_entrySelectorDomain:{type:String,state:!0},_entrySelectorEntries:{type:Array,state:!0},_entrySelectorCurrentId:{type:String,state:!0}};constructor(){super(),this.currentView="browse",this.stats={pendingRestart:0},this.narrow=window.innerWidth<768,this._apiReady=!1,this._error="",this._detailRepo=null,this._showDetail=!1,this._favoriteCount=0,this._readmeHtml=null,this._readmeLoading=!1,this._viewTransition=!1,this._networkStatus="online",this._detailExpanded=!1,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1,this._installingVersion=!1,this._changelogData=null,this._changelogLoading=!1,this._presetFilter="",this._configFlowDomain="",this._configFlowEntryId=null,this._showConfigFlow=!1,this._configEntries=null,this._showEntrySelector=!1,this._entrySelectorDomain="",this._entrySelectorEntries=[],this._entrySelectorCurrentId=null,It(this),window.addEventListener("resize",()=>{this.narrow=window.innerWidth<768}),window.addEventListener("online",()=>{this._networkStatus="online"}),window.addEventListener("offline",()=>{this._networkStatus="offline"})}async _updateFavoriteCount(){try{const e=await ce.getFavorites(),t=Array.isArray(e)?e:e.favorites||[];this._favoriteCount=t.length}catch{this._favoriteCount=0}}willUpdate(e){var t;e.has("hass")&&this.hass&&(t=this.hass,t?.language&&(pe=0===t.language.indexOf("zh")?"zh":"en"),ce.setHass(this.hass),this._apiReady||(this._apiReady=!0,this._loadStats(),this._loadConfigEntries(),ce._onNetworkStatus=e=>{this._networkStatus=e}))}static styles=a`
  ...
  `;async connectedCallback(){super.connectedCallback(),this.addEventListener("refresh-stats",()=>this._loadStats()),this.addEventListener("detail",e=>this._openDetail(e.detail.repo)),this.addEventListener("favorite",()=>this._loadStats()),this.addEventListener("open-flow",e=>{const t=e.detail?.domain;t&&this._openConfigFlow(t)}),this.addEventListener("open-options-flow",e=>{const{entryId:t,domain:o}=e.detail||{};t&&this._openOptionsFlow(t,o)}),this._keydownHandler=e=>{if("Escape"===e.key&&this._showDetail)return e.preventDefault(),void this._closeDetail();if((e.ctrlKey||e.metaKey)&&"k"===e.key){e.preventDefault();const t=this.renderRoot?.querySelector(".search input");return void(t&&(t.focus(),t.select()))}if(!this._showDetail&&"INPUT"!==document.activeElement?.tagName&&"SELECT"!==document.activeElement?.tagName&&"TEXTAREA"!==document.activeElement?.tagName){const t=["browse","updates","management","settings"],o=parseInt(e.key);o>=1&&o<=t.length&&(e.preventDefault(),this.switchView(t[o-1]))}},window.addEventListener("keydown",this._keydownHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._keydownHandler)}async _loadStats(){try{this._error="",this.stats=await ce.getStats();const e=await ce.getFavorites(),t=Array.isArray(e)?e:e.favorites||[];this._favoriteCount=t.length}catch(e){console.error("Stats error:",e),this.stats={},this._error=`API: ${e.message}`}}async _restartHA(){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Bt});if(await e.show(this,{message:ge("restartConfirm"),confirmText:ge("restartHA"),danger:!0}))try{await ce.restartHA(),Nt(ge("haRestarting"),"info")}catch(e){Nt(`${ge("restartFailed")}: ${e.message}`,"error")}}switchView(e){this.currentView!==e&&(this._viewTransition=!0,this.currentView=e,this.dispatchEvent(new CustomEvent("view-changed",{detail:{view:e},bubbles:!0,composed:!0})),setTimeout(()=>{this._viewTransition=!1},150))}_openDetail(e){this._detailRepo=e,this._showDetail=!0,this._readmeHtml=null,this._readmeLoading=!0,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1,this._changelogData=null,this._changelogLoading=!0,this._loadReadme(e),this._loadChangelog(e)}async _loadReadme(e){if(e?.full_name){try{const t=await ce.getReadme(e.full_name);this._readmeHtml=t?Rt.sanitize(t):null}catch(e){this._readmeHtml=null}this._readmeLoading=!1}else this._readmeLoading=!1}async _loadChangelog(e){if(e?.full_name){try{const t=await ce.getChangelog(e.full_name);this._changelogData=t?.body?t:null}catch(e){this._changelogData=null}this._changelogLoading=!1}else this._changelogLoading=!1}_applyFilter(e){this._presetFilter=e,this.switchView("browse"),setTimeout(()=>{this._presetFilter=""},100)}_closeDetail(){this._showDetail=!1,this._detailRepo=null,this._readmeHtml=null,this._readmeLoading=!1,this._detailExpanded=!1,this._showVersionSelector=!1,this._releases=[],this._releasesLoading=!1}_openConfigFlow(e){this._configFlowDomain=e,this._configFlowEntryId=null,this._showConfigFlow=!0}_openOptionsFlow(e,t){if(this._configFlowDomain=t||"",this._configFlowEntryId=null,t&&this._configEntries&&this._configEntries[t]&&this._configEntries[t].length>1)return this._entrySelectorDomain=t,this._entrySelectorEntries=this._configEntries[t],this._entrySelectorCurrentId=e,void(this._showEntrySelector=!0);this._configFlowEntryId=e,this._showConfigFlow=!0}_selectConfigEntry(e){if(this._showEntrySelector=!1,this._configFlowEntryId=e,this._configEntries)for(const t of Object.values(this._configEntries)){const o=t.find(t=>t.entry_id===e);if(o){this._configFlowDomain=o.domain||"";break}}this._showConfigFlow=!0}async _loadConfigEntries(){try{const e=await ce.getConfigEntries(),t=e?.entries||[],o={};if(Array.isArray(t))for(const e of t){const t=e.domain||e.handler||"?";o[t]||(o[t]=[]),o[t].push(e)}this._configEntries=o}catch{this._configEntries=null}}async _checkUpdates(){try{const e=await ce.checkUpdatesWithNotify();e.success&&(e.updates_found>0?Nt(ge("updatesChecked",{n:e.updates_found}),"success"):Nt(ge("noUpdatesFound"),"info"),e.notified&&Nt(ge("notifySent"),"success"),this._loadStats())}catch(e){Nt(`Update check failed: ${e.message}`,"error")}}_onFlowClose(){this._showConfigFlow=!1,this._configFlowDomain="",this._configFlowEntryId=null,this._showEntrySelector=!1}_toggleDetailExpand(){this._detailExpanded=!this._detailExpanded}async _toggleVersionSelector(){if(this._showVersionSelector=!this._showVersionSelector,this._showVersionSelector&&0===this._releases.length){this._releasesLoading=!0;try{const e=this._detailRepo?.id||this._detailRepo?.full_name;if(e){const t=await ce.getRepoReleases(e);this._releases=Array.isArray(t)?t:t.releases||[]}}catch(e){console.error("Failed to load releases:",e),this._releases=[]}this._releasesLoading=!1}}async _installVersion(e){const t=this._detailRepo?.id||this._detailRepo?.full_name;if(t&&e){this._installingVersion=!0;try{await ce.installVersion(t,e),Nt(`${ge("installComplete")}: ${e}`,"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._closeDetail()}catch(e){Nt(`${ge("installFailed")}: ${e.message}`,"error")}this._installingVersion=!1}}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPython"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}async _modalAction(e){const t=this._detailRepo;if(t)try{if("install"===e)await ce.install(t.id||t.full_name,t.category),Nt(ge("installComplete"),"success");else if("update"===e)await ce.update([t.id||t.full_name]),Nt(ge("updateStarted"),"success");else if("uninstall"===e){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Bt});if(!await e.show(this,{message:`${ge("confirmRemove")} ${t.full_name||t.name}?`,confirmText:ge("remove"),danger:!0}))return;await ce.remove(t.id||t.full_name),Nt(ge("removed"),"success")}else if("github"===e){const e=t.html_url||`https://github.com/${t.full_name}`;return void window.open(e,"_blank")}this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._closeDetail()}catch(e){Nt(`${ge("updateFailed")}: ${e.message}`,"error")}}_checkTabsScrollable(){const e=this.renderRoot?.querySelector(".tabs-wrapper"),t=e?.querySelector(".tabs");e&&t&&e.classList.toggle("scrollable",t.scrollWidth>t.clientWidth)}async updated(e){super.updated(e),e.has("narrow")&&requestAnimationFrame(()=>this._checkTabsScrollable())}firstUpdated(){requestAnimationFrame(()=>this._checkTabsScrollable())}render(){const e=[{view:"browse",label:ge("tabBrowse"),icon:"",count:null},{view:"updates",label:ge("tabUpdates"),icon:"",count:this.stats?.available_updates??null},{view:"management",label:ge("tabManagement"),icon:"",count:null},{view:"settings",label:ge("tabSettings"),icon:"",count:null}],t=this._detailRepo,o=t?.installed||!1,i=o&&(t?.has_update||t?.installed_version&&t?.latest_version&&t.installed_version!==t.latest_version),r=t?fe(t.category):"#03a9f4";return H`
      <div class="store">
        ...
        <div class="content ${this._viewTransition?"transitioning":""}">
          <browse-view .hass=${this.hass} .presetFilter=${this._presetFilter} .pendingRestart=${this.stats.pending_restart??0} ?hidden=${"browse"!==this.currentView}></browse-view>
      ...
      ${this._showEntrySelector?H`
        <div class="entry-overlay" @click=${()=>{this._showEntrySelector=!1}}>
    ...
    `}}let Tt=null;function It(e){Tt=e}const Dt=[];let Lt=!1;function Nt(e,t="info"){const o=Tt||document.querySelector("hacs-vision-panel"),i=o?.shadowRoot?.querySelector("#toast-container");i?(Dt.push({msg:e,type:t}),Lt||Ot(i)):console.warn("Toast container not found:",e)}function Ot(e){if(0===Dt.length)return void(Lt=!1);Lt=!0;const{msg:t,type:o}=Dt.shift(),i=document.createElement("div");i.className="toast",o&&i.classList.add(o),i.textContent=t,e.appendChild(i),requestAnimationFrame(()=>{i.classList.add("show")}),setTimeout(()=>{i.classList.remove("show"),setTimeout(()=>{i.remove(),Ot(e)},350)},3e3)}var Ft=Object.freeze({__proto__:null,HacsVisionPanel:Et,registerPanel:It,showToast:Nt});class Mt extends se{static properties={repo:{type:Object},_isFavorite:{type:Boolean,state:!0},_installing:{type:Boolean},_favorites:{type:Array,state:!0},selected:{type:Boolean},showCheckbox:{type:Boolean},viewMode:{type:String},renamedFrom:{type:String},showRemoveBtn:{type:Boolean}};constructor(){super(),this.repo={},this._isFavorite=!1,this._installing=!1,this._favorites=[],this.viewMode="store",this.renamedFrom=null,this.showRemoveBtn=!1}async connectedCallback(){super.connectedCallback(),await this._loadFavorites()}async _loadFavorites(){try{const e=await ce.getFavorites();this._favorites=Array.isArray(e)?e:e.favorites||[]}catch(e){this._favorites=[]}this._updateFavoriteState()}_updateFavoriteState(){this.repo&&(this._isFavorite=this._favorites.includes(this.repo.id||this.repo.full_name))}willUpdate(e){e.has("repo")&&this.repo&&this._updateFavoriteState()}static styles=a`
  ...
  `;_getInitials(e){if(!e)return"?";const t=e.split("/");return(t[t.length-1]||e).charAt(0).toUpperCase()}_getIconUrl(e){const t=e.domain;return t&&"integration"===e.category?`https://brands.home-assistant.io/${t}/icon.png`:null}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPython"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}_handleAction(e,t){e.stopPropagation(),this.dispatchEvent(new CustomEvent(t,{detail:{repo:this.repo},bubbles:!0,composed:!0}))}async _handleFavorite(e){e.stopPropagation();const t=this.repo.id||this.repo.full_name,o=[...this._favorites],i=o.indexOf(t);i>=0?(o.splice(i,1),this._isFavorite=!1):(o.push(t),this._isFavorite=!0);try{await ce.setFavorites(o),this._favorites=o}catch(e){this._isFavorite=!this._isFavorite}this.dispatchEvent(new CustomEvent("favorite",{detail:{repo:this.repo,isFavorite:this._isFavorite},bubbles:!0,composed:!0}))}_handleCardClick(){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:this.repo},bubbles:!0,composed:!0}))}render(){const e=this.repo,t=e.manifest_name||e.repository_manifest?.name||e.full_name||e.name||"unknown",o=e.description||"",i=e.category||"integration",r=e.stars||e.stargazers_count||0,a=e.downloads||0,s=e.installed||!1,n=s&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version),l=fe(i);return H`
      <div class="card${e.is_custom?" custom-repo":""}" @click=${this._handleCardClick}>
        <div class="img-container">
          ...
          ${s?H`<span class="installed-badge"><svg class="mini-icon" viewBox="0 0 24 24" fill="none" stroke="#4caf50" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg> ${ge("installed")}</span>`:""}
        ...
        <div class="content">
          ...
          <div class="meta">
            <div class="tags">
              ...
              ${e.is_custom?H`<span class="custom-tag">${ge("customBadge")}</span>`:""}
    ...
    `}}customElements.define("repo-card",Mt);const Ut=a`
  /* ===== Loading ===== */
  .loading {
...
`;class Pt extends se{static properties={_message:{type:String,state:!0},_confirmText:{type:String,state:!0},_cancelText:{type:String,state:!0},_danger:{type:Boolean,state:!0},_visible:{type:Boolean,state:!0}};constructor(){super(),this._message="",this._confirmText=ge("confirm"),this._cancelText=ge("cancel"),this._danger=!1,this._visible=!1,this._resolve=null}static styles=a`
  ...
  `;static show(e,{message:t,confirmText:o,cancelText:i,danger:r}={}){let a=e.shadowRoot?.querySelector("confirm-dialog");return a||(a=document.createElement("confirm-dialog"),e.shadowRoot.appendChild(a)),new Promise(e=>{a._resolve=e,a._message=t||"Are you sure?",a._confirmText=o||ge("confirm"),a._cancelText=i||ge("cancel"),a._danger=!!r,a._visible=!0})}_onConfirm(){this._visible=!1,this._resolve&&this._resolve(!0)}_onCancel(){this._visible=!1,this._resolve&&this._resolve(!1)}_onOverlayClick(e){e.target===e.currentTarget&&this._onCancel()}render(){return this._visible?H`
    ...
    `:H``}}customElements.define("confirm-dialog",Pt);var Bt=Object.freeze({__proto__:null,ConfirmDialog:Pt});const Ht="hacs_vision_browse_state",jt="hacs_vision_view_mode";class Vt extends se{static properties={repos:{type:Array},total:{type:Number},search:{type:String},category:{type:String},statusFilter:{type:String},sort:{type:String},sortDir:{type:String},page:{type:Number},loading:{type:Boolean},categoryCounts:{type:Object},statusCounts:{type:Object},viewMode:{type:String},groupBy:{type:String},pageSize:{type:Number},_installingIds:{type:Object,state:!0},_searchText:{type:String,state:!0},_showAddRepo:{type:Boolean,state:!0},_newRepoUrl:{type:String,state:!0},_newRepoCategory:{type:String,state:!0},_addRepoInstalling:{type:Boolean,state:!0},_collapsedGroups:{type:Object,state:!0},_filterExpanded:{type:Boolean,state:!0},_favorites:{type:Array,state:!0},presetFilter:{type:String},pendingRestart:{type:Number},_selectedRepos:{type:Array,state:!0}};constructor(){super();const e=function(){try{return JSON.parse(localStorage.getItem(Ht)||"{}")}catch{return{}}}();this.repos=[],this.total=0,this.search=e.search||"",this.category=e.category||"",this.statusFilter=e.statusFilter||"",this.sort=e.sort||"stars",this.sortDir=e.sortDir||"desc",this.page=e.page||1,this.loading=!1,this.limit=e.pageSize||50,this.pageSize=this.limit,this.categoryCounts={},this.statusCounts={},this._installingIds={},this._searchTimer=void 0,this._searchText=e.search||"",this.viewMode=localStorage.getItem(jt)||"card",this.groupBy=e.groupBy||"none",this._showAddRepo=!1,this._newRepoUrl="",this._newRepoCategory="integration",this._addRepoInstalling=!1,this._collapsedGroups={},this._filterExpanded=!1,this._favorites=[],this._selectedRepos=[],this.statusOptions=[{value:"",label:ge("statusAll")},{value:"installed",label:ge("statusInstalled")},{value:"not_installed",label:ge("statusNotInstalled")},{value:"update_available",label:ge("statusPendingUpgrade")},{value:"favorites",label:ge("statusFavorites")},{value:"new",label:ge("statusNew")},{value:"custom",label:ge("statusCustom")},{value:"pending_restart",label:ge("statusPendingRestart")}],this.typeOptions=[{value:"",label:ge("typeAll")},{value:"integration",label:ge("typeIntegration")},{value:"plugin",label:ge("typePlugin")},{value:"theme",label:ge("typeTheme")},{value:"appdaemon",label:ge("typeAppDaemon")},{value:"netdaemon",label:ge("typeNetDaemon")},{value:"python_script",label:ge("typePython")},{value:"template",label:ge("typeTemplate")}],this.groupOptions=[{value:"none",label:ge("groupNone")},{value:"status",label:ge("groupStatus")},{value:"type",label:ge("groupType")}],this.sortColumns=[{key:"name",label:ge("colName")||"名称",sortable:!0},{key:"downloads",label:ge("colDownloads")||"下载",sortable:!0},{key:"stars",label:ge("colStars")||"星数",sortable:!0},{key:"last_updated",label:ge("colLastUpdated")||"更新时间",sortable:!0},{key:"installed_version",label:ge("colInstalledVer")||"已安装",sortable:!0},{key:"latest_version",label:ge("colAvailableVer")||"可用",sortable:!0},{key:"installed_at",label:ge("colInstalledAt")||"安装时间",sortable:!0},{key:"status",label:ge("colStatus")||"状态",sortable:!0}]}static styles=a`
    ${Ut}
  ...
  `;async connectedCallback(){super.connectedCallback(),await this._loadFavorites(),await this._load(),this.addEventListener("install",e=>this._handleInstall(e.detail.repo)),this.addEventListener("update",e=>this._handleUpdate(e.detail.repo)),this.addEventListener("uninstall",e=>this._handleUninstall(e.detail.repo)),this.addEventListener("configure",e=>this._handleConfigure(e.detail.repo)),this.addEventListener("add-integration",e=>this._handleAddIntegration(e.detail.repo)),this.addEventListener("favorite",async()=>{await this._loadFavorites(),this._syncFavoriteCount()})}willUpdate(e){if(e.has("presetFilter")){const t=this.presetFilter;if(void 0===e.get("presetFilter")&&""===t)return;this.presetFilter="",this.statusFilter=t,this.page=1,this._persistState(),this._load()}}async _loadFavorites(){try{const e=await ce.getFavorites();this._favorites=Array.isArray(e)?e:e.favorites||[]}catch(e){this._favorites=[]}}_syncFavoriteCount(){this.statusCounts={...this.statusCounts,favorites:this._favorites.length},this.requestUpdate()}_persistState(){!function(e){try{localStorage.setItem(Ht,JSON.stringify(e))}catch{}}({search:this.search,category:this.category,statusFilter:this.statusFilter,sort:this.sort,sortDir:this.sortDir,page:this.page,groupBy:this.groupBy,pageSize:this.pageSize})}async _handleInstall(e){const t=e.id||e.full_name;this._installingIds={...this._installingIds,[t]:!0};try{await ce.install(t,e.category),Nt(`${ge("installComplete")}: ${e.full_name||e.name}`,"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load()}catch(e){Nt(`${ge("installFailed")}: ${e.message}`,"error")}delete this._installingIds[t],this._installingIds={...this._installingIds}}async _handleUpdate(e){try{const t=await ce.update([e.id||e.full_name]);t?.success?.length>0?Nt(`${ge("updateComplete")}: ${e.full_name||e.name}`,"success"):Nt(`${ge("updateFailed")}: ${e.full_name||e.name}`,"error"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load()}catch(e){console.error("Update failed",e),Nt(`${ge("updateFailed")}: ${e.message}`,"error")}}async _handleUninstall(e){if(await Pt.show(this,{message:`${ge("confirmRemove")} ${e.full_name||e.name}?`,confirmText:ge("remove"),danger:!0}))try{await ce.remove(e.id||e.full_name),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0})),this._load()}catch(e){console.error("Uninstall failed",e)}}_handleConfigure(e){const t=e.domain||(e.full_name||"").split("/")[1]||"";this.dispatchEvent(new CustomEvent("open-options-flow",{detail:{entryId:e.config_entry_id,domain:t},bubbles:!0,composed:!0}))}_handleAddIntegration(e){const t=e.domain||(e.full_name||"").split("/")[1]||"";this.dispatchEvent(new CustomEvent("open-flow",{detail:{domain:t},bubbles:!0,composed:!0}))}async _load(){this.loading=!0;try{const e=!(!this.search||!this.search.match(/github\.com\/([^/]+\/[^/\s?#]+)/i)&&!this.search.match(/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/));let t=this.search;if(e){const e=this.search.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);e&&(t=e[1].replace(/\.git$/,""))}const o=await ce.listRepositories({search:t,category:this.category,sort:this.sort,sortDir:this.sortDir,page:this.page,limit:this.limit,status:this.statusFilter});this.repos=o.repositories||[],this.total=o.total||0,this.categoryCounts=o.category_counts||{},this.statusCounts=o.status_counts||{},this.statusCounts={...this.statusCounts,favorites:this._favorites.length}}catch(e){console.error("Browse load error",e),this.repos=[],this.total=0}this.loading=!1}_onSearch(e){this._searchText=e.target.value,clearTimeout(this._searchTimer),this._searchTimer=setTimeout(()=>{this.search=this._searchText,this.page=1,this._persistState(),this._load()},300)}_clearSearch(){this._searchText="",this.search="",this.page=1,this._persistState(),this._load()}_onStatusFilter(e){this.statusFilter=e,this.page=1,this._persistState(),this._load()}_onTypeFilter(e){this.category=e,this.page=1,this._persistState(),this._load()}_onSortColumn(e){this.sort===e?this.sortDir="desc"===this.sortDir?"asc":"desc":(this.sort=e,this.sortDir="name"===e?"asc":"desc"),this.page=1,this._persistState(),this._load()}_onGroupChange(e){this.groupBy=e.target.value,this._persistState()}_onViewModeChange(e){this.viewMode=e;try{localStorage.setItem(jt,e)}catch{}}_toggleGroup(e){this._collapsedGroups={...this._collapsedGroups,[e]:!this._collapsedGroups[e]}}_goPage(e){this.page=e,this._persistState(),this._load()}_onPageSizeChange(e){this.pageSize=parseInt(e.target.value,10),this.limit=this.pageSize,this.page=1,this._persistState(),this._load()}_refresh(){this.page=1,this._persistState(),this._load()}async _addRepo(){const e=this._parseRepoUrl(this._newRepoUrl);if(e){this._addRepoInstalling=!0;try{const t=await ce.addCustomRepo(e,this._newRepoCategory);t.success?(Nt(`${ge("addSuccess")}: ${e}`,"success"),this._newRepoUrl="",this._showAddRepo=!1,this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))):Nt(`${ge("addFailed")}: ${t.error}`,"error")}catch(e){Nt(`${ge("addFailed")}: ${e.message}`,"error")}this._addRepoInstalling=!1}else Nt(ge("invalidRepoUrl"),"error")}_parseRepoUrl(e){const t=e.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return t?t[1].replace(/\.git$/,""):/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/.test(e)?e:null}_getRepoStatus(e){return e.id||e.full_name,e.pending_restart?"pending_restart":e.installed&&(e.has_update||e.installed_version&&e.latest_version&&e.installed_version!==e.latest_version)?"pending-upgrade":e.installed?"installed":e.new||"new"===e.status?"new":"default"}_getStatusBadge(e){const t={installed:{label:ge("statusInstalled"),cls:"installed"},"pending-upgrade":{label:ge("statusPendingUpgrade"),cls:"pending-upgrade"},"pending-restart":{label:ge("statusPendingRestart"),cls:"pending-restart"},new:{label:ge("statusNew"),cls:"new"},default:{label:ge("statusDefault"),cls:"default"}}[e]||{label:e,cls:"default"};return H`<span class="status-badge ${t.cls}">${t.label}</span>`}_getStatusLabel(e){return{installed:ge("statusInstalled"),not_installed:ge("statusDefault"),update_available:ge("statusPendingUpgrade"),favorites:ge("statusFavorites"),new:ge("statusNew"),custom:ge("statusCustom"),pending_restart:ge("statusPendingRestart")}[e]||e}_applyFilters(e){return"favorites"===this.statusFilter?e.filter(e=>this._favorites.includes(e.id||e.full_name)):e}_getFiltered(){let e=this._applyFilters(this.repos);if(!this.search)return e;const t=this.search.toLowerCase();let o=null;const i=t.match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return i&&(o=i[1].replace(/\.git$/,"").toLowerCase()),e.filter(e=>{const i=(e.full_name||"").toLowerCase(),r=(e.name||"").toLowerCase(),a=(e.description||"").toLowerCase(),s=(e.authors||[]).join(",").toLowerCase(),n=(e.manifest_name||e.repository_manifest?.name||"").toLowerCase();return!!(i.includes(t)||r.includes(t)||a.includes(t)||s.includes(t))||(!(!o||i!==o&&!i.includes(o))||!!n.includes(t))})}_groupRepos(e){if("none"===this.groupBy)return null;const t={};for(const o of e){let e;e="status"===this.groupBy?this._getRepoStatus(o):"type"===this.groupBy&&o.category||"other",t[e]||(t[e]=[]),t[e].push(o)}const o=["pending-restart","pending-upgrade","installed","new","default"],i=["integration","plugin","theme","appdaemon","netdaemon","python_script","template","other"],r=Object.keys(t);return"status"===this.groupBy?r.sort((e,t)=>o.indexOf(e)-o.indexOf(t)):"type"===this.groupBy&&r.sort((e,t)=>i.indexOf(e)-i.indexOf(t)),r.map(e=>({key:e,label:"status"===this.groupBy?this._getStatusLabel(e):this._getCategoryLabel(e),repos:t[e]}))}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPython"),template:ge("catTemplate"),other:e}[e]||e}_formatDate(e){if(!e)return"";try{const t=new Date(e),o=new Date-t,i=Math.floor(o/864e5);return 0===i?ge("today")||"今天":1===i?ge("yesterday")||"昨天":i<30?`${i}d`:i<365?`${Math.floor(i/30)}mo`:`${Math.floor(i/365)}y`}catch{return""}}_toggleSelect(e){this._selectedRepos.includes(e)?this._selectedRepos=this._selectedRepos.filter(t=>t!==e):this._selectedRepos=[...this._selectedRepos,e]}_isAllSelected(){const e=this._getFiltered();return e.length>0&&this._selectedRepos.length===e.length}_toggleSelectAll(){const e=this._getFiltered();this._isAllSelected()?this._selectedRepos=[]:this._selectedRepos=e.map(e=>e.full_name).filter(Boolean)}async _batchDo(e){if(0===this._selectedRepos.length)return;const t=this._selectedRepos.map(e=>{const t=this.repos.find(t=>t.full_name===e);return{repository:e,category:t?.category||"integration"}});if("remove"===e){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Bt});if(!await e.show(this,{message:ge("batchRemoveConfirm",{n:t.length}),confirmText:ge("batchRemove"),danger:!0}))return}try{let o;Nt(ge("batchInProgress"),"info"),o="install"===e?await ce.batchInstall(t):"update"===e?await ce.update(t.map(e=>e.repository)):await ce.batchRemove(t.map(e=>e.repository)),Nt(ge("batchComplete"),"success"),this._selectedRepos=[],this._load()}catch(t){Nt(`${e} failed: ${t.message}`,"error")}}async _restartHA(){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Bt});if(await e.show(this,{message:this.t?.("restartConfirm"),confirmText:this.t?.("restartHA"),danger:!0}))try{await ce.restartHA(),Nt(this.t?.("haRestarting"),"info")}catch(e){Nt(`${this.t?.("restartFailed")}: ${e.message}`,"error")}}_renderRepoList(e){return"list"===this.viewMode?H`<div class="list-view">${this._renderListTable(e)}</div>`:H`<div class="grid">${e.map(e=>H`
    ...
    `}_renderListRow(e){const t=fe(e.category||"integration"),o=e.manifest_name||e.repository_manifest?.name||e.full_name||e.name||"?",i=e.stars||e.stargazers_count||0,r=e.downloads||0,a=this._getRepoStatus(e),s=e.installed||!1,n="pending-upgrade"===a,l=e.id||e.full_name,c=!!this._installingIds?.[l];return H`
    ...
    `}render(){const e=Math.ceil(this.total/this.limit),t=this._getFiltered(),o=this._groupRepos(t);return H`
        ...
        <div class="add-repo-form">
          <div class="form-row">
            ...
            <select class="form-select" .value=${this._newRepoCategory} @change=${e=>{this._newRepoCategory=e.target.value}}>
              ...
              <option value="theme">${ge("catTheme")}</option><option value="appdaemon">${ge("catAppDaemon")}</option>
              <option value="python_script">${ge("catPython")}</option><option value="template">${ge("catTemplate")}</option>
            </select>
          </div>
      ...
      <button class="filter-toggle" @click=${()=>{this._filterExpanded=!this._filterExpanded}}>
        <span>${ge("filterStatus")||"筛选"} / ${ge("filterType")||"类型"}</span>
      ...
      <!-- Content -->
      ${this.loading?H`
        <div class="loading"><div class="spinner"></div><div>${ge("loading")}</div></div>
      `:0===t.length?H`
        <div class="empty">
      ...
      `:H`
        ...
        `:""}
      `}
    `}}customElements.define("browse-view",Vt);class Gt extends se{static properties={updates:{type:Array},loading:{type:Boolean},updating:{type:Boolean},search:{type:String},_installingIds:{type:Object,state:!0},_changelogs:{type:Object,state:!0},_searchText:{type:String,state:!0},_selectedIds:{type:Object,state:!0},_selectedRepos:{type:Array,state:!0},_batchMode:{type:Boolean,state:!0},_viewMode:{type:String,state:!0}};constructor(){super(),this.updates=[],this.loading=!1,this.updating=!1,this.search="",this._searchTimer=null,this._installingIds={},this._changelogs={},this._changelogsLoading={},this._expandedChangelogs={},this._searchText="",this._selectedIds={},this._selectedRepos=[],this._batchMode=!1;const e=localStorage.getItem("hacs_vision_view_mode");this._viewMode=e||"card"}static styles=[Ut,a`
      :host { display: block; touch-action: manipulation; background: var(--primary-background-color); }
    ...
    `];async connectedCallback(){super.connectedCallback(),await this._load()}_lazyLoadChangelogs(){const e=this.updates.filter(e=>e.full_name&&!this._changelogs[e.full_name]);if(0===e.length)return;let t=0;const o=()=>{t>=e.length||(this._loadChangelog(e[t++].full_name),setTimeout(o,150))};setTimeout(o,300)}async _load(){this.loading=!0;try{await ce.refresh().catch(()=>{});const e=await ce.getUpdates();this.updates=Array.isArray(e)?e:e.updates||[],this._lazyLoadChangelogs()}catch(e){console.error("Failed to load updates",e),this.updates=[]}this.loading=!1}async _loadChangelog(e){if(e&&!this._changelogs[e]&&!this._changelogsLoading[e]){this._changelogsLoading={...this._changelogsLoading,[e]:!0};try{const t=await ce.getChangelog(e);t?.body&&(this._changelogs={...this._changelogs,[e]:t})}catch{}this._changelogsLoading={...this._changelogsLoading,[e]:!1}}}_toggleChangelog(e){this._expandedChangelogs={...this._expandedChangelogs,[e]:!this._expandedChangelogs?.[e]}}async _loadChangelogs(){const e=this.updates.filter(e=>e.full_name);if(0===e.length)return;const t=await Promise.allSettled(e.map(e=>ce.getChangelog(e.full_name).then(t=>({fullName:e.full_name,data:t})))),o={};for(const e of t)"fulfilled"===e.status&&e.value.data?.body&&(o[e.value.fullName]=e.value.data);Object.keys(o).length>0&&(this._changelogs={...this._changelogs,...o})}async _updateSelected(){const e=Object.keys(this._selectedIds).filter(e=>this._selectedIds[e]);if(0===e.length)return;if(await Pt.show(this,{message:`${ge("confirmUpdateAll")} ${e.length}?`,confirmText:ge("confirmUpdate"),danger:!1})){this.updating=!0;try{await ce.update(e),Nt(`${ge("allUpdatesStarted")} (${e.length})`,"success"),this._selectedIds={},this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Nt(`${ge("updateFailed")}: ${e.message}`,"error")}this.updating=!1}}async _updateAll(){const e=this.updates.map(e=>e.id||e.full_name);if(0===e.length)return;if(await Pt.show(this,{message:`${ge("updateAll")} ${e.length}?`,confirmText:ge("confirmUpdate"),danger:!1})){this.updating=!0;try{await ce.update(e),Nt(`${ge("allUpdatesStarted")} (${e.length})`,"success"),this._selectedIds={},this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Nt(`${ge("updateFailed")}: ${e.message}`,"error")}this.updating=!1}}_toggleSelect(e){this._selectedIds={...this._selectedIds,[e]:!this._selectedIds[e]}}_toggleSelectFull(e){this._selectedRepos.includes(e)?this._selectedRepos=this._selectedRepos.filter(t=>t!==e):this._selectedRepos=[...this._selectedRepos,e]}async _batchDo(e){if(0!==this._selectedRepos.length){if("remove"===e){if(!await Pt.show(this,{message:ge("batchRemoveConfirm",{n:this._selectedRepos.length}),confirmText:ge("batchRemove"),danger:!0}))return}try{Nt(ge("batchInProgress"),"info"),"update"===e?await ce.update(this._selectedRepos):"remove"===e&&await ce.batchRemove(this._selectedRepos.map(e=>e)),Nt(ge("batchComplete"),"success"),this._selectedRepos=[],this._batchMode=!1,this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(t){Nt(`${e} failed: ${t.message}`,"error")}}}_toggleSelectAll(){const e=this._getFiltered();if(this._isAllSelected())this._selectedIds={};else{const t={};for(const o of e)t[o.id||o.full_name]=!0;this._selectedIds=t}}_isAllSelected(){const e=this._getFiltered();return 0!==e.length&&e.every(e=>this._selectedIds[e.id||e.full_name])}_selectedCount(){return Object.keys(this._selectedIds).filter(e=>this._selectedIds[e]).length}async _updateOne(e){const t=e.id||e.full_name;this._installingIds={...this._installingIds,[t]:!0};try{await ce.update([t]);const o=e.latest_version;let i=0;const r=async()=>{if(i++>30)return this._installingIds={...this._installingIds},delete this._installingIds[t],void Nt(`${ge("installFailed")}: timeout`,"error");try{const i=await ce.getRepoStatus(t);if(i?.installed_version===o||i?.installed&&!i?.has_update)return this._installingIds={...this._installingIds},delete this._installingIds[t],Nt(`${ge("updateComplete")}: ${e.full_name||e.name}`,"success"),this._load(),void this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){}setTimeout(r,2e3)};setTimeout(r,2e3)}catch(e){this._installingIds={...this._installingIds},delete this._installingIds[t],Nt(`${ge("updateFailed")}: ${e.message}`,"error")}}_getFiltered(){if(!this.search)return this.updates;const e=this.search.toLowerCase();return this.updates.filter(t=>(t.full_name||t.name||"").toLowerCase().includes(e))}_clearSearch(){this._searchText="",this.search="",this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_openDetail(e){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:e},bubbles:!0,composed:!0}))}_setViewMode(e){this._viewMode=e;try{localStorage.setItem("hacs_vision_view_mode",e)}catch{}}_getCategoryColor(e){return{integration:"#1565c0",plugin:"#7b1fa2",theme:"#2e7d32",python_script:"#f9a825",template:"#6a1b9a",appdaemon:"#e65100",netdaemon:"#00838f",dashboard:"#f57f17"}[e]||"#78909c"}_renderListTable(e){return H`
      <table class="list-table">
        <thead>
          <tr>
            <th class="col-icon"></th>
    ...
    `}_renderListRow(e){const t=e.id||e.full_name,o=!!this._installingIds?.[t],i=!!this._selectedIds[t],r=e.manifest_name||e.name||e.full_name||"?",a=this._getCategoryColor(e.category),s=e.domain;return H`
    ...
    `}render(){const e=this._getFiltered();return H`
      ...
      ${this.loading?H`
        <div class="loading"><div class="spinner"></div><div>${ge("checkingUpdates")}</div></div>
...
/**
  ...
  `;async connectedCallback(){super.connectedCallback(),await this._load()}async _load(){this.loading=!0;try{const e=await ce.getConfig()||{};this.archivedRepos=e.archived_repositories||[],this.ignoredRepos=e.ignored_repositories||[],this.renamedEntries=Object.entries(e.renamed_repositories||{});const t=await ce.getCustomRepos();this.customRepos=Array.isArray(t)?t:t.custom_repositories||[]}catch(e){console.error("Config load error",e)}this.loading=!1}async _removeArchivedRepo(e){if(await Pt.show(this,{message:`${ge("confirmRemoveArchived")} ${e}?`,confirmText:ge("removeArchived"),danger:!0}))try{await ce.removeArchivedRepo(e),this._load()}catch(e){Nt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}async _removeRenamedRepo(e){if(await Pt.show(this,{message:`${ge("confirmRemoveRenamed")} ${e}?`,confirmText:ge("removeRenamed"),danger:!0}))try{await ce.removeRenamedRepo(e),this._load()}catch(e){Nt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}async _replaceRenamedOneClick(e,t){if(await Pt.show(this,{message:`${ge("confirmReplaceRenamed")}: ${e} → ${t}${ge("replaceRenamedWarning")}?`,confirmText:ge("replace"),danger:!0})){this._renamedRefreshing=!0;try{await ce.replaceRenamedRepo(e,t),Nt(`${ge("replace")}: ${e} → ${t}`,"success"),await ce.refresh(),this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Nt(`${ge("updateFailed")}: ${e.message}`,"error")}this._renamedRefreshing=!1}}async _checkDependencies(){this._depLoading=!0;try{const e=await ce.checkDependencies();this._depResults=e,e.all_ok?Nt(ge("depOk"),"success"):Nt(`${ge("depMissing")} (${e.issues_count})`,"error")}catch(e){this._depResults=null,Nt(`${ge("checkFailed")}: ${e.message}`,"error")}this._depLoading=!1}_depMissingCount(){return this._depResults?.dependencies?this._depResults.dependencies.filter(e=>e.has_issues).length:0}async _export(){this.exporting=!0;try{const e=await ce.exportBackup(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),o=URL.createObjectURL(t),i=document.createElement("a");i.href=o,i.download=`hacs-vision-backup-${(new Date).toISOString().slice(0,10)}.json`,i.click(),URL.revokeObjectURL(o),Nt(ge("exportSuccess"),"success")}catch(e){Nt(`${ge("exportFailed")}: ${e.message}`,"error")}this.exporting=!1}async _import(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=async()=>{const t=e.files[0];if(t){this.importing=!0;try{const e=await t.text(),o=JSON.parse(e);await ce.importBackup(o),Nt(ge("importSuccess"),"success"),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Nt(`${ge("importFailed")}: ${e.message}`,"error")}this.importing=!1}},e.click()}_toggleAddCustom(){this._showAddCustom=!this._showAddCustom,this._showAddCustom||(this._customRepoUrl="",this._customRepoCategory="integration")}_parseRepoUrl(e){const t=(e=e.trim()).match(/github\.com\/([^/]+\/[^/\s?#]+)/i);return t?t[1].replace(/\.git$/,""):/^[a-zA-Z0-9_-]+\/[a-zA-Z0-9_.-]+$/.test(e)?e:null}async _addCustomRepo(){const e=this._parseRepoUrl(this._customRepoUrl);if(!e)return void Nt(ge("invalidRepoUrl"),"error");const t=this.customRepos.some(t=>(t.full_name||t.repository)===e);if(t)Nt(`${e} ${ge("alreadyExists")}`,"error");else{this._addingCustom=!0;try{const t=await ce.addCustomRepo(e,this._customRepoCategory);t.success?(Nt(`${ge("addSuccess")}: ${e}`,"success"),this._customRepoUrl="",this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))):Nt(`${ge("addFailed")}: ${t.error}`,"error")}catch(e){Nt(`${ge("addFailed")}: ${e.message}`,"error")}this._addingCustom=!1}}async _removeCustomRepo(e,t){if(await Pt.show(this,{message:`${ge("confirmRemoveRepo")} ${e}?`,confirmText:ge("removeRepo"),danger:!0}))try{const t=await ce.removeCustomRepo(e);t&&!1===t.success&&Nt(`${ge("removeRepoFailed")}: ${t.error}`,"error"),this._load(),this.dispatchEvent(new CustomEvent("refresh-stats",{bubbles:!0,composed:!0}))}catch(e){Nt(`${ge("removeRepoFailed")}: ${e.message}`,"error")}}_toggleSection(e){this._collapsed={...this._collapsed,[e]:!this._collapsed[e]}}_setViewMode(e){this._viewMode=e}_openCardDetail(e){this.dispatchEvent(new CustomEvent("detail",{detail:{repo:e},bubbles:!0,composed:!0}))}_getFilteredCustomRepos(){let e=[...this.customRepos];const t=(this._customRepoSearch||"").toLowerCase();t&&(e=e.filter(e=>{const o=(e.manifest_name||e.name||e.full_name||"").toLowerCase(),i=(e.description||"").toLowerCase();return o.includes(t)||i.includes(t)}));const o=this._customRepoSort||"name";return"stars"===o?e.sort((e,t)=>(t.stargazers_count||0)-(e.stargazers_count||0)):"updated"===o?e.sort((e,t)=>(t.last_updated||"").localeCompare(e.last_updated||"")):e.sort((e,t)=>(e.manifest_name||e.name||e.full_name||"").localeCompare(t.manifest_name||t.name||t.full_name||"")),e}_getInitials(e){if(!e)return"?";const t=e.split("/");return(t[t.length-1]||e).charAt(0).toUpperCase()}_getCategoryColor(e){return getCategoryColor(e)}_getCategoryLabel(e){return{integration:ge("catIntegration"),plugin:ge("catPlugin"),theme:ge("catTheme"),appdaemon:ge("catAppDaemon"),netdaemon:ge("catNetDaemon"),python_script:ge("catPython"),template:ge("catTemplate"),dashboard:ge("catDashboard")}[e]||e}_renderCard(e,t){const o=e.full_name||e.repository,i=e.manifest_name||e.name||o,r=t.find(([e,t])=>t===o),a=!!r,s=a?r[0]:null,n=e.installed_version||"",l=e.latest_version||"",c=e.has_update,d=e.stargazers_count||0,p=e.description||"",h=e.installed||!1,g=this._getCategoryColor(e.category);return H`
    ...
    `}_renderListItem(e,t){const o=e.full_name||e.repository,i=e.manifest_name||e.name||o,r=t.find(([e,t])=>t===o),a=!!r,s=a?r[0]:null,n=e.installed_version||"",l=e.latest_version||"",c=e.has_update,d=e.stargazers_count||0,p=e.description||"";return H`
  ...
  `;render(){return H`
      <div class="settings">
        ...
        <div class="field">
          ...
          <select @change=${e=>this._set("notify_updates","true"===e.target.value)}
            ...
            <option value="true">${ge("confirm")}</option>
            <option value="false">${ge("cancel")}</option>
          </select>
        </div>
        ...
        <button class="save-btn" @click=${this._save} ?disabled=${this._saving}>
          ${this._saving?ge("loading"):ge("confirm")}
        </button>
    ...
    `}async _checkUpdates(){try{const e=await ce.checkUpdatesWithNotify(),{showToast:t}=await Promise.resolve().then(function(){return Ft});e.success&&(e.updates_found>0?t(ge("updatesChecked",{n:e.updates_found}),"success"):t(ge("noUpdatesFound"),"info"),e.notified&&t(ge("notifySent"),"success"))}catch(e){showToast(`Update check failed: ${e.message}`,"error")}}async _checkAndRestart(){const{ConfirmDialog:e}=await Promise.resolve().then(function(){return Bt});if(await e.show(this,{message:ge("restartConfirm"),confirmText:ge("restartHA"),danger:!0}))try{await ce.restartHA();const{showToast:e}=await Promise.resolve().then(function(){return Ft});e(ge("haRestarting"),"info")}catch(e){showToast(`${ge("restartFailed")}: ${e.message}`,"error")}}}customElements.define("config-view",Xt);class Zt extends se{static properties={hass:{type:Object},domain:{type:String},entryId:{type:String},configEntries:{type:Object},open:{type:Boolean,reflect:!0},_loading:{type:Boolean,state:!0},_flowId:{type:String,state:!0},_step:{type:Object,state:!0},_errors:{type:Object,state:!0},_finished:{type:Boolean,state:!0},_result:{type:Object,state:!0},_isOptions:{type:Boolean,state:!0}};constructor(){super(),this.domain="",this.entryId=null,this.configEntries=null,this.open=!1,this._loading=!1,this._flowId=null,this._step=null,this._errors={},this._finished=!1,this._result=null,this._isOptions=!1,this._loadingTimeout=null,this._translations=null,this._lang="zh-Hans"}_getHass(){if(this.hass)return this.hass;try{const e=window.parent?.document?.querySelector("home-assistant");return e?.hass||null}catch(e){return null}}disconnectedCallback(){super.disconnectedCallback(),this._clearLoadingTimeout()}_clearLoadingTimeout(){this._loadingTimeout&&(clearTimeout(this._loadingTimeout),this._loadingTimeout=null)}_startLoadingTimeout(){this._clearLoadingTimeout(),this._loadingTimeout=setTimeout(()=>{this._loading&&!this._finished&&(this._clearLoadingTimeout(),this._finished=!0,this._result={type:"error",message:ge("flowTimeout")},this._loading=!1,this.requestUpdate())},3e4)}connectedCallback(){super.connectedCallback()}updated(e){e.has("open")&&this.open&&(this.entryId?(this._isOptions=!0,this._startFlow()):this.domain&&(this._isOptions=!1,this.entryId=null,this._startFlow()))}openFlow(e){this.entryId=null,this._isOptions=!1,this.domain=e,this.open=!0}openOptionsFlow(e){this.domain="",this._isOptions=!0,this.entryId=e,this.open=!0}async _loadTranslations(e){if(e&&(!this._translations||this._translations._domain!==e))try{const t=await ce.getTranslations(e,this._lang),o=t?.data||{};this._translations={_domain:e,_data:o}}catch(t){this._translations={_domain:e,_data:{}}}}_t(e){if(!this._translations?._data)return null;const t="component."+this._translations._domain+".",o=e.startsWith(t)?e.slice(t.length):e;let i=this._traverse(this._translations._data,o);return i||(o.startsWith("config.")&&(i=this._traverse(this._translations._data,"options."+o.slice(7)),i)?i:null)}_traverse(e,t){const o=t.split(".");let i=e;for(const e of o){if(null==i||"object"!=typeof i)return null;i=i[e]}return"string"==typeof i?i:null}async _startFlow(){this._loading=!0,this._finished=!1,this._result=null,this._step=null,this._errors={},this.requestUpdate(),this._startLoadingTimeout();try{const e=this._isOptions?this._getFlowDomain():this.domain;let t;e&&await this._loadTranslations(e),t=this._isOptions&&this.entryId?await ce.startOptionsFlow(this.entryId):await ce.startConfigFlow(this.domain),await this._handleFlowResponse(t)}catch(e){console.error("HACS Vision: config flow start error:",e),this._finished=!0,this._result={type:"error",message:this._getFlowErrorMessage(e)},this._loading=!1,this.requestUpdate()}}async _handleFlowResponse(e){if("abort"===e.type)return this._finished=!0,this._result={type:"abort",reason:e.reason},this._loading=!1,void this.requestUpdate();if("create_entry"===e.type)return this._finished=!0,this._result={type:"create_entry",title:e.title||this.domain||ge("flowDone")},this._loading=!1,void this.requestUpdate();if("form"===e.type){this._flowId=e.flow_id||e.flowId,this._step=e,this._errors=e.errors||{};const t=this._getFlowDomain()||e.handler;return t&&await this._loadTranslations(t),this._loading=!1,void this.requestUpdate()}if("external"===e.type){this._finished=!0;const t=e.url||"";return this._result={type:"external",url:t,message:ge("flowExternalAuth")},this._loading=!1,void this.requestUpdate()}if("menu"===e.type)return this._flowId=e.flow_id||e.flowId,this._step=e,this._errors={},this._loading=!1,void this.requestUpdate();this._finished=!0,this._result={type:"unsupported",message:ge("flowUnknownType",{type:e.type})},this._loading=!1,this.requestUpdate()}async _submitStep(e){this._loading=!0,this._errors={},this.requestUpdate();try{let t;t=this._isOptions&&this._step?await ce.stepOptionsFlow(this._flowId,e):await ce.stepConfigFlow(this._flowId,e),this._handleFlowResponse(t)}catch(e){console.error("HACS Vision: flow step error:",e),this._errors={base:e.message||ge("flowSubmitFailed")},this._loading=!1,this.requestUpdate()}}_handleSubmit(e){e.preventDefault();const t=e.target,o={};for(const e of t.elements)e.name&&"submit"!==e.type&&"button"!==e.type&&("checkbox"===e.type?o[e.name]=e.checked:"select-multiple"===e.type?o[e.name]=Array.from(e.selectedOptions).map(e=>e.value):void 0!==e.value&&null!==e.value&&(o[e.name]=void 0===e.valueAsNumber||isNaN(e.valueAsNumber)||"number"!==e.type?e.value:e.valueAsNumber));this._submitStep(o)}_handleMenuSelect(e){this._submitStep({next_step_id:e})}_cancelFlow(){this._flowId&&ce.cancelConfigFlow(this._flowId).catch(()=>{}),this._close()}_close(){this.open=!1,this._flowId=null,this._step=null,this._finished=!1,this._result=null,this._errors={},this._isOptions=!1,this.domain="",this.entryId=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}static styles=a`
    :host { display: block; }
    :host([open]) {
      position: fixed;
  ...
  `;render(){if(!this.open)return"";const e=this._isOptions?this._getFlowDomain()||ge("flowTitleOptions"):this._step?.title||this._localizeTitle()||this._step?.handler||this.domain||ge("flowTitle");return H`
      <div class="overlay" @click=${e=>{e.target===e.currentTarget&&this._cancelFlow()}}>
        <div class="dialog">
          <div class="header">
          ...
          ${this._loading||this._finished||this._step||this._result?"":H`
            <div class="loading">
              <div class="spinner"></div>
    ...
    `}_renderStep(){const e=this._step;return e?"menu"===e.type?this._renderMenu(e):"form"===e.type?this._renderForm(e):H`<div class="result error"><div class="result-title">${ge("flowResultFailed")}: ${e.type}</div></div>`:""}_renderMenu(e){const t=this._buildDescription(e),o=e.menu_options||[];return H`
      ...
      <div class="menu-list">
        ${o.map((t,o)=>{const i="string"==typeof t,r=i?t:t.value||"",a=this._t(`component.${this._getFlowDomain()}.config.step.${e.step_id}.menu_options.${r}`)||(i?t:t.label||t.title||t.value||""),s=i?"":t.description||"";return H`
    ...
    `}_buildDescription(e){let t=e.description||e.description_placeholders?.description||"";if(t&&t.includes(".")){const e=this._t(t)||null;e&&(t=e)}if(!t){const o=this._getFlowDomain(),i=e.step_id;if(o&&i){const e=`component.${o}.config.step.${i}.description`,r=this._t(e);r&&(t=r)}}const o=e.description_placeholders||{};for(const[e,i]of Object.entries(o))t=t.replace(new RegExp(`\\{${e}\\}`,"g"),i);if(!t&&Object.keys(o).length>0){const e=Object.entries(o).map(([,e])=>e);t=e.join("\n")}return t}_getFlowDomain(){if(this.domain)return this.domain;if(this.entryId&&this.configEntries)for(const e of Object.values(this.configEntries))for(const t of e)if(t.entry_id===this.entryId)return t.domain||"";const e=this._step?.handler;return e&&!/^[0-9A-Z]{20,}$/.test(e)?e:""}_localizeTitle(){const e=this._getFlowDomain(),t=this._step?.step_id;if(e&&t){const o=`component.${e}.config.step.${t}.title`,i=this._t(o);if(i)return i}if(e){const t=`component.${e}.title`,o=this._t(t);if(o)return o}return""}_getFieldLabel(e){const t=this._getFlowDomain(),o=this._step?.step_id;if(t&&o){const i=`component.${t}.config.step.${o}.data.${e.name}`,r=this._t(i);if(r)return r}return e.label||e.name.replace(/_/g," ")}_getFieldDescription(e){const t=this._getFlowDomain(),o=this._step?.step_id;if(t&&o){const i=`component.${t}.config.step.${o}.data.${e.name}.description`,r=this._t(i);if(r)return r}return e.description||""}_getFieldPlaceholder(e){const t=this._getFlowDomain(),o=this._step?.step_id;if(t&&o){const i=`component.${t}.config.step.${o}.data.${e.name}.placeholder`,r=this._t(i);if(r)return r}return e.placeholder||""}_getOptionLabel(e,t){const o=this._getFlowDomain(),i=this._step?.step_id;if(o&&i){const r=`component.${o}.config.step.${i}.data.${e.name}.options.${t}`,a=this._t(r);if(a)return a}return null}_getFlowErrorMessage(e){const t=e?.message||"";return t.includes("404")?this._isOptions?ge("flowOptionsNotSupported"):ge("flowHandlerNotFound"):t.includes("401")||t.includes("403")?ge("flowAuthError"):t||(this._isOptions?ge("flowStartFailedOptions"):ge("flowStartFailed"))}_renderField(e){const t=e.name,o=this._getFieldLabel(e),i=e.type||"string",r=!1!==e.required,a=void 0!==e.default&&null!==e.default,s=a?e.default:"",n=this._getFieldPlaceholder(e),l=this._getFieldDescription(e),c=this._errors?.[t]||"",d=!0===e.multiline,p=!0===e.password||"password"===e.type||/token|secret|password|key|api_key|apiKey/i.test(t)&&"string"===i;if("select"===i||"multi_select"===i||e.options||e.enum){const n=e.options||e.enum||[],d=Array.isArray(n)?n:Object.entries(n).map(([e,t])=>({value:e,label:t})),p="multi_select"===i;return H`
        <div class="form-field">
          <label>${o}${r?" *":""}</label>
          ${l?H`<div class="field-desc">${l}</div>`:""}
          <select name=${t} ?multiple=${p} ?required=${r}>
            ${r||p?"":H`<option value="">${ge("flowSelectOption")}</option>`}
            ${d.map(t=>{const o=Array.isArray(t),i="string"==typeof t?t:o?t[0]:t.value??t,r=this._getOptionLabel(e,i)||("string"==typeof t?t:o?t[1]||t[0]:t.label||t.description||t.value||t),n=a&&(Array.isArray(s)?s.includes(i):s===i);return H`<option value=${i} ?selected=${n}>${r}</option>`})}
          </select>
      ...
      `}return"boolean"===i?H`
        <div class="form-field">
          <label class="checkbox-label">
            <input type="checkbox" name=${t} ?checked=${!0===s||"true"===s}>
            <span>${o!==e.name.replace(/_/g," ")?o:l||o}</span>
          </label>
          ${c?H`<div class="form-error">${c}</div>`:""}
        </div>
      `:"integer"===i||"number"===i?H`
        <div class="form-field">
          <label>${o}${r?" *":""}</label>
          ${l?H`<div class="field-desc">${l}</div>`:""}
          <input type="number" name=${t} .value=${s}
                 ?required=${r} placeholder=${n}
                 step=${"integer"===i?1:"any"}>
          ${c?H`<div class="form-error">${c}</div>`:""}
        </div>
      `:d?H`
        <div class="form-field">
          <label>${o}${r?" *":""}</label>
          ${l?H`<div class="field-desc">${l}</div>`:""}
          <textarea name=${t} .value=${s}
                    ?required=${r} placeholder=${n}></textarea>
          ${c?H`<div class="form-error">${c}</div>`:""}
        </div>
      `:H`
      <div class="form-field">
        <label>${o}${r?" *":""}</label>
        ${l&&l!==n?H`<div class="field-desc">${l}</div>`:""}
        <input type=${p?"password":"text"} name=${t}
               .value=${s} ?required=${r} placeholder=${n}>
        ${c?H`<div class="form-error">${c}</div>`:""}
      </div>
