      ...
      <div class="entry-row ${r?"disabled":""} ${a?"expanded":""}">
        ...
        <div class="entry-icon" style="background:${this._getDomainColor(this._detailDomain)}">
          <img class="entry-icon-img" src="https://brands.home-assistant.io/${this._detailDomain}/icon.png" alt=""
            @error=${function(){try{this.style.display="none";const e=this.parentElement?.querySelector(".entry-icon-letter");e&&(e.style.display="flex",this.parentElement.style.background=e.dataset.color||"var(--primary-color)")}catch(e){}}}>
