      ...
      ${this._showAddCustom?H`
        <div class="add-repo-form">
          ...
          <div style="margin-top:14px;padding-top:12px;border-top:1px solid var(--divider-color);">
            <div style="font-size:12px;font-weight:600;margin-bottom:6px;">${ge("batchAddOrg")||"批量添加组织/用户仓库"}</div>
            <div style="display:flex;gap:6px;margin-bottom:8px;">
              <input class="form-input" type="text" style="flex:1;" .value=${this._orgUrl} @input=${e=>this._orgUrl=e.target.value} @keydown=${e=>"Enter"===e.key&&this._loadMgmtOrgRepos()} placeholder="GitHub 组织名或 URL（如 C3H3-AI）">
            ...
            `:this._orgRepos.length>0?H`
              ...
              ${this._orgSyncResult?H`<div style="font-size:11px;margin-bottom:4px;color:${this._orgSyncResult.includes("失败")?"#f44336":"var(--primary-text-color)"};">${this._orgSyncResult}</div>`:""}
