      ...
      <div class="container">
        ...
        <div class="config-col">
          <div class="section">
            ...
            <div class="setting-row">
              <div class="setting-info">
                <div class="label">${we("settingsRefreshInterval")}</div>
                <div class="desc">${we("settingsDesc")}</div>
              </div>
              <div class="setting-control">
            ...
            <div class="setting-row">
              <div class="setting-info">
                <div class="label">${we("settingsNotifyUpdates")}</div>
              </div>
              <div class="setting-control">
                <label class="toggle">
            ...
            <div class="setting-row">
              <div class="setting-info">
                <div class="label">${we("settingsNotifyRestart")}</div>
              </div>
              <div class="setting-control">
                <label class="toggle">
