            ...
            ${e.map(e=>{const t=e.id||e.full_name,o=!!this._installingIds?.[t],i=this._changelogs?.[e.full_name],r=!!this._selectedIds[t];return H`
              <div class="card" @click=${t=>{t.target.closest(".btn")||t.target.closest("a")||t.target.closest(".checkbox")||this._openDetail(e)}}>
                <div class="img-container">
                  ...
                  <span class="category-badge-corner" style="background:${fe(e.category)}">${e.category}</span>
                </div>
                <div class="card-body">
    ...
    `}_renderListRow(e){const{domain:t,entries:o}=e,i=e._state,r=o.length>1,s=o[0],a=o.some(e=>this._removing[e.entry_id]||this._reloading[e.entry_id]);return H`
      <div class="list-row list-row-${i}" @click=${()=>this._openDetail(t,o)}>
        ...
        <span class="list-row-actions">
          ...
          <button class="list-action-btn" @click=${e=>{e.stopPropagation(),this._openDetail(t,o)}} title="${ge("viewDetail")||"详情"}">
      ...
      <div class="entry-row ${r?"disabled":""} ${s?"expanded":""}">
        ...
        <div class="entry-icon">
          <img class="entry-icon-img" src="https://brands.home-assistant.io/${this._detailDomain}/icon.png" alt=""
            @error=${function(){try{this.style.display="none";const e=this.parentElement?.querySelector(".entry-icon-letter");e&&(e.style.display="flex")}catch(e){}}}>
